...
import OffboardingMarcusVanePeople from "@/imports/OffboardingMarcusVanePeople/OffboardingMarcusVanePeople";

interface OffboardingLayoutProps {
  onNavigateBack: () => void;
}

export function OffboardingLayout({ onNavigateBack }: OffboardingLayoutProps) {
  return (
    <div className="flex h-screen bg-[#f6f6f8] overflow-hidden">
      ...
      {/* Main Content Area - Hide imported sidebar */}
      <div className="flex-1 overflow-hidden [&_[data-name='Sidebar']]:hidden">
        <OffboardingMarcusVanePeople />
      </div>
    </div>
  );
}
