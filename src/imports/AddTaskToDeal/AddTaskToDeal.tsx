"use client";
import svgPaths from "./svg-cb1gid4s26";
...
function Container3() {
  return (
    <div className="h-[24.002px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#64748b] text-[16px] top-[-0.78px] whitespace-nowrap">Deal tasks and activities</p>
    </div>
  );
}
...
function Container24() {
  return (
    <div className="absolute content-stretch flex h-[24.444px] items-start left-[32px] top-[32px] w-[496.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Add Task to Deal</p>
    </div>
  );
}
...
function Container25() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[32px] top-[60.43px] w-[496.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[14px]">Create a new task for this deal</p>
    </div>
  );
}
...
function TextInput1() {
  return (
    <div className="bg-[#f8fafc] flex-[1_0_0] min-h-px relative rounded-[8px] w-[496.007px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[14px] whitespace-nowrap">Portal Customization</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
    ...
    <div className="h-[16.111px] relative shrink-0 w-[496.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] min-w-px not-italic relative text-[#334155] text-[13px]">
          <span className="leading-[normal]">{`Task Title `}</span>
...
function TextInput2() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[496.007px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Enter task title</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container28() {
  return (
    <div className="absolute h-[58.889px] left-[32px] top-[175.98px] w-[496.007px]" data-name="Container">
      <Container29 />
    </div>
  );
}
...
function Label2() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[240px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Assign To</p>
      </div>
    </div>
  );
}
...
function Dropdown() {
  return (
    <div className="h-[37.778px] relative rounded-[8px] shrink-0 w-[240px]" data-name="Dropdown">
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-568.663px] pr-[808.663px] pt-[-433.333px] relative size-full">
        <Option />
        <Option1 />
        <Option2 />
        <Option3 />
...
function Label3() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[240.009px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Due Date</p>
      </div>
    </div>
  );
}
...
function Container30() {
  return (
    <div className="absolute h-[60.885px] left-[32px] top-[250.87px] w-[496.007px]" data-name="Container">
      <Container31 />
      <Container32 />
    </div>
  );
...
function Container36() {
  return (
    <div className="bg-white h-[31.441px] relative rounded-[9999px] shrink-0 w-[61.319px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[1.667px] border-solid inset-0 pointer-events-none rounded-[9999px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[17.66px] not-italic text-[#059669] text-[13px] top-[7.66px] whitespace-nowrap">Low</p>
      </div>
    </div>
  );
}
...
function Container37() {
  return (
    <div className="bg-[#f8fafc] h-[31.441px] relative rounded-[9999px] shrink-0 w-[86.189px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#d97706] border-[1.667px] border-solid inset-0 pointer-events-none rounded-[9999px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[17.66px] not-italic text-[#d97706] text-[13px] top-[7.66px] whitespace-nowrap">Medium</p>
      </div>
    </div>
  );
}
...
function Container38() {
  return (
    <div className="bg-white h-[31.441px] relative rounded-[9999px] shrink-0 w-[64.523px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[1.667px] border-solid inset-0 pointer-events-none rounded-[9999px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[17.66px] not-italic text-[#dc2626] text-[13px] top-[7.66px] whitespace-nowrap">High</p>
      </div>
    </div>
  );
}
...
function Container39() {
  return (
    <div className="bg-white h-[31.441px] relative rounded-[9999px] shrink-0 w-[78.151px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[1.667px] border-solid inset-0 pointer-events-none rounded-[9999px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[17.66px] not-italic text-[#7c3aed] text-[13px] top-[7.66px] whitespace-nowrap">Urgent</p>
      </div>
    </div>
  );
}
...
function Container35() {
  return (
    <div className="h-[31.441px] relative shrink-0 w-[496.007px]" data-name="Container">
...
function Container34() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[52.552px] items-start left-0 top-0 w-[496.007px]" data-name="Container">
      <Label4 />
      <Container35 />
    </div>
  );
...
function Container33() {
  return (
    <div className="absolute h-[52.552px] left-[32px] top-[327.75px] w-[496.007px]" data-name="Container">
      <Container34 />
    </div>
  );
}
  ...
  return (
    <div className="bg-white h-[70px] relative rounded-[8px] shrink-0 w-[496.007px]" data-name="Text Area">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start overflow-clip px-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Describe what needs to be done...</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container40() {
  return (
    <div className="absolute h-[91.111px] left-[32px] top-[396.3px] w-[496.007px]" data-name="Container">
      <Container41 />
    </div>
  );
}
...
function Button2() {
  return (
    <div className="bg-[#5048e5] h-[37.778px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(80,72,229,0.2)] shrink-0 w-[120.556px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[20px] py-[10px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Create Task</p>
      </div>
    </div>
  );
}
...
function Container42() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[58.333px] items-start justify-end left-[32px] pt-[20.556px] top-[511.41px] w-[496.007px]" data-name="Container">
...
function Container23() {
  return (
    <div className="bg-white h-[601.736px] relative rounded-[20px] shadow-[0px_25px_50px_0px_rgba(0,0,0,0.25)] shrink-0 w-[560px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container24 />
        <Container25 />
        <Container26 />
...
export default function AddTaskToDeal() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Add Task to Deal">
      <Body />
      <Sidebar />
      <Header />
      <Container22 />
