"use client";
import svgPaths from "./svg-pm3v6tzzmw";
...
function Container24() {
  return (
    <div className="absolute content-stretch flex h-[24.444px] items-start left-[32px] top-[32px] w-[496.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Message Ravi Kumar</p>
    </div>
  );
}
...
function Container25() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[32px] top-[60.43px] w-[496.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[14px]">Send a message via Chat</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[16.111px] relative shrink-0 w-[496.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Channel</p>
      </div>
    </div>
  );
}
...
function Dropdown() {
  return (
    <div className="flex-[1_0_0] min-h-px relative rounded-[8px] w-[496.007px]" data-name="Dropdown">
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-568.663px] pr-[1064.67px] pt-[-344.115px] relative size-full">
        <Option />
        <Option1 />
        <Option2 />
      </div>
...
function Label1() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[496.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Message</p>
      </div>
    </div>
  );
}
...
function TextArea() {
  return (
    <div className="bg-white h-[120px] relative rounded-[8px] shrink-0 w-[496.007px]" data-name="Text Area">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start overflow-clip px-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Write your message...</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container29() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[141.111px] items-start left-0 top-0 w-[496.007px]" data-name="Container">
      <Label1 />
      <TextArea />
    </div>
  );
...
function Container28() {
  return (
    <div className="absolute h-[141.111px] left-[32px] top-[175.98px] w-[496.007px]" data-name="Container">
      <Container29 />
    </div>
  );
}
...
function Icon19() {
  return (
    <div className="absolute left-[13.99px] size-[13.993px] top-[9.05px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.9931 13.9931">
        <g id="Icon">
          <path d={svgPaths.p46e8700} id="Vector" stroke="var(--stroke-0, #64748B)" strokeWidth="1.49926" />
        </g>
      </svg>
    </div>
  );
...
function Button1() {
  return (
    <div className="absolute bg-white border-[#e2e8f0] border-[0.556px] border-dashed h-[33.212px] left-[32px] rounded-[8px] top-[333.09px] w-[115.79px]" data-name="Button">
      <Icon19 />
      <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[67.48px] not-italic text-[#64748b] text-[13px] text-center top-[7.99px] whitespace-nowrap">{` Attach File `}</p>
    </div>
  );
}
...
function Button3() {
  return (
    <div className="bg-[#5048e5] h-[37.778px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(80,72,229,0.2)] shrink-0 w-[139.878px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[20px] py-[10px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Send Message</p>
      </div>
    </div>
  );
}
...
function Container30() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[58.333px] items-start justify-end left-[32px] pt-[20.556px] top-[390.29px] w-[496.007px]" data-name="Container">
...
function Container23() {
  return (
    <div className="bg-white h-[480.625px] relative rounded-[20px] shadow-[0px_25px_50px_0px_rgba(0,0,0,0.25)] shrink-0 w-[560px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container24 />
        <Container25 />
        <Container26 />
...
export default function MessageEmployee() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Message Employee">
      <Body />
      <Sidebar />
      <Header />
      <Container22 />
