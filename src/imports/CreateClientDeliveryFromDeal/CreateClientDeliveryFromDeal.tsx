"use client";
import svgPaths from "./svg-zernh656zs";
import imgDropdown from "./5094ae664e848e19d8526a5f2e3d190abd538585.png";

function MainContent() {
  return <div className="absolute h-[51.997px] left-[256px] opacity-40 top-[63.99px] w-[1024.002px]" data-name="Main Content" />;
}
...
function Icon19() {
  return (
    <div className="absolute left-[12.55px] size-[13.993px] top-[7.61px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.9931 13.9931">
        <g id="Icon">
          <path d={svgPaths.p2356f900} id="Vector" stroke="var(--stroke-0, #15803D)" strokeWidth="1.49926" />
        </g>
      </svg>
    </div>
  );
...
function Container22() {
  return (
    <div className="bg-[#f0fdf4] h-[29.219px] relative rounded-[8px] shrink-0 w-[127.969px]" data-name="Container">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon19 />
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[32.54px] not-italic text-[#15803d] text-[13px] top-[6.55px] whitespace-nowrap">{` TechFlow Inc `}</p>
      </div>
    </div>
  );
}
...
function Icon20() {
  return (
    <div className="absolute left-[12.55px] size-[13.993px] top-[7.61px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.9931 13.9931">
        <g id="Icon">
          <path d={svgPaths.pe84b200} id="Vector" stroke="var(--stroke-0, #15803D)" strokeWidth="1.49926" />
          <path d={svgPaths.p12226400} id="Vector_2" stroke="var(--stroke-0, #15803D)" strokeWidth="1.49926" />
        </g>
      </svg>
    </div>
  );
...
function Container23() {
  return (
    <div className="bg-[#f0fdf4] h-[29.219px] relative rounded-[8px] shrink-0 w-[117.934px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#bbf7d0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon20 />
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[32.54px] not-italic text-[#15803d] text-[13px] top-[6.55px] whitespace-nowrap">{` Sarah Chen `}</p>
      </div>
    </div>
  );
}
...
function TextInput1() {
  return (
    <div className="bg-[#f8fafc] flex-[1_0_0] min-h-px relative rounded-[8px] w-[280px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[14px] whitespace-nowrap">TechFlow Inc</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container25() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[58.889px] items-start left-0 top-0 w-[280px]" data-name="Container">
      <Label />
      <TextInput1 />
    </div>
  );
...
function Label1() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[280.009px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
...
function TextInput2() {
  return (
    <div className="bg-[#f8fafc] flex-[1_0_0] min-h-px relative rounded-[8px] w-[280.009px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[14px] whitespace-nowrap">Sarah Chen — CTO</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container26() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[58.889px] items-start left-[296px] top-0 w-[280.009px]" data-name="Container">
      <Label1 />
      <TextInput2 />
    </div>
  );
...
function Label2() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[576.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Deal</p>
      </div>
    </div>
  );
}
...
function TextInput3() {
  return (
    <div className="bg-[#f8fafc] flex-[1_0_0] min-h-px relative rounded-[8px] w-[576.007px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[14px] whitespace-nowrap">Portal Customization — $85K</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container28() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[58.889px] items-start left-0 top-0 w-[576.007px]" data-name="Container">
      <Label2 />
      <TextInput3 />
    </div>
  );
...
function Label3() {
  return (
    <div className="absolute content-stretch flex h-[16.111px] items-start left-0 top-0 w-[576.007px]" data-name="Label">
...
function TextArea() {
  return <div className="absolute bg-white border-[#e2e8f0] border-[0.556px] border-solid h-[71.111px] left-0 rounded-[8px] top-[21.11px] w-[576.007px]" data-name="Text Area" />;
}

function Text() {
  return (
    <div className="absolute content-stretch flex h-[13.333px] items-start left-0 top-[99.22px] w-[576.007px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[11px]">Pre-filled from deal notes</p>
    </div>
  );
}
...
function Container31() {
  return (
    <div className="absolute h-[112.552px] left-0 top-0 w-[576.007px]" data-name="Container">
      <Label3 />
      <TextArea />
      <Text />
    </div>
...
function Option() {
  return <div className="absolute left-[-528.66px] size-0 top-[-537.19px]" data-name="Option" />;
}
...
function Dropdown() {
  return (
    <div className="absolute h-[37.222px] left-0 rounded-[8px] top-[21.11px] w-[576.007px]" data-name="Dropdown">
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[-528.66px] not-italic text-[#0f172a] text-[14px] top-[-537.19px] whitespace-nowrap">​</p>
      <Option />
      <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[-528.66px] not-italic text-[#0f172a] text-[14px] top-[-537.19px] whitespace-nowrap">
...
function Text1() {
  return (
    <div className="absolute content-stretch flex h-[13.333px] items-start left-0 top-[65.33px] w-[576.007px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[11px]">Auto-suggested based on deal type</p>
    </div>
  );
}
...
function Container33() {
  return (
    <div className="absolute h-[78.663px] left-0 top-0 w-[576.007px]" data-name="Container">
      <Label4 />
      <Dropdown />
      <Text1 />
    </div>
...
function Option4() {
  return <div className="absolute left-[-528.66px] size-0 top-[-687.07px]" data-name="Option" />;
}
...
function Dropdown1() {
  return (
    <div className="h-[37.222px] relative rounded-[8px] shrink-0 w-[576.007px]" data-name="Dropdown">
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[-528.66px] not-italic text-[#0f172a] text-[14px] top-[-687.07px] whitespace-nowrap">​</p>
        <Option4 />
        <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[-528.66px] not-italic text-[#0f172a] text-[14px] top-[-687.07px] whitespace-nowrap">
          <p className="leading-[normal] mb-0 whitespace-pre">​</p>
          <p className="leading-[normal] whitespace-pre">{`          `}</p>
        </div>
        <Option5 />
...
function Container36() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[58.333px] items-start left-0 top-0 w-[576.007px]" data-name="Container">
      <Label5 />
      <Dropdown1 />
    </div>
  );
...
function TextInput4() {
  return (
    <div className="absolute bg-white content-stretch flex h-[16.111px] items-center left-[229.33px] overflow-clip top-[12.94px] w-[334.123px]" data-name="Text Input">
...
function Container39() {
  return (
    <div className="h-[41.997px] relative rounded-[8px] shrink-0 w-[576.007px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container40 />
        <Container41 />
...
function Container38() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[63.108px] items-start left-0 top-0 w-[576.007px]" data-name="Container">
      <Label6 />
      <Container39 />
    </div>
  );
...
function Label7() {
  return (
    <div className="absolute content-stretch flex h-[16.111px] items-start left-0 top-0 w-[280px]" data-name="Label">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Start Date</p>
    </div>
  );
}

function DatePicker() {
  return <div className="absolute bg-white border-[#e2e8f0] border-[0.556px] border-solid h-[39.774px] left-0 rounded-[8px] top-[21.11px] w-[280px]" data-name="Date Picker" />;
}

function Text4() {
  return (
    <div className="absolute content-stretch flex h-[13.333px] items-start left-0 top-[67.88px] w-[280px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[11px]">From deal close date</p>
    </div>
  );
}
...
function Container44() {
  return (
    <div className="absolute h-[81.215px] left-0 top-0 w-[280px]" data-name="Container">
      <Label7 />
      <DatePicker />
      <Text4 />
    </div>
...
function Label8() {
  return (
    <div className="absolute content-stretch flex h-[16.111px] items-start left-0 top-0 w-[280.009px]" data-name="Label">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">End Date</p>
    </div>
  );
}

function DatePicker1() {
  return <div className="absolute bg-white border-[#e2e8f0] border-[0.556px] border-solid h-[39.774px] left-0 rounded-[8px] top-[21.11px] w-[280.009px]" data-name="Date Picker" />;
}

function Text5() {
  return (
    <div className="absolute content-stretch flex h-[13.333px] items-start left-0 top-[67.88px] w-[280.009px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[11px]">From deal timeline</p>
    </div>
  );
}
...
function Container45() {
  return (
    <div className="absolute h-[81.215px] left-[296px] top-0 w-[280.009px]" data-name="Container">
      <Label8 />
      <DatePicker1 />
      <Text5 />
    </div>
...
function Container17() {
  return (
    <div className="absolute bg-[rgba(15,23,42,0.45)] content-stretch flex h-[1088px] items-center justify-center left-0 px-[496.667px] top-0 w-[1633px]" data-name="Container">
      <Container18 />
    </div>
  );
}
