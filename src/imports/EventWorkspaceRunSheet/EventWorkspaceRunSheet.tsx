"use client";
import svgPaths from "./svg-n1r7mzaxcv";
...
function Cell() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[24.5px] pt-[23.5px] px-[24px] relative shrink-0 w-[118.86px]" data-name="Cell">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[16px] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[12px] tracking-[0.6px] uppercase w-[32.25px]">
...
function Cell1() {
  return (
    <div className="content-stretch flex flex-col items-start min-w-[200px] pb-[24.5px] pt-[23.5px] px-[24px] relative shrink-0 w-[200px]" data-name="Cell">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[16px] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[12px] tracking-[0.6px] uppercase w-[99.25px]">
        <p className="leading-[16px]">Session Name</p>
      </div>
    </div>
  );
}
...
function Cell2() {
  return (
    <div className="content-stretch flex flex-col items-start min-w-[300px] pb-[24.5px] pt-[23.5px] px-[24px] relative shrink-0 w-[300px]" data-name="Cell">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[16px] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[12px] tracking-[0.6px] uppercase w-[88.09px]">
...
function Cell3() {
  return (
    <div className="content-stretch flex flex-col items-start px-[24px] py-[16px] relative shrink-0 w-[170.92px]" data-name="Cell">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[32px] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[12px] tracking-[0.6px] uppercase w-[89.05px]">
        <p className="leading-[16px] mb-0">Responsible</p>
        <p className="leading-[16px]">Person</p>
      </div>
    </div>
  );
}
...
function Cell4() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[24.5px] pt-[23.5px] px-[24px] relative shrink-0 w-[168.22px]" data-name="Cell">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[16px] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[12px] tracking-[0.6px] uppercase w-[66.7px]">
...
function Data() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-[70.86px]" data-name="Data">
      <div className="bg-[#10b981] h-[8px] rounded-[9999px] shrink-0 w-[6.73px]" data-name="Background" />
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[40px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] w-[40.18px]">
        <p className="leading-[20px] mb-0">08:00</p>
...
function Data1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152px]" data-name="Data">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[40px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] w-[95.56px]">
        <p className="leading-[20px] mb-0">{`Registration &`}</p>
        <p className="leading-[20px]">Breakfast</p>
      </div>
    </div>
  );
}
...
function Data2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[252px]" data-name="Data">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[40px] justify-center leading-[0] not-italic relative shrink-0 text-[#475569] text-[14px] w-[247.61px]">
        <p className="leading-[20px] mb-0">Guest check-in and breakfast service</p>
        <p className="leading-[20px]">in the main lobby.</p>
      </div>
    </div>
  );
}
...
function Overlay1() {
  return (
    <div className="bg-[rgba(80,72,229,0.2)] content-stretch flex items-center justify-center relative rounded-[9999px] shrink-0 size-[24px]" data-name="Overlay">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[12px] justify-center leading-[0] not-italic relative shrink-0 text-[#5048e5] text-[10px] text-center w-[16.83px]">
...
function Container40() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[16px] justify-center leading-[0] not-italic relative shrink-0 text-[#334155] text-[12px] w-[72.5px]">
        <p className="leading-[16px]">Maria Garcia</p>
      </div>
    </div>
  );
}
...
function Data3() {
  return (
    <div className="bg-[#f1f5f9] content-stretch flex gap-[8px] items-center p-[6px] relative rounded-[8px] shrink-0 w-[122.92px]" data-name="Data">
      <Overlay1 />
      <Container40 />
    </div>
  );
  ...
  return (
    <div className="h-[15px] relative shrink-0 w-[12px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 15">
        <g id="Container">
          <path d={svgPaths.p1a900f00} fill="var(--fill-0, #94A3B8)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Data4() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-[120.22px]" data-name="Data">
      <Container41 />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[60px] justify-center leading-[0] not-italic relative shrink-0 text-[#475569] text-[14px] w-[57.91px]">
        <p className="leading-[20px] mb-0">Grand</p>
        <p className="leading-[20px] mb-0">Ballroom</p>
        <p className="leading-[20px]">Foyer</p>
      </div>
    </div>
  );
}
...
function Row() {
  return (
    <div className="content-stretch flex gap-[48px] items-center justify-center pb-[20.5px] pt-[19.5px] relative shrink-0 w-full" data-name="Row">
      <Data />
      <Data1 />
      <Data2 />
      <Data3 />
...
function Data5() {
  return (
    <div className="relative shrink-0 w-[70.86px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <div className="bg-[#5048e5] h-[8px] rounded-[9999px] shrink-0 w-[6.73px]" data-name="Background" />
        <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[40px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] w-[40.19px]">
          <p className="leading-[20px] mb-0">09:00</p>
          <p className="leading-[20px]">AM</p>
        </div>
      </div>
    </div>
...
function Data6() {
  return (
    <div className="relative shrink-0 w-[152px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] w-[118.02px]">
          <p className="leading-[20px]">Opening Keynote</p>
        </div>
      </div>
    </div>
  );
...
function Data7() {
  return (
    <div className="relative shrink-0 w-[252px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[40px] justify-center leading-[0] not-italic relative shrink-0 text-[#475569] text-[14px] w-[240.11px]">
          <p className="leading-[20px] mb-0">Welcome speech and deep dive into</p>
          <p className="leading-[20px]">the 2024 AI Industry Outlook.</p>
        </div>
      </div>
    </div>
  );
...
function Background3() {
  return (
    <div className="bg-[#ffedd5] content-stretch flex h-[24px] items-center justify-center relative rounded-[9999px] shrink-0 w-[23.53px]" data-name="Background">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[12px] justify-center leading-[0] not-italic relative shrink-0 text-[#ea580c] text-[10px] text-center w-[12.41px]">
        <p className="leading-[normal]">SJ</p>
      </div>
    </div>
  );
}
...
function Container42() {
  return (
    <div className="content-stretch flex flex-col items-start pr-[34.8px] relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[32px] justify-center leading-[0] not-italic relative shrink-0 text-[#334155] text-[12px] w-[44.59px]">
        <p className="leading-[16px] mb-0">Sarah</p>
        <p className="leading-[16px]">Jenkins</p>
      </div>
    </div>
  );
}
...
function Data8() {
  return (
    <div className="bg-[#f1f5f9] relative rounded-[8px] shrink-0 w-[122.92px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center p-[6px] relative size-full">
        <Background3 />
        <Container42 />
      </div>
    </div>
...
function Data9() {
  return (
    <div className="relative shrink-0 w-[120.22px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[6px] items-center relative size-full">
        <Container43 />
        <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#475569] text-[14px] w-[74.36px]">
          <p className="leading-[20px]">Main Stage</p>
        </div>
      </div>
    </div>
  );
...
function Row1() {
  return (
    <div className="content-stretch flex gap-[48px] items-center justify-center py-[20.5px] relative shrink-0 w-full" data-name="Row">
...
function Data10() {
  return (
    <div className="relative shrink-0 w-[70.86px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <div className="bg-[#5048e5] h-[8px] rounded-[9999px] shrink-0 w-[7.05px]" data-name="Background" />
        <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[40px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] w-[36.92px]">
          <p className="leading-[20px] mb-0">10:30</p>
          <p className="leading-[20px]">AM</p>
        </div>
      </div>
    </div>
...
function Data11() {
  return (
    <div className="relative shrink-0 w-[152px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] w-[132.83px]">
          <p className="leading-[20px]">Breakout Session A</p>
        </div>
      </div>
    </div>
  );
...
function Data12() {
  return (
    <div className="relative shrink-0 w-[252px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[40px] justify-center leading-[0] not-italic relative shrink-0 text-[#475569] text-[14px] w-[239.31px]">
          <p className="leading-[20px] mb-0">Technical workshop on the future of</p>
          <p className="leading-[20px]">decentralized Cloud Computing.</p>
        </div>
      </div>
    </div>
  );
...
function Background4() {
  return (
    <div className="bg-[#dbeafe] content-stretch flex items-center justify-center relative rounded-[9999px] shrink-0 size-[24px]" data-name="Background">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[12px] justify-center leading-[0] not-italic relative shrink-0 text-[#2563eb] text-[10px] text-center w-[16.72px]">
        <p className="leading-[normal]">MC</p>
      </div>
    </div>
  );
}
...
function Container44() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[16px] justify-center leading-[0] not-italic relative shrink-0 text-[#334155] text-[12px] w-[78.5px]">
...
function Data14() {
  return (
    <div className="relative shrink-0 w-[120.22px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[6px] items-center relative size-full">
        <Container45 />
        <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#475569] text-[14px] w-[67.81px]">
          <p className="leading-[20px]">Room 302</p>
        </div>
      </div>
    </div>
  );
...
function Row2() {
  return (
    <div className="content-stretch flex gap-[48px] items-center justify-center pb-[20.5px] pt-[20px] relative shrink-0 w-full" data-name="Row">
      <div aria-hidden="true" className="absolute border-[#f1f5f9] border-solid border-t inset-0 pointer-events-none" />
      <Data10 />
      <Data11 />
      <Data12 />
...
function Data15() {
  return (
    <div className="relative shrink-0 w-[70.86px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <div className="bg-[#f59e0b] h-[8px] rounded-[9999px] shrink-0 w-[7.16px]" data-name="Background" />
        <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[40px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] w-[36.76px]">
          <p className="leading-[20px] mb-0">12:00</p>
...
function Data16() {
  return (
    <div className="relative shrink-0 w-[152px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] w-[125.73px]">
          <p className="leading-[20px]">Networking Lunch</p>
        </div>
      </div>
    </div>
  );
...
function Data17() {
  return (
    <div className="relative shrink-0 w-[252px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[40px] justify-center leading-[0] not-italic relative shrink-0 text-[#475569] text-[14px] w-[250.03px]">
          <p className="leading-[20px] mb-0">Curated networking meal for Platinum</p>
          <p className="leading-[20px]">and Gold ticket holders.</p>
        </div>
      </div>
    </div>
  );
...
function Background5() {
  return (
    <div className="bg-[#d1fae5] content-stretch flex items-center justify-center relative rounded-[9999px] shrink-0 size-[24px]" data-name="Background">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[12px] justify-center leading-[0] not-italic relative shrink-0 text-[#059669] text-[10px] text-center w-[16.83px]">
        <p className="leading-[normal]">MG</p>
      </div>
    </div>
  );
...
function Data19() {
  return (
    <div className="relative shrink-0 w-[120.22px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[6px] items-center relative size-full">
        <Container47 />
        <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[40px] justify-center leading-[0] not-italic relative shrink-0 text-[#475569] text-[14px] w-[50.89px]">
          <p className="leading-[20px] mb-0">Garden</p>
          <p className="leading-[20px]">Terrace</p>
        </div>
      </div>
    </div>
  );
...
function Data20() {
  return (
    <div className="relative shrink-0 w-[70.86px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <div className="bg-[#5048e5] h-[8px] rounded-[9999px] shrink-0 w-[7.14px]" data-name="Background" />
        <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[40px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] w-[36.92px]">
          <p className="leading-[20px] mb-0">01:30</p>
          <p className="leading-[20px]">PM</p>
        </div>
      </div>
    </div>
...
function Data21() {
  return (
    <div className="relative shrink-0 w-[152px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[40px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] w-[144.19px]">
          <p className="leading-[20px] mb-0">Panel: Cybersecurity</p>
          <p className="leading-[20px]">in 2025</p>
        </div>
      </div>
    </div>
  );
...
function Data22() {
  return (
    <div className="relative shrink-0 w-[252px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[40px] justify-center leading-[0] not-italic relative shrink-0 text-[#475569] text-[14px] w-[228.44px]">
          <p className="leading-[20px] mb-0">Industry experts discuss emerging</p>
          <p className="leading-[20px]">threats and defensive strategies.</p>
        </div>
      </div>
    </div>
  );
...
function Background6() {
  return (
    <div className="bg-[#f3e8ff] content-stretch flex items-center justify-center relative rounded-[9999px] shrink-0 size-[24px]" data-name="Background">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[12px] justify-center leading-[0] not-italic relative shrink-0 text-[#9333ea] text-[10px] text-center w-[17.13px]">
        <p className="leading-[normal]">AW</p>
      </div>
    </div>
  );
}
...
function Container48() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium h-[16px] justify-center leading-[0] not-italic relative shrink-0 text-[#334155] text-[12px] w-[61.55px]">
        <p className="leading-[16px]">Alex Wong</p>
      </div>
    </div>
  );
}
...
function Row4() {
  return (
    <div className="content-stretch flex gap-[48px] items-center justify-center py-[20px] relative shrink-0 w-full" data-name="Row">
      <div aria-hidden="true" className="absolute border-[#f1f5f9] border-solid border-t inset-0 pointer-events-none" />
      <Data20 />
      <Data21 />
      <Data22 />
...
export default function EventWorkspaceRunSheet() {
  return (
    <div className="bg-[#f6f6f8] content-stretch flex flex-col items-start relative size-full" data-name="Event Workspace - Run sheet">
      <Body />
    </div>
  );
}