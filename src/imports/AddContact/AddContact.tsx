"use client";
import svgPaths from "./svg-47niauzfwe";
...
function Container19() {
  return (
    <div className="absolute content-stretch flex h-[24.5px] items-start left-[32px] top-[32px] w-[536px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Extra_Bold',sans-serif] font-extrabold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Add Contact</p>
    </div>
  );
}
...
function Container20() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[32px] top-[60.5px] w-[536px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[14px]">Add a new contact to your CRM database.</p>
    </div>
  );
}
...
function Label() {
  return (
    <div className="h-[15.5px] relative shrink-0 w-[260px]" data-name="Label">
    ...
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[260px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">First name</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container22() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[59.5px] items-start left-0 top-0 w-[260px]" data-name="Container">
      <Label />
      <TextInput1 />
    </div>
  );
...
function TextInput2() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[260px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Last name</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container23() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[59.5px] items-start left-[276px] top-0 w-[260px]" data-name="Container">
      <Label1 />
      <TextInput2 />
    </div>
  );
...
function Container21() {
  return (
    <div className="absolute h-[59.5px] left-[32px] top-[101.5px] w-[536px]" data-name="Container">
      <Container22 />
      <Container23 />
    </div>
  );
...
function EmailInput() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[260px]" data-name="Email Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">name@company.com</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container24() {
  return (
    <div className="absolute h-[59.5px] left-[32px] top-[177px] w-[536px]" data-name="Container">
      <Container25 />
      <Container26 />
    </div>
  );
...
function HorizontalRule() {
  return <div className="absolute border-[#f1f5f9] border-solid border-t h-px left-[32px] top-[256.5px] w-[536px]" data-name="Horizontal Rule" />;
}
...
function Option() {
  return <div className="absolute left-[-467px] size-0 top-[-395.5px]" data-name="Option" />;
}
...
function Dropdown() {
  return (
    <div className="h-[38px] relative rounded-[8px] shrink-0 w-[260px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[8px]">
        ...
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[15.79%] left-0 max-w-none top-[42.11%] w-[3.85%]" src={imgDropdown.src} />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[-467px] not-italic text-[#0f172a] text-[14px] top-[-395.5px] whitespace-nowrap">​</p>
        <Option />
        <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[-467px] not-italic text-[#0f172a] text-[14px] top-[-395.5px] whitespace-nowrap">
...
function Label5() {
  return (
    <div className="h-[15.5px] relative shrink-0 w-[260px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Role / Title</p>
      </div>
    </div>
  );
}
...
function TextInput3() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[260px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">e.g. CTO, Product Manager</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container27() {
  return (
    <div className="absolute h-[59.5px] left-[32px] top-[277.5px] w-[536px]" data-name="Container">
      <Container28 />
      <Container29 />
    </div>
  );
...
function Label6() {
  return (
    <div className="h-[15.5px] relative shrink-0 w-[536px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Source</p>
      </div>
    </div>
  );
}
...
function Option4() {
  return <div className="absolute left-[-467px] size-0 top-[-471px]" data-name="Option" />;
}
...
function Dropdown1() {
  return (
    <div className="flex-[1_0_0] min-h-px relative rounded-[8px] w-[536px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[8px]">
        <div className="absolute bg-clip-padding bg-white border-0 border-[transparent] border-solid inset-0 rounded-[8px]" />
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[15.79%] left-0 max-w-none top-[42.11%] w-[1.87%]" src={imgDropdown.src} />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[-467px] not-italic text-[#0f172a] text-[14px] top-[-471px] whitespace-nowrap">​</p>
        <Option4 />
        <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[-467px] not-italic text-[#0f172a] text-[14px] top-[-471px] whitespace-nowrap">
          <p className="leading-[normal] mb-0 whitespace-pre">​</p>
          <p className="leading-[normal] whitespace-pre">{`          `}</p>
        </div>
        <Option5 />
...
function Container31() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[58.5px] items-start left-0 top-0 w-[536px]" data-name="Container">
      <Label6 />
      <Dropdown1 />
    </div>
  );
...
function Container30() {
  return (
    <div className="absolute h-[58.5px] left-[32px] top-[353px] w-[536px]" data-name="Container">
      <Container31 />
    </div>
  );
}
...
function TextArea() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[536px]" data-name="Text Area">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Any additional context about this contact...</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container33() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[93.5px] items-start left-0 top-0 w-[536px]" data-name="Container">
      <Label7 />
      <TextArea />
    </div>
  );
...
function Container32() {
  return (
    <div className="absolute h-[93.5px] left-[32px] top-[427.5px] w-[536px]" data-name="Container">
      <Container33 />
    </div>
  );
}
...
function Button2() {
  return (
    <div className="bg-[#5048e5] h-[39px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(80,72,229,0.2),0px_4px_6px_0px_rgba(80,72,229,0.2)] shrink-0 w-[118.539px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[17px] py-[10px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Add Contact</p>
      </div>
    </div>
  );
}
...
function Container34() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[60px] items-start justify-end left-[32px] pt-[21px] top-[545px] w-[536px]" data-name="Container">
...
function Container18() {
  return (
    <div className="bg-white h-[637px] relative rounded-[20px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] shrink-0 w-[600px]" data-name="Container">
...
function Container17() {
  return (
    <div className="absolute bg-[rgba(15,23,42,0.45)] content-stretch flex h-[832px] items-center justify-center left-0 px-[435px] top-0 w-[1470px]" data-name="Container">
      <Container18 />
    </div>
  );
}
...
export default function AddContact() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Add Contact">
      <MainContent />
      <Sidebar />
      <Header />
      <Container17 />
