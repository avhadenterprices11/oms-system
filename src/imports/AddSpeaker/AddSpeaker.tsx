"use client";
import svgPaths from "./svg-vok635p5xy";
...
function Icon6() {
  return (
    <div className="absolute left-[12px] size-[17.995px] top-[9px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.9948 17.9948">
        <g id="Icon">
          <path d={svgPaths.p1e56f800} id="Vector" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49957" />
          <path d="M1.99942 6.99797H15.9954" id="Vector_2" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49957" />
          <path d="M5.99826 2.99913V6.99798" id="Vector_3" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49957" />
          <path d="M11.9965 2.99913V6.99798" id="Vector_4" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49957" />
        </g>
      </svg>
    </div>
  );
...
function Link5() {
  return (
    <div className="bg-[rgba(80,72,229,0.08)] h-[35.998px] relative rounded-[8px] shrink-0 w-[223.446px]" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon6 />
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[41.99px] not-italic text-[#5048e5] text-[14px] top-[9.66px] whitespace-nowrap">Events</p>
      </div>
    </div>
  );
}
...
function Container20() {
  return (
    <div className="absolute content-stretch flex h-[24.444px] items-start left-[32px] top-[32px] w-[496.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Add Speaker</p>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[32px] top-[60.43px] w-[496.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[14px]">Add a speaker to the event run sheet.</p>
    </div>
  );
}
...
function Icon19() {
  return (
    <div className="relative shrink-0 size-[17.995px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.9948 17.9948">
        <g id="Icon">
          <path d={svgPaths.p273a7380} id="Vector" stroke="var(--stroke-0, #94A3B8)" strokeWidth="1.49957" />
        </g>
      </svg>
    </div>
  );
...
function Text() {
  return (
    <div className="h-[9.444px] relative shrink-0 w-[28.212px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[8px] uppercase whitespace-nowrap">Photo</p>
      </div>
    </div>
  );
}
...
function Container23() {
  return (
    <div className="relative rounded-[31.997px] shrink-0 size-[63.993px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[1.667px] border-dashed inset-0 pointer-events-none rounded-[31.997px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[1.997px] items-center justify-center pb-[17.283px] pt-[17.275px] px-[1.667px] relative size-full">
        <Icon19 />
        <Text />
      </div>
    </div>
...
function Label() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[200.009px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
...
function TextInput1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[200.009px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Full name</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container25() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[58.889px] items-start left-0 top-0 w-[200.009px]" data-name="Container">
      <Label />
      <TextInput1 />
    </div>
  );
...
function Label1() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[200.009px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Title / Role</p>
      </div>
    </div>
  );
}
...
function TextInput2() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[200.009px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">e.g. CTO</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container26() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[58.889px] items-start left-[216.01px] top-0 w-[200.009px]" data-name="Container">
      <Label1 />
      <TextInput2 />
    </div>
  );
...
function Container24() {
  return (
    <div className="flex-[416.016_0_0] h-[58.889px] min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container25 />
        <Container26 />
      </div>
...
function Container22() {
  return (
    <div className="absolute content-stretch flex gap-[15.998px] h-[63.993px] items-start left-[32px] top-[101.09px] w-[496.007px]" data-name="Container">
      <Container23 />
      <Container24 />
    </div>
  );
...
function Label2() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[240px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Company</p>
      </div>
    </div>
  );
}
...
function TextInput3() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[240px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Company name</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container28() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[58.889px] items-start left-0 top-0 w-[240px]" data-name="Container">
      <Label2 />
      <TextInput3 />
    </div>
  );
...
function Label3() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[240.009px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] min-w-px not-italic relative text-[#334155] text-[13px]">
...
function EmailInput() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[240.009px]" data-name="Email Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">speaker@company.com</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container29() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[58.889px] items-start left-[256px] top-0 w-[240.009px]" data-name="Container">
      <Label3 />
      <EmailInput />
    </div>
  );
...
function Container27() {
  return (
    <div className="absolute h-[58.889px] left-[32px] top-[181.09px] w-[496.007px]" data-name="Container">
      <Container28 />
      <Container29 />
    </div>
  );
...
function PhoneInput() {
  return (
    <div className="bg-white h-[37.778px] relative rounded-[8px] shrink-0 w-[240px]" data-name="Phone Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">+91 98765 43210</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Label5() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[240.009px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Topic / Session</p>
      </div>
    </div>
  );
}
...
function TextInput4() {
  return (
    <div className="bg-white h-[37.778px] relative rounded-[8px] shrink-0 w-[240.009px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Session title</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container30() {
  return (
    <div className="absolute h-[58.889px] left-[32px] top-[255.97px] w-[496.007px]" data-name="Container">
      <Container31 />
      <Container32 />
    </div>
  );
...
function Label6() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[496.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Bio</p>
      </div>
    </div>
  );
}
...
function TextArea() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[496.007px]" data-name="Text Area">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Brief speaker bio...</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container34() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[92.222px] items-start left-0 top-0 w-[496.007px]" data-name="Container">
      <Label6 />
      <TextArea />
    </div>
  );
...
function Container33() {
  return (
    <div className="absolute h-[92.222px] left-[32px] top-[330.86px] w-[496.007px]" data-name="Container">
      <Container34 />
    </div>
  );
}
...
function Label7() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[247.431px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Time Slot</p>
      </div>
    </div>
  );
}
...
function Dropdown() {
  return (
    <div className="h-[37.778px] relative rounded-[8px] shrink-0 w-[247.431px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[8px]">
        ...
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[15.88%] left-0 max-w-none top-[42.06%] w-[4.04%]" src={imgDropdown.src} />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-568.663px] pr-[816.094px] pt-[-553.828px] relative size-full">
        <Option />
        <Option1 />
        <Option2 />
        <Option3 />
...
function Container36() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[58.889px] items-start left-0 top-0 w-[247.431px]" data-name="Container">
      <Label7 />
      <Dropdown />
    </div>
  );
...
function Container35() {
  return (
    <div className="absolute h-[58.889px] left-[32px] top-[439.08px] w-[496.007px]" data-name="Container">
      <Container36 />
    </div>
  );
}
...
function Container38() {
  return (
    <div className="absolute content-stretch flex h-[16.111px] items-start left-0 top-[11.94px] w-[216.302px]" data-name="Container">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#334155] text-[13px] whitespace-nowrap">{`Travel & Accommodation Required`}</p>
    </div>
  );
}
...
function Container39() {
  return (
    <div className="absolute bg-[#5048e5] content-stretch flex flex-col h-[20px] items-start left-[460.01px] pl-[17.995px] pr-[2.005px] pt-[1.997px] rounded-[10px] top-[10px] w-[35.998px]" data-name="Container">
      <Container40 />
    </div>
  );
}
...
function Container37() {
  return (
    <div className="absolute h-[40px] left-[32px] top-[530.52px] w-[496.007px]" data-name="Container">
      <Container38 />
      <Container39 />
    </div>
  );
...
function Label8() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[240px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Travel From</p>
      </div>
    </div>
  );
}
...
function TextInput5() {
  return (
    <div className="bg-white h-[37.778px] relative rounded-[8px] shrink-0 w-[240px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">City / Airport</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container42() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[60.885px] items-start left-0 top-0 w-[240px]" data-name="Container">
      <Label8 />
      <TextInput5 />
    </div>
  );
...
function Label9() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[240.009px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Hotel Check-in</p>
      </div>
    </div>
  );
}
...
function DatePicker() {
  return (
    <div className="bg-white h-[39.774px] relative rounded-[8px] shrink-0 w-[240.009px]" data-name="Date Picker">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
}
...
function Container43() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[60.885px] items-start left-[256px] top-0 w-[240.009px]" data-name="Container">
      <Label9 />
      <DatePicker />
    </div>
  );
...
function Container41() {
  return (
    <div className="absolute h-[60.885px] left-[32px] top-[582.52px] w-[496.007px]" data-name="Container">
      <Container42 />
      <Container43 />
    </div>
  );
...
function Button2() {
  return (
    <div className="bg-[#5048e5] h-[37.778px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(80,72,229,0.2)] shrink-0 w-[126.78px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[20px] py-[10px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Add Speaker</p>
      </div>
    </div>
  );
}
...
function Container44() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[37.778px] items-start justify-end left-[32px] top-[667.4px] w-[496.007px]" data-name="Container">
      <Button1 />
      <Button2 />
    </div>
  );
...
function Container19() {
  return (
    <div className="bg-white h-[737.17px] relative rounded-[20px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] shrink-0 w-[560px]" data-name="Container">
...
export default function AddSpeaker() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Add Speaker">
      <Body />
      <Sidebar />
      <Header />
      <Container18 />
