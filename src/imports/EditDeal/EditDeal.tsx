"use client";
import svgPaths from "./svg-rokg4yycc8";
...
function Container3() {
  return (
    <div className="h-[24.002px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#64748b] text-[16px] top-[-0.78px] whitespace-nowrap">Deal overview</p>
    </div>
  );
}
...
function Container24() {
  return (
    <div className="absolute content-stretch flex h-[24.444px] items-start left-[32px] top-[32px] w-[536.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Edit Deal</p>
    </div>
  );
}
...
function Container25() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[32px] top-[60.43px] w-[536.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[14px]">Update deal details for Portal Customization</p>
    </div>
  );
}
    ...
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[260px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[14px] whitespace-nowrap">Portal Customization</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Dropdown() {
  return (
    <div className="flex-[1_0_0] min-h-px relative rounded-[8px] w-[260.009px]" data-name="Dropdown">
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-824.661px] pr-[1084.67px] pt-[-333.941px] relative size-full">
        <Option />
        <Option1 />
        <Option2 />
      </div>
...
function Label2() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[260px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Primary Contact</p>
      </div>
    </div>
  );
}
...
function Dropdown1() {
  return (
    <div className="flex-[1_0_0] min-h-px relative rounded-[8px] w-[260px]" data-name="Dropdown">
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-548.663px] pr-[808.663px] pt-[-408.828px] relative size-full">
        <Option3 />
        <Option4 />
        <Option5 />
      </div>
...
function Dropdown2() {
  return (
    <div className="flex-[1_0_0] min-h-px relative rounded-[8px] w-[260.009px]" data-name="Dropdown">
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-824.661px] pr-[1084.67px] pt-[-408.828px] relative size-full">
        <Option6 />
        <Option7 />
        <Option8 />
        <Option9 />
...
function TextInput2() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[260px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[14px] whitespace-nowrap">$85,000</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function NumberInput() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[260.009px]" data-name="Number Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[14px] whitespace-nowrap">75</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Dropdown3() {
  return (
    <div className="h-[37.778px] relative rounded-[8px] shrink-0 w-[260px]" data-name="Dropdown">
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-548.663px] pr-[808.663px] pt-[-558.602px] relative size-full">
        <Option10 />
        <Option11 />
        <Option12 />
        <Option13 />
...
function Container36() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[60.885px] items-start left-0 top-0 w-[260px]" data-name="Container">
      <Label6 />
      <Dropdown3 />
    </div>
  );
...
function DatePicker() {
  return (
    <div className="bg-white h-[39.774px] relative rounded-[8px] shrink-0 w-[260.009px]" data-name="Date Picker">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
}
...
function Container37() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[60.885px] items-start left-[276px] top-0 w-[260.009px]" data-name="Container">
      <Label7 />
      <DatePicker />
    </div>
  );
...
function Container35() {
  return (
    <div className="absolute h-[60.885px] left-[32px] top-[325.76px] w-[536.007px]" data-name="Container">
      <Container36 />
      <Container37 />
    </div>
  );
...
function Container38() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[58.333px] items-start justify-end left-[32px] pt-[20.556px] top-[410.63px] w-[536.007px]" data-name="Container">
...
function Container23() {
  return (
    <div className="bg-white h-[500.964px] relative rounded-[20px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] shrink-0 w-[600px]" data-name="Container">
...
export default function EditDeal() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Edit Deal">
      <Body />
      <Sidebar />
      <Header />
      <Container22 />
