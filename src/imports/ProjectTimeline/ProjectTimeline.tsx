"use client";
import svgPaths from "./svg-ov0a06gnc0";
...
function TimelineHeaderMonths() {
  return (
    <div className="bg-[#f8fafc] h-[49px] relative shrink-0 w-[998px]" data-name="Timeline Header (Months)">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-b border-solid inset-0 pointer-events-none" />
...
function GanttRows() {
  return (
    <div className="relative shrink-0 w-[998px]" data-name="Gantt Rows">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
...
function GanttContent() {
  return (
    <div className="absolute bg-[#f6f6f8] content-stretch flex flex-col gap-[32px] h-[711px] items-start left-0 overflow-clip p-[32px] right-0 top-[246px]" data-name="Gantt Content">
...
export default function ProjectTimeline() {
  return (
    <div className="bg-[#f6f6f8] content-stretch flex flex-col items-start relative size-full" data-name="Project Timeline">
      <Body />
    </div>
  );
}