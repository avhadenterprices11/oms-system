"use client";
import svgPaths from "./svg-7ncdc3bxf9";
...
function ProjectTaskTable() {
  return (
    <div className="bg-white h-[714px] relative shrink-0 w-full" data-name="Project Task Table">
...
export default function ClientDeliveryTasksTab() {
  return (
    <div className="bg-[#f6f6f8] content-stretch flex flex-col items-start relative size-full" data-name="Client Delivery - Tasks Tab">
      <Body />
    </div>
  );
}