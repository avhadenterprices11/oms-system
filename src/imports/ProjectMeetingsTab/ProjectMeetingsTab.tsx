"use client";
import svgPaths from "./svg-znory5fg42";
...
function MeetingsList() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-[593px] items-start relative shrink-0 w-full" data-name="Meetings List">
      <MeetingEntry />
      <MeetingEntry1 />
      <MeetingEntry2 />
    </div>
...
function Container40() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] h-[681px] items-start relative shrink-0 w-full" data-name="Container">
      <Container41 />
      <MeetingsList />
      <PaginationViewMore />
    </div>
...
function WorkspaceContent1() {
  return (
    <div className="absolute bg-[#f6f6f8] content-stretch flex flex-col h-[714px] items-start left-0 p-[32px] right-0 top-[246px]" data-name="Workspace Content">
      <Container40 />
    </div>
  );
}
...
export default function ProjectMeetingsTab() {
  return (
    <div className="bg-[#f6f6f8] content-stretch flex flex-col items-start relative size-full" data-name="Project Meetings tab">
      <Body />
    </div>
  );
}