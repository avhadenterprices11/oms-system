"use client";
import svgPaths from "./svg-r04azdwelu";
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 2">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[36px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[30px] tracking-[-0.75px] w-[195.25px]">
        <p className="leading-[36px]">Organisations</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[24px] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[16px] w-[485.13px]">
        <p className="leading-[24px]">Manage and track your business relationships across industries.</p>
      </div>
    </div>
  );
}
...
function Container22() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[485.13px]" data-name="Container">
      <Heading />
      <Container23 />
    </div>
  );
...
function Row({ 
  ...
  return (
    ...
    >
      ...
      {/* Active Deals */}
      <div className="px-4 py-4 text-center overflow-hidden">
        <span className="text-[#0f172a] text-sm font-bold">{deals}</span>
      </div>

      {/* Actions */}
      <div className="pl-4 pr-8 py-4 text-right overflow-hidden">
        <button className="p-2 hover:bg-[#f1f5f9] rounded-lg transition-colors text-[#64748b]">
