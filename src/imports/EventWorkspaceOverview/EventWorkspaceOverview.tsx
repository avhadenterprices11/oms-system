"use client";
import svgPaths from "./svg-xig1b6ij25";
import imgProfilePic from "./8903f064e14b604493b2a186385c8300714f69a3.png";
import imgUser from "./7085a59588279bfdd897300585ce83db8aa4c2f0.png";
import imgUser1 from "./912f2fbc94d047313197dc39068ebd16db25ab1c.png";
...
function Button3() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center pb-[18px] relative shrink-0" data-name="Button">
      ...
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#5048e5] text-[14px] text-center w-[65.44px]">
...
function Heading1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Heading 3">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[18px] whitespace-nowrap">
        <p className="leading-[28px]">Event Brief</p>
      </div>
    </div>
  );
}
...
function Button12() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0" data-name="Button">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[16px] justify-center leading-[0] not-italic relative shrink-0 text-[#5048e5] text-[12px] text-center w-[53.41px]">
        <p className="leading-[16px]">Edit Brief</p>
      </div>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.75px] relative size-full">
        <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#475569] text-[14px] w-full">
          <p className="leading-[22.75px] mb-0">The Q3 Product Launch focuses on releasing the version 2.0 of our core platform. This</p>
          <p className="leading-[22.75px] mb-0">includes a complete UI overhaul, new automation modules, and enhanced API</p>
          <p className="leading-[22.75px] mb-0">documentation. We are currently in the final stages of the beta testing phase with key</p>
          <p className="leading-[22.75px] mb-0">stakeholders to ensure maximum stability and user satisfaction before the public</p>
          <p className="leading-[22.75px]">rollout.</p>
        </div>
      </div>
    </div>
  );
...
function SectionProjectBrief() {
  return (
    <div className="bg-white drop-shadow-[0px_1px_1px_rgba(0,0,0,0.05)] relative rounded-[24px] shrink-0 w-full" data-name="Section - Project Brief">
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <div className="content-stretch flex flex-col gap-[15px] items-start p-[25px] relative size-full">
        <Container41 />
        <Container42 />
      </div>
    </div>
...
function Heading2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Heading 3">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[28px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[18px] w-[134.53px]">
        <p className="leading-[28px]">Key Milestones</p>
      </div>
    </div>
  );
}
...
function Button13() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0" data-name="Button">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#5048e5] text-[14px] text-center w-[55.66px]">
...
function Background3() {
  return (
    <div className="bg-[#d1fae5] content-stretch flex items-center justify-center relative rounded-[9999px] shrink-0 size-[32px]" data-name="Background">
      <Container46 />
    </div>
  );
}
...
function Background4() {
  return (
    <div className="bg-[#ecfdf5] content-stretch flex flex-col items-start px-[8px] py-[2px] relative rounded-[4px] shrink-0" data-name="Background">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[15px] justify-center leading-[0] not-italic relative shrink-0 text-[#059669] text-[10px] uppercase w-[28.63px]">
...
function Container48() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] w-[175.88px]">
        <p className="leading-[20px]">Phase 1: Brand Guidelines</p>
      </div>
      <Background4 />
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[12px] w-full">
        <p className="leading-[16px]">Design system and UI kit delivery completed on July 15.</p>
      </div>
    </div>
  );
}
...
function Container51() {
  return (
    <div className="relative shrink-0 size-[15px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g id="Container">
          <path d={svgPaths.p204d7580} fill="var(--fill-0, #5048E5)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function OverlayBorder() {
  return (
    <div className="bg-[rgba(80,72,229,0.1)] content-stretch flex items-center justify-center p-[2px] relative rounded-[9999px] shrink-0 size-[32px]" data-name="Overlay+Border">
      <div aria-hidden="true" className="absolute border-2 border-[rgba(80,72,229,0.2)] border-solid inset-0 pointer-events-none rounded-[9999px]" />
      <Container51 />
    </div>
  );
}
...
function Overlay1() {
  return (
    <div className="bg-[rgba(80,72,229,0.1)] content-stretch flex flex-col items-start px-[8px] py-[2px] relative rounded-[4px] shrink-0" data-name="Overlay">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[15px] justify-center leading-[0] not-italic relative shrink-0 text-[#5048e5] text-[10px] uppercase w-[66.8px]">
...
function Container53() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] w-[146.89px]">
...
function Container54() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[12px] w-full">
        <p className="leading-[16px]">Collecting feedback from the first 50 power users. Target: Aug 28.</p>
      </div>
    </div>
  );
}
...
function SectionMilestonesSummary() {
  return (
    <div className="bg-white drop-shadow-[0px_1px_1px_rgba(0,0,0,0.05)] relative rounded-[24px] shrink-0 w-full" data-name="Section - Milestones Summary">
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[24px]" />
...
function Heading3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Heading 3">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[28px] justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[18px] w-[117.45px]">
        <p className="leading-[28px]">Recent Tasks</p>
      </div>
    </div>
  );
}
...
function Button14() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative shrink-0" data-name="Button">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#5048e5] text-[14px] text-center w-[79.56px]">
        <p className="leading-[20px]">Go to Tasks</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[14px] w-full">
        <p className="leading-[20px]">Finalize API Documentation</p>
      </div>
    </div>
  );
}
...
function Container60() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Container">
      <Container61 />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[15px] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[10px] w-[28.89px]">
...
function Background5() {
  return (
    <div className="bg-[#fef3c7] content-stretch flex flex-col items-start px-[6px] py-[2px] relative rounded-[4px] shrink-0" data-name="Background">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[15px] justify-center leading-[0] not-italic relative shrink-0 text-[#b45309] text-[10px] uppercase w-[42.06px]">
        <p className="leading-[15px]">Medium</p>
      </div>
    </div>
  );
}
...
function User() {
  return (
    <div className="pointer-events-none relative rounded-[9999px] shrink-0 size-[24px]" data-name="User">
      <div className="absolute inset-0 overflow-hidden rounded-[9999px]">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgUser.src} />
      </div>
      <div aria-hidden="true" className="absolute border border-solid border-white inset-0 rounded-[9999px]" />
    </div>
  );
}
    ...
    <div className="relative rounded-[8px] shrink-0 w-full" data-name="Border">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[16px] items-center p-[13px] relative size-full">
          <div className="relative rounded-[4px] shrink-0 size-[20px]" data-name="Border">
...
function Background6() {
  return (
    <div className="bg-[#5048e5] relative rounded-[4px] shrink-0 size-[20px]" data-name="Background">
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#94a3b8] text-[14px] w-full">
        <p className="[text-decoration-skip-ink:none] decoration-solid leading-[20px] line-through">Draft Marketing Copy</p>
      </div>
    </div>
  );
}
...
function Container67() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Container">
      <Container68 />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal h-[15px] justify-center leading-[0] not-italic relative shrink-0 text-[#94a3b8] text-[10px] w-[87.16px]">
        <p className="leading-[15px]">Completed 2d ago</p>
      </div>
    </div>
  );
}
...
function User1() {
  return (
    <div className="pointer-events-none relative rounded-[9999px] shrink-0 size-[24px]" data-name="User">
      <div className="absolute inset-0 overflow-hidden rounded-[9999px]">
        <img alt="" className="absolute left-0 max-w-none size-full top-0" src={imgUser1.src} />
      </div>
      <div aria-hidden="true" className="absolute border border-solid border-white inset-0 rounded-[9999px]" />
    </div>
  );
...
function SectionRecentTasks() {
  return (
    <div className="bg-white drop-shadow-[0px_1px_1px_rgba(0,0,0,0.05)] relative rounded-[24px] shrink-0 w-full" data-name="Section - Recent Tasks">
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <div className="content-stretch flex flex-col gap-[24px] items-start p-[25px] relative size-full">
        <Container55 />
        <Container56 />
...
function LeftColumnMainWidgets() {
  return (
    <div className="col-[1/span_2] content-stretch flex flex-col gap-[32px] items-start justify-self-stretch relative row-1 self-start shrink-0" data-name="Left Column (Main widgets)">
      <SectionProjectBrief />
      <SectionMilestonesSummary />
      <SectionRecentTasks />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[12px] w-full">
        <p>
          <span className="leading-[16px]">Sarah Jenkins</span>
          <span className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic text-[#334155]">{` updated the Roadmap`}</span>
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[9px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 9">
        <g id="Container">
          <path d={svgPaths.p4889f40} fill="var(--fill-0, #2563EB)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Background11() {
  return (
    <div className="absolute bg-[#dbeafe] content-stretch flex items-center justify-center left-0 rounded-[9999px] size-[24px] top-0" data-name="Background">
      <Container89 />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex flex-col items-start pl-[32px] relative size-full">
        <Container86 />
        <div className="absolute bg-[#e2e8f0] bottom-[-24px] left-[11px] top-[32px] w-px" data-name="Vertical Divider" />
        <Background11 />
      </div>
    </div>
  );
...
function Container92() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[12px] w-full">
        <p className="mb-0">
          <span className="leading-[16px]">Marcus Wu</span>
          <span className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic text-[#334155]">{` commented on "Beta`}</span>
        </p>
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] text-[#334155]">{`Bugs"`}</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[10px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10">
        <g id="Container">
          <path d={svgPaths.pe27aa00} fill="var(--fill-0, #9333EA)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Background12() {
  return (
    <div className="absolute bg-[#f3e8ff] content-stretch flex items-center justify-center left-0 rounded-[9999px] size-[24px] top-0" data-name="Background">
      <Container94 />
    </div>
  );
}
...
function Container97() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#0f172a] text-[12px] w-full">
        <p className="mb-0">
          <span className="leading-[16px]">Elena Lopez</span>
          <span className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic text-[#334155]">{` uploaded`}</span>
        </p>
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] text-[#334155]">brand_assets.zip</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[10px] relative shrink-0 w-[8px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 10">
        <g id="Container">
          <path d={svgPaths.p174b8b40} fill="var(--fill-0, #059669)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Background13() {
  return (
    <div className="absolute bg-[#d1fae5] content-stretch flex items-center justify-center left-0 rounded-[9999px] size-[24px] top-0" data-name="Background">
      <Container99 />
    </div>
  );
}
...
function Button15() {
  return (
    <div className="relative shrink-0 w-full" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center pt-[7.5px] relative size-full">
        <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[16px] justify-center leading-[0] not-italic relative shrink-0 text-[#94a3b8] text-[12px] text-center w-[89.03px]">
          <p className="leading-[16px]">See All Activity</p>
        </div>
      </div>
    </div>
  );
...
function SectionRecentActivity() {
  return (
    <div className="bg-white drop-shadow-[0px_1px_1px_rgba(0,0,0,0.05)] relative rounded-[24px] shrink-0 w-full" data-name="Section - Recent Activity">
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <div className="content-stretch flex flex-col gap-[24px] items-start p-[25px] relative size-full">
        <Heading7 />
        <Container84 />
...
function RightColumnStatusAndSecondaryWidgets() {
  return (
    <div className="col-3 content-stretch flex flex-col gap-[32px] items-start justify-self-stretch pb-[123.75px] relative row-1 self-start shrink-0" data-name="Right Column (Status and secondary widgets)">
      <UpcomingMeetings />
...
function Container40() {
  return (
    <div className="gap-x-[32px] gap-y-[32px] grid grid-cols-[repeat(3,minmax(0,1fr))] grid-rows-[_770.75px] h-[770.75px] relative shrink-0 w-full" data-name="Container">
      <LeftColumnMainWidgets />
      <RightColumnStatusAndSecondaryWidgets />
    </div>
  );
}
...
function OverviewTabContent() {
  return (
    <div className="bg-[#f6f6f8] h-[961px] relative shrink-0 w-full" data-name="Overview Tab Content">
...
export default function EventWorkspaceOverview() {
  return (
    <div className="bg-[#f6f6f8] content-stretch flex flex-col items-start relative size-full" data-name="Event Workspace - Overview">
      <Body />
    </div>
  );
}