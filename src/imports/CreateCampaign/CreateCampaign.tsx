"use client";
import svgPaths from "./svg-teqhvw8ukt";
...
function Container20() {
  return (
    <div className="absolute content-stretch flex h-[24.444px] items-start left-[32px] top-[32px] w-[576.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Create Campaign</p>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[32px] top-[60.43px] w-[576.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[14px]">Launch a new social media campaign across platforms.</p>
    </div>
  );
}
    ...
    <div className="h-[16.111px] relative shrink-0 w-[280px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] min-w-px not-italic relative text-[#334155] text-[13px]">
          <span className="leading-[normal]">{`Campaign Name `}</span>
...
function TextInput1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[280px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">e.g. Q2 Product Launch</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Label1() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[280.009px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] min-w-px not-italic relative text-[#334155] text-[13px]">
          <span className="leading-[normal]">{`Brand `}</span>
          <span className="leading-[normal] text-[#ef4444]">*</span>
        </p>
      </div>
    </div>
...
function Dropdown() {
  return (
    <div className="flex-[1_0_0] min-h-px relative rounded-[8px] w-[280.009px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[8px]">
        ...
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[15.88%] left-0 max-w-none top-[42.06%] w-[3.57%]" src={imgDropdown.src} />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-824.661px] pr-[1104.67px] pt-[-297.127px] relative size-full">
        <Option />
        <Option1 />
        <Option2 />
      </div>
...
function Container22() {
  return (
    <div className="absolute h-[58.889px] left-[32px] top-[101.09px] w-[576.007px]" data-name="Container">
      <Container23 />
      <Container24 />
    </div>
  );
...
function Label2() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[576.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] min-w-px not-italic relative text-[#334155] text-[13px]">
          <span className="leading-[normal]">{`Platforms `}</span>
          <span className="leading-[normal] text-[#ef4444]">*</span>
        </p>
      </div>
    </div>
...
function Label3() {
  return (
    <div className="absolute h-[17.995px] left-0 top-0 w-[81.71px]" data-name="Label">
      <Container28 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[25.99px] not-italic text-[#334155] text-[14px] top-[0.66px] whitespace-nowrap">{` LinkedIn `}</p>
    </div>
  );
}
...
function Label4() {
  return (
    <div className="absolute h-[17.995px] left-[93.71px] top-0 w-[71.458px]" data-name="Label">
      <Container29 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[25.99px] not-italic text-[#334155] text-[14px] top-[0.66px] whitespace-nowrap">{` Twitter `}</p>
    </div>
  );
}
...
function Label5() {
  return (
    <div className="absolute h-[17.995px] left-[177.16px] top-0 w-[91.91px]" data-name="Label">
      <Container30 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[25.99px] not-italic text-[#334155] text-[14px] top-[0.66px] whitespace-nowrap">{` Instagram `}</p>
    </div>
  );
}
...
function Label6() {
  return (
    <div className="absolute h-[17.995px] left-[281.07px] top-0 w-[90.981px]" data-name="Label">
      <Container31 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[25.99px] not-italic text-[#334155] text-[14px] top-[0.66px] whitespace-nowrap">{` Facebook `}</p>
    </div>
  );
}
...
function Container27() {
  return (
    <div className="h-[17.995px] relative shrink-0 w-[576.007px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Label3 />
        <Label4 />
        <Label5 />
...
function Container26() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[39.106px] items-start left-0 top-0 w-[576.007px]" data-name="Container">
      <Label2 />
      <Container27 />
    </div>
  );
...
function Container25() {
  return (
    <div className="absolute h-[39.106px] left-[32px] top-[175.98px] w-[576.007px]" data-name="Container">
      <Container26 />
    </div>
  );
}
...
function DatePicker() {
  return (
    <div className="bg-white h-[39.774px] relative rounded-[8px] shrink-0 w-[280px]" data-name="Date Picker">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
}
...
function Container33() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[60.885px] items-start left-0 top-0 w-[280px]" data-name="Container">
      <Label7 />
      <DatePicker />
    </div>
  );
...
function DatePicker1() {
  return (
    <div className="bg-white h-[39.774px] relative rounded-[8px] shrink-0 w-[280.009px]" data-name="Date Picker">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
}
...
function Container34() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[60.885px] items-start left-[296px] top-0 w-[280.009px]" data-name="Container">
      <Label8 />
      <DatePicker1 />
    </div>
  );
...
function Container32() {
  return (
    <div className="absolute h-[60.885px] left-[32px] top-[231.09px] w-[576.007px]" data-name="Container">
      <Container33 />
      <Container34 />
    </div>
  );
...
function Label9() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[576.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Goal / Description</p>
      </div>
    </div>
  );
}
...
function TextArea() {
  return (
    <div className="bg-white h-[54.444px] relative rounded-[8px] shrink-0 w-[576.007px]" data-name="Text Area">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start overflow-clip px-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Describe the campaign goal...</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container36() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[75.556px] items-start left-0 top-0 w-[576.007px]" data-name="Container">
      <Label9 />
      <TextArea />
    </div>
  );
...
function Container35() {
  return (
    <div className="absolute h-[75.556px] left-[32px] top-[307.97px] w-[576.007px]" data-name="Container">
      <Container36 />
    </div>
  );
}
...
function Label10() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[280px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Hashtags</p>
      </div>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="absolute h-[14.002px] left-[110.02px] top-[3.21px] w-[9.427px]" data-name="Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[14px] left-0 not-italic text-[#5048e5] text-[14px] top-[0.33px] whitespace-nowrap">×</p>
    </div>
  );
}
...
function Text() {
  return (
    <div className="absolute bg-[#ede9fe] h-[20.434px] left-[12.55px] rounded-[6px] top-[8.55px] w-[129.444px]" data-name="Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[10px] not-italic text-[#5048e5] text-[12px] top-[2.99px] whitespace-nowrap">{`#ProductLaunch `}</p>
      <Text1 />
    </div>
  );
}
...
function Text3() {
  return (
    <div className="absolute h-[14.002px] left-[83.65px] top-[3.21px] w-[9.427px]" data-name="Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[14px] left-0 not-italic text-[#5048e5] text-[14px] top-[0.33px] whitespace-nowrap">×</p>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="absolute bg-[#ede9fe] h-[20.434px] left-[147.99px] rounded-[6px] top-[8.55px] w-[103.082px]" data-name="Text">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[10px] not-italic text-[#5048e5] text-[12px] top-[2.99px] whitespace-nowrap">{`#AcmeCorp `}</p>
      <Text3 />
    </div>
  );
}
...
function TextInput2() {
  return (
    <div className="absolute bg-white content-stretch flex h-[16.667px] items-center left-[12.55px] overflow-clip top-[34.98px] w-[254.896px]" data-name="Text Input">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Add hashtag...</p>
    </div>
  );
}
...
function Container39() {
  return (
    <div className="h-[60.2px] relative rounded-[8px] shrink-0 w-[280px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Text />
        <Text2 />
...
function Container38() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[81.311px] items-start left-0 top-0 w-[280px]" data-name="Container">
      <Label10 />
      <Container39 />
    </div>
  );
...
function Dropdown1() {
  return (
    <div className="h-[37.778px] relative rounded-[8px] shrink-0 w-[280.009px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[8px]">
        <div className="absolute bg-clip-padding bg-white border-0 border-[transparent] border-solid inset-0 rounded-[8px]" />
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[15.88%] left-0 max-w-none top-[42.06%] w-[3.57%]" src={imgDropdown.src} />
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-824.661px] pr-[1104.67px] pt-[-595.556px] relative size-full">
        <Option3 />
        <Option4 />
        <Option5 />
        <Option6 />
...
function Container40() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[81.311px] items-start left-[296px] top-0 w-[280.009px]" data-name="Container">
      <Label11 />
      <Dropdown1 />
    </div>
  );
...
function Container37() {
  return (
    <div className="absolute h-[81.311px] left-[32px] top-[399.52px] w-[576.007px]" data-name="Container">
      <Container38 />
      <Container40 />
    </div>
  );
...
function Button2() {
  return (
    <div className="bg-[#5048e5] h-[37.778px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(80,72,229,0.2)] shrink-0 w-[157.491px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[20px] py-[10px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Create Campaign</p>
      </div>
    </div>
  );
}
...
function Container41() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[37.778px] items-start justify-end left-[32px] top-[504.83px] w-[576.007px]" data-name="Container">
      <Button1 />
      <Button2 />
    </div>
  );
...
function Container19() {
  return (
    <div className="bg-white h-[574.601px] relative rounded-[20px] shadow-[0px_25px_50px_0px_rgba(0,0,0,0.25)] shrink-0 w-[640px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container20 />
        <Container21 />
        <Container22 />
...
export default function CreateCampaign() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Create Campaign">
      <Body />
      <Sidebar />
      <Header />
      <Container18 />
