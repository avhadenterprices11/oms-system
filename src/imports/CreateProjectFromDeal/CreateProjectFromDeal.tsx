"use client";
import svgPaths from "./svg-buj313qn8g";
...
function Container20() {
  return (
    <div className="absolute content-stretch flex h-[24.444px] items-start left-[32px] top-[32px] w-[616.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Extra_Bold',sans-serif] font-extrabold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Create Project from Deal</p>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[32px] top-[60.43px] w-[616.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[14px]">Pre-populated from CRM deal data</p>
    </div>
  );
}
...
function Icon20() {
  return (
    <div className="absolute left-[12.55px] size-[13.993px] top-[7.61px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.9931 13.9931">
        <g clipPath="url(#clip0_15_42828)" id="Icon">
          <path d={svgPaths.p32f2ac00} id="Vector" stroke="var(--stroke-0, #15803D)" strokeWidth="1.49926" />
        </g>
        <defs>
          <clipPath id="clip0_15_42828">
...
function Container24() {
  return (
    <div className="bg-[#f0fdf4] h-[29.219px] relative rounded-[8px] shrink-0 w-[229.757px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#bbf7d0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon20 />
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[32.54px] not-italic text-[#15803d] text-[13px] top-[6.55px] whitespace-nowrap">{` Portal Customization — $85K `}</p>
      </div>
    </div>
  );
}
...
function Container22() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[29.219px] items-start left-[32px] top-[101.09px] w-[616.007px]" data-name="Container">
      <Container23 />
      <Container24 />
    </div>
  );
...
function Label() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[616.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Project Name</p>
      </div>
    </div>
  );
}
...
function TextInput1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[616.007px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[14px] whitespace-nowrap">Portal Customization — TechFlow</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container26() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[58.889px] items-start left-0 top-0 w-[616.007px]" data-name="Container">
      <Label />
      <TextInput1 />
    </div>
  );
...
function Container25() {
  return (
    <div className="absolute h-[58.889px] left-[32px] top-[150.31px] w-[616.007px]" data-name="Container">
      <Container26 />
    </div>
  );
}
...
function Label1() {
  return (
    <div className="absolute content-stretch flex h-[16.111px] items-start left-0 top-0 w-[300px]" data-name="Label">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Client</p>
    </div>
  );
}
...
function TextInput2() {
  return (
    <div className="absolute bg-[#f8fafc] h-[37.778px] left-0 rounded-[8px] top-[21.11px] w-[300px]" data-name="Text Input">
...
function Text() {
  return (
    <div className="absolute content-stretch flex h-[13.333px] items-start left-0 top-[65.89px] w-[300px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[11px]">Linked from CRM (read-only)</p>
    </div>
  );
}
...
function Container28() {
  return (
    <div className="absolute h-[79.219px] left-0 top-0 w-[300px]" data-name="Container">
      <Label1 />
      <TextInput2 />
      <Text />
    </div>
...
function Label2() {
  return (
    <div className="absolute content-stretch flex h-[16.111px] items-start left-0 top-0 w-[300.009px]" data-name="Label">
...
function TextInput3() {
  return (
    <div className="absolute bg-[#f8fafc] h-[37.778px] left-0 rounded-[8px] top-[21.11px] w-[300.009px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip px-[14px] py-[10px] relative rounded-[inherit] size-full">
...
function Text1() {
  return (
    <div className="absolute content-stretch flex h-[13.333px] items-start left-0 top-[65.89px] w-[300.009px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[11px]">Linked from CRM (read-only)</p>
    </div>
  );
}
...
function Container29() {
  return (
    <div className="absolute h-[79.219px] left-[316px] top-0 w-[300.009px]" data-name="Container">
      <Label2 />
      <TextInput3 />
      <Text1 />
    </div>
...
function Container27() {
  return (
    <div className="absolute h-[79.219px] left-[32px] top-[225.2px] w-[616.007px]" data-name="Container">
      <Container28 />
      <Container29 />
    </div>
  );
...
function Option() {
  return <div className="absolute left-[-508.66px] size-0 top-[-425.56px]" data-name="Option" />;
}
...
function Dropdown() {
  return (
    <div className="absolute h-[37.778px] left-0 rounded-[8px] top-[21.11px] w-[300px]" data-name="Dropdown">
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[-508.66px] not-italic text-[#0f172a] text-[14px] top-[-425.56px] whitespace-nowrap">​</p>
      <Option />
      <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[-508.66px] not-italic text-[#0f172a] text-[14px] top-[-425.56px] whitespace-nowrap">
...
function Text2() {
  return (
    <div className="absolute content-stretch flex h-[13.333px] items-start left-0 top-[65.89px] w-[300px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[11px]">Default: deal owner</p>
    </div>
  );
}
...
function Label4() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[300.009px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
...
function TextInput4() {
  return (
    <div className="absolute bg-white content-stretch flex h-[16.111px] items-center left-[121.45px] overflow-clip top-[12.94px] w-[166.007px]" data-name="Text Input">
...
function Container33() {
  return (
    <div className="h-[41.997px] relative rounded-[8px] shrink-0 w-[300.009px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container34 />
        <TextInput4 />
...
function Container32() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[79.219px] items-start left-[316px] top-0 w-[300.009px]" data-name="Container">
      <Label4 />
      <Container33 />
    </div>
  );
...
function Container30() {
  return (
    <div className="absolute h-[79.219px] left-[32px] top-[344.97px] w-[616.007px]" data-name="Container">
      <Container31 />
      <Container32 />
    </div>
  );
...
function DatePicker() {
  return <div className="absolute bg-white border-[#e2e8f0] border-[0.556px] border-solid h-[39.774px] left-0 rounded-[8px] top-[21.11px] w-[300px]" data-name="Date Picker" />;
}

function Text4() {
  return (
    <div className="absolute content-stretch flex h-[13.333px] items-start left-0 top-[67.88px] w-[300px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[11px]">Auto: deal close date + 1 week</p>
    </div>
  );
}
...
function Container36() {
  return (
    <div className="absolute h-[81.215px] left-0 top-0 w-[300px]" data-name="Container">
      <Label5 />
      <DatePicker />
      <Text4 />
    </div>
...
function DatePicker1() {
  return <div className="absolute bg-white border-[#e2e8f0] border-[0.556px] border-solid h-[39.774px] left-0 rounded-[8px] top-[21.11px] w-[300.009px]" data-name="Date Picker" />;
}

function Text5() {
  return (
    <div className="absolute content-stretch flex h-[13.333px] items-start left-0 top-[67.88px] w-[300.009px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[11px]">Deal close + project duration</p>
    </div>
  );
}
...
function Container37() {
  return (
    <div className="absolute h-[81.215px] left-[316px] top-0 w-[300.009px]" data-name="Container">
      <Label6 />
      <DatePicker1 />
      <Text5 />
    </div>
...
function Container35() {
  return (
    <div className="absolute h-[81.215px] left-[32px] top-[464.75px] w-[616.007px]" data-name="Container">
      <Container36 />
      <Container37 />
    </div>
  );
...
function Icon21() {
  return (
    <div className="absolute left-0 size-[15.998px] top-[0.33px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9983 15.9983">
        <g id="Icon">
          <path d={svgPaths.p3f773040} id="Vector" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49984" />
        </g>
      </svg>
    </div>
  );
...
function Container38() {
  return (
    <div className="absolute h-[16.667px] left-[32px] top-[586.52px] w-[616.007px]" data-name="Container">
      <Icon21 />
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[normal] left-[23.99px] not-italic text-[#0f172a] text-[14px] top-0 whitespace-nowrap">{` Auto-Create `}</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[10.998px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.9983 10.9983">
        <g id="Icon">
          <path d={svgPaths.p11cd7580} id="Vector" stroke="var(--stroke-0, white)" strokeWidth="1.99968" />
        </g>
      </svg>
    </div>
  );
...
function Container41() {
  return (
    <div className="absolute bg-[#5048e5] content-stretch flex items-center justify-center left-0 px-[3.498px] py-[1.111px] rounded-[4px] size-[17.995px] top-0" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#5048e5] border-[1.111px] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <Icon22 />
    </div>
  );
}
...
function Container40() {
  return (
    <div className="h-[17.995px] relative shrink-0 w-[616.007px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container41 />
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[27.99px] not-italic text-[#334155] text-[13px] top-[0.94px] whitespace-nowrap">{` Client Delivery workspace `}</p>
      </div>
    </div>
  );
}
...
function Container42() {
  return (
    <div className="h-[17.995px] relative shrink-0 w-[616.007px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container43 />
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[27.99px] not-italic text-[#334155] text-[13px] top-[0.94px] whitespace-nowrap">{` Kick-off meeting `}</p>
      </div>
    </div>
  );
}
...
function Container44() {
  return (
    <div className="h-[17.995px] relative shrink-0 w-[616.007px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container45 />
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[27.99px] not-italic text-[#334155] text-[13px] top-[0.94px] whitespace-nowrap">{` Onboarding tasks `}</p>
      </div>
    </div>
  );
}
...
function Container39() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[10px] h-[73.984px] items-start left-[32px] top-[617.18px] w-[616.007px]" data-name="Container">
      <Container40 />
      <Container42 />
      <Container44 />
    </div>
...
function Container18() {
  return (
    <div className="absolute bg-[rgba(15,23,42,0.45)] content-stretch flex h-[924.444px] items-center justify-center left-0 px-[476.667px] top-0 w-[1633.333px]" data-name="Container">
      <Container19 />
    </div>
  );
}
