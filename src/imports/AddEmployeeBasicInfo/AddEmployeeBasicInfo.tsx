"use client";
import svgPaths from "./svg-9oxwtbbfd5";
...
function Text2() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[90.321px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#334155] text-[13px] whitespace-nowrap">Add Employee</p>
      </div>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="h-[35.998px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Extra_Bold',sans-serif] font-extrabold leading-[36px] left-0 not-italic text-[#0f172a] text-[24px] top-[-0.67px] tracking-[-0.75px] whitespace-nowrap">Add New Employee</p>
    </div>
  );
}
...
function Container4() {
  return (
    <div className="h-[24.002px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#64748b] text-[14px] top-[0.33px] whitespace-nowrap">Fill in the employee details, configure access and permissions.</p>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="h-[63.993px] relative shrink-0 w-[413.438px]" data-name="Container">
...
function Container7() {
  return (
    <div className="bg-[#5048e5] relative rounded-[13.997px] shrink-0 size-[27.995px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#5048e5] border-[1.667px] border-solid inset-0 pointer-events-none rounded-[13.997px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center p-[1.667px] relative size-full">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[12px] text-white whitespace-nowrap">1</p>
      </div>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="h-[14.444px] relative shrink-0 w-[56.866px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[12px] whitespace-nowrap">Basic Info</p>
      </div>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="h-[27.995px] relative shrink-0 w-[92.856px]" data-name="Container">
...
function Container8() {
  return <div className="bg-[#e2e8f0] flex-[75.877_0_0] h-[1.997px] min-w-px" data-name="Container" />;
}

function Container10() {
  return (
    <div className="bg-white relative rounded-[13.997px] shrink-0 size-[27.995px]" data-name="Container">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center p-[1.667px] relative size-full">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[12px] whitespace-nowrap">2</p>
      </div>
    </div>
  );
}
...
function Text4() {
  return (
    <div className="h-[14.444px] relative shrink-0 w-[81.988px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[12px] whitespace-nowrap">{`Role & Access`}</p>
      </div>
    </div>
  );
}
...
function Container9() {
  return (
    <div className="h-[27.995px] relative shrink-0 w-[117.977px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[7.995px] items-center relative size-full">
        <Container10 />
        <Text4 />
      </div>
...
function Container11() {
  return <div className="bg-[#e2e8f0] flex-[75.885_0_0] h-[1.997px] min-w-px" data-name="Container" />;
}
...
function Text5() {
  return (
    <div className="h-[14.444px] relative shrink-0 w-[89.245px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[12px] whitespace-nowrap">Module Access</p>
      </div>
    </div>
  );
}
...
function Container12() {
  return (
    <div className="h-[27.995px] relative shrink-0 w-[125.234px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[7.995px] items-center relative size-full">
        <Container13 />
        <Text5 />
      </div>
...
function Container16() {
  return (
    <div className="bg-white relative rounded-[13.997px] shrink-0 size-[27.995px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[1.667px] border-solid inset-0 pointer-events-none rounded-[13.997px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center p-[1.667px] relative size-full">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[12px] whitespace-nowrap">4</p>
      </div>
    </div>
  );
}
...
function Text6() {
  return (
    <div className="h-[14.444px] relative shrink-0 w-[68.325px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[12px] whitespace-nowrap">Onboarding</p>
      </div>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="h-[27.995px] relative shrink-0 w-[104.314px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[7.995px] items-center relative size-full">
        <Container16 />
        <Text6 />
      </div>
...
function Container18() {
  return (
    <div className="absolute content-stretch flex h-[21.667px] items-start left-[31.99px] top-[32px] w-[754.896px]" data-name="Container">
...
function Container19() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[31.99px] top-[57.65px] w-[754.896px]" data-name="Container">
  ...
  return (
    <div className="absolute left-0 size-[15.998px] top-[0.33px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9983 15.9983">
        <g id="Icon">
          <path d={svgPaths.p12a1e80} id="Vector" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49984" />
          <path d={svgPaths.p11794b80} id="Vector_2" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49984" />
        </g>
      </svg>
    </div>
  );
...
function Container20() {
  return (
    <div className="absolute h-[16.667px] left-[31.99px] top-[98.32px] w-[754.896px]" data-name="Container">
      <Icon />
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d="M10 7V13M7 10H13" id="Vector" stroke="var(--stroke-0, #94A3B8)" strokeWidth="1.5" />
          <path d={svgPaths.p34071600} id="Vector_2" stroke="var(--stroke-0, #94A3B8)" strokeWidth="1.5" />
          <path d={svgPaths.p1610fbc0} id="Vector_3" stroke="var(--stroke-0, #94A3B8)" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Text7() {
  return (
    <div className="h-[11.111px] relative shrink-0 w-[38.655px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[9px] tracking-[0.3px] uppercase whitespace-nowrap">Upload</p>
      </div>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[3.993px] items-center justify-center left-[31.99px] px-[1.667px] py-[22.448px] rounded-[16px] size-[80px] top-[128.98px]" data-name="Container">
...
function Container22() {
  return (
    <div className="absolute h-[16.667px] left-[31.99px] top-[249.53px] w-[754.896px]" data-name="Container">
      <Icon2 />
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[normal] left-[23.99px] not-italic text-[#0f172a] text-[14px] top-0 whitespace-nowrap">{` Personal Details `}</p>
    </div>
  );
}
...
function Container23() {
  return (
    <div className="absolute h-[58.889px] left-[31.99px] top-[280.19px] w-[754.896px]" data-name="Container">
      <Container24 />
      <Container25 />
    </div>
  );
...
function Container26() {
  return (
    <div className="absolute h-[58.889px] left-[31.99px] top-[355.08px] w-[754.896px]" data-name="Container">
      <Container27 />
      <Container28 />
    </div>
  );
    ...
    <div className="h-[37.222px] relative rounded-[8px] shrink-0 w-[369.453px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[8px]">
        ...
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[16.12%] left-0 max-w-none top-[41.94%] w-[2.71%]" src={imgDropdown.src} />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-775.99px] pr-[1145.443px] pt-[-707.717px] relative size-full">
        <Option />
        <Option1 />
        <Option2 />
        <Option3 />
...
function Container29() {
  return (
    <div className="absolute h-[60.885px] left-[31.99px] top-[429.97px] w-[754.896px]" data-name="Container">
      <Container30 />
      <Container31 />
    </div>
  );
...
function Icon3() {
  return (
    <div className="absolute left-0 size-[15.998px] top-[0.33px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9983 15.9983">
        <g id="Icon">
          <path d={svgPaths.p25091a00} id="Vector" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49984" />
          <path d="M6 13.998V9.99805H10V13.998" id="Vector_2" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49984" />
        </g>
      </svg>
    </div>
  );
...
function Container32() {
  return (
    <div className="absolute h-[16.667px] left-[31.99px] top-[531.4px] w-[754.896px]" data-name="Container">
      <Icon3 />
...
function Container33() {
  return (
    <div className="absolute h-[58.889px] left-[31.99px] top-[562.07px] w-[754.896px]" data-name="Container">
      <Container34 />
    </div>
  );
}
...
function Container35() {
  return (
    <div className="absolute h-[58.889px] left-[31.99px] top-[636.95px] w-[754.896px]" data-name="Container">
      <Container36 />
      <Container37 />
      <Container38 />
    </div>
  ...
  return (
    <div className="h-[37.222px] relative rounded-[8px] shrink-0 w-[754.896px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[8px]">
        <div className="absolute bg-clip-padding bg-white border-0 border-[transparent] border-solid inset-0 rounded-[8px]" />
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[16.12%] left-0 max-w-none top-[41.94%] w-[1.32%]" src={imgDropdown.src} />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-390.547px] pr-[1145.443px] pt-[-989.592px] relative size-full">
        <Option4 />
        <Option5 />
        <Option6 />
        <Option7 />
...
function Container39() {
  return (
    <div className="absolute h-[58.333px] left-[31.99px] top-[711.84px] w-[754.896px]" data-name="Container">
      <Container40 />
    </div>
  );
}
...
function Icon4() {
  return (
    <div className="absolute left-0 size-[15.998px] top-[0.33px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9983 15.9983">
        <g clipPath="url(#clip0_15_14748)" id="Icon">
          <path d={svgPaths.p3c4c3680} id="Vector" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49984" />
          <path d={svgPaths.p1d231300} id="Vector_2" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49984" />
        </g>
        <defs>
          <clipPath id="clip0_15_14748">
...
function Container41() {
  return (
    <div className="absolute h-[16.667px] left-[31.99px] top-[810.73px] w-[754.896px]" data-name="Container">
      <Icon4 />
...
function Dropdown2() {
  return (
    <div className="h-[37.222px] relative rounded-[8px] shrink-0 w-[369.453px]" data-name="Dropdown">
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-775.99px] pr-[1145.443px] pt-[-1119.141px] relative size-full">
        <Option9 />
        <Option10 />
        <Option11 />
        <Option12 />
...
function Container42() {
  return (
    <div className="absolute h-[58.889px] left-[31.99px] top-[841.39px] w-[754.896px]" data-name="Container">
      <Container43 />
      <Container44 />
    </div>
  );
...
function Container45() {
  return (
    <div className="absolute h-[58.889px] left-[31.99px] top-[916.28px] w-[754.896px]" data-name="Container">
      <Container46 />
    </div>
  );
}
...
function Container17() {
  return (
    <div className="absolute bg-white border-[#e2e8f0] border-[0.556px] border-solid h-[1024.271px] left-0 rounded-[24px] top-[172.09px] w-[820px]" data-name="Container">
      <Container18 />
      <Container19 />
      <Container20 />
      <Container21 />
...
function Container48() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[65.269px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[13px] whitespace-nowrap">Step 1 of 4</p>
      </div>
    </div>
  );
}
...
function Icon5() {
  return (
    <div className="absolute left-[202.49px] size-[13.993px] top-[11.89px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.9931 13.9931">
        <g id="Icon">
          <path d={svgPaths.pf3c2e00} id="Vector" stroke="var(--stroke-0, white)" strokeWidth="1.99901" />
        </g>
      </svg>
    </div>
  );
...
function Button1() {
  return (
    <div className="bg-[#5048e5] h-[37.778px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(80,72,229,0.2),0px_4px_6px_0px_rgba(80,72,229,0.2)] shrink-0 w-[233.481px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[106px] not-italic text-[14px] text-center text-white top-[10.55px] whitespace-nowrap">{`Continue to Role & Access `}</p>
        <Icon5 />
      </div>
    </div>
  );
...
function Container49() {
  return (
    <div className="h-[37.778px] relative shrink-0 w-[325.608px]" data-name="Container">
...
function Container47() {
  return (
    <div className="absolute content-stretch flex h-[41.771px] items-center justify-between left-0 top-[1216.36px] w-[820px]" data-name="Container">
      <Container48 />
      <Container49 />
    </div>
  );
...
function MainContent() {
  return (
    <div className="absolute h-[1258.134px] left-[358px] top-[83.99px] w-[820px]" data-name="Main Content">
      <Container />
      <Container1 />
      <Container5 />
      <Container17 />
...
function Icon7() {
  return (
    <div className="absolute left-[12px] size-[17.995px] top-[9px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.9948 17.9948">
        <g clipPath="url(#clip0_15_14726)" id="Icon">
...
function Icon10() {
  return (
    <div className="absolute left-[12px] size-[17.995px] top-[9px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.9948 17.9948">
        <g clipPath="url(#clip0_15_14711)" id="Icon">
...
function Icon22() {
  return (
    <div className="relative shrink-0 size-[15.998px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9983 15.9983">
        <g clipPath="url(#clip0_15_14658)" id="Icon">
