"use client";
import svgPaths from "./svg-fv2r94dufh";
...
function Container20() {
  return (
    <div className="absolute content-stretch flex h-[24.444px] items-start left-[32px] top-[32px] w-[496.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Add Milestone</p>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[32px] top-[60.43px] w-[496.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[14px]">Define a project milestone with dependencies.</p>
    </div>
  );
}
    ...
    <div className="h-[16.111px] relative shrink-0 w-[496.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] min-w-px not-italic relative text-[#334155] text-[13px]">
          <span className="leading-[normal]">{`Milestone Name `}</span>
    ...
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[496.007px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">e.g. Beta Release</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Label1() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[240px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] min-w-px not-italic relative text-[#334155] text-[13px]">
          <span className="leading-[normal]">{`Target Date `}</span>
          <span className="leading-[normal] text-[#ef4444]">*</span>
        </p>
      </div>
    </div>
...
function DatePicker() {
  return (
    <div className="bg-white h-[39.774px] relative rounded-[8px] shrink-0 w-[240px]" data-name="Date Picker">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
}
...
function Dropdown() {
  return (
    <div className="h-[37.778px] relative rounded-[8px] shrink-0 w-[240.009px]" data-name="Dropdown">
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-824.661px] pr-[1064.67px] pt-[-322.057px] relative size-full">
        <Option />
        <Option1 />
        <Option2 />
        <Option3 />
...
function Container24() {
  return (
    <div className="absolute h-[60.885px] left-[32px] top-[175.98px] w-[496.007px]" data-name="Container">
      <Container25 />
      <Container26 />
    </div>
  );
...
function TextArea() {
  return (
    <div className="bg-white h-[54.444px] relative rounded-[8px] shrink-0 w-[496.007px]" data-name="Text Area">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start overflow-clip px-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Describe this milestone...</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container28() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[75.556px] items-start left-0 top-0 w-[496.007px]" data-name="Container">
      <Label3 />
      <TextArea />
    </div>
  );
...
function Container27() {
  return (
    <div className="absolute h-[75.556px] left-[32px] top-[252.86px] w-[496.007px]" data-name="Container">
      <Container28 />
    </div>
  );
}
...
function Label4() {
  return (
    <div className="absolute content-stretch flex h-[16.111px] items-start left-0 top-0 w-[496.007px]" data-name="Label">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Depends On</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[10px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10">
        <g id="Icon">
          <path d="M2 5L4 7L8 3" id="Vector" stroke="var(--stroke-0, white)" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Container32() {
  return (
    <div className="absolute bg-[#5048e5] content-stretch flex items-center justify-center left-[7.99px] pl-[2.995px] pr-[3.003px] py-[1.111px] rounded-[4px] size-[15.998px] top-[6.05px]" data-name="Container">
...
function Label5() {
  return (
    <div className="h-[28.108px] relative rounded-[6px] shrink-0 w-full" data-name="Label">
      <Container32 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[31.99px] not-italic text-[#334155] text-[13px] top-[6px] whitespace-nowrap">Design Approval</p>
    </div>
  );
}
...
function Container33() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[7.99px] pl-[2.995px] pr-[3.003px] py-[1.111px] rounded-[4px] size-[15.998px] top-[6.05px]" data-name="Container">
...
function Label6() {
  return (
    <div className="h-[28.108px] relative rounded-[6px] shrink-0 w-full" data-name="Label">
      <Container33 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[31.99px] not-italic text-[#334155] text-[13px] top-[6px] whitespace-nowrap">API Integration Complete</p>
    </div>
  );
}
...
function Label7() {
  return (
    <div className="h-[28.108px] relative rounded-[6px] shrink-0 w-full" data-name="Label">
      <Container34 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[31.99px] not-italic text-[#334155] text-[13px] top-[6px] whitespace-nowrap">QA Sign-off</p>
    </div>
  );
}
...
function Label8() {
  return (
    <div className="h-[28.108px] relative rounded-[6px] shrink-0 w-full" data-name="Label">
      <Container35 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[31.99px] not-italic text-[#334155] text-[13px] top-[6px] whitespace-nowrap">Infrastructure Setup</p>
    </div>
  );
}
...
function Container31() {
  return (
    <div className="absolute h-[120px] left-0 rounded-[8px] top-[21.11px] w-[496.007px]" data-name="Container">
      <div className="content-stretch flex flex-col items-start overflow-clip pb-[0.556px] pt-[8.55px] px-[8.55px] relative rounded-[inherit] size-full">
        <Label5 />
        <Label6 />
        <Label7 />
        <Label8 />
...
function Text() {
  return (
    <div className="absolute content-stretch flex h-[13.333px] items-start left-0 top-[148.11px] w-[496.007px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[11px]">Select milestones that must be completed first</p>
    </div>
  );
}
...
function Container30() {
  return (
    <div className="absolute h-[161.441px] left-0 top-0 w-[496.007px]" data-name="Container">
      <Label4 />
      <Container31 />
      <Text />
    </div>
...
function Container29() {
  return (
    <div className="absolute h-[161.441px] left-[32px] top-[344.42px] w-[496.007px]" data-name="Container">
      <Container30 />
    </div>
  );
}
...
function Dropdown1() {
  return (
    <div className="h-[37.778px] relative rounded-[8px] shrink-0 w-[496.007px]" data-name="Dropdown">
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-568.663px] pr-[1064.67px] pt-[-667.934px] relative size-full">
        <Option4 />
        <Option5 />
        <Option6 />
        <Option7 />
...
function Container36() {
  return (
    <div className="absolute h-[58.889px] left-[32px] top-[521.86px] w-[496.007px]" data-name="Container">
      <Container37 />
    </div>
  );
}
...
function Button2() {
  return (
    <div className="bg-[#5048e5] h-[37.778px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(80,72,229,0.2)] shrink-0 w-[137.37px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[20px] py-[10px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Add Milestone</p>
      </div>
    </div>
  );
}
...
function Container38() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[37.778px] items-start justify-end left-[32px] top-[604.74px] w-[496.007px]" data-name="Container">
      <Button1 />
      <Button2 />
    </div>
  );
...
function Container19() {
  return (
    <div className="bg-white h-[674.514px] relative rounded-[20px] shadow-[0px_25px_50px_0px_rgba(0,0,0,0.25)] shrink-0 w-[560px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container20 />
        <Container21 />
        <Container22 />
...
export default function AddMilestone() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Add Milestone">
      <Body />
      <Sidebar />
      <Header />
      <Container18 />
