"use client";
import svgPaths from "./svg-0tgm3c7pp1";
...
function Container3() {
  return (
    <div className="h-[24.002px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#64748b] text-[16px] top-[-0.78px] whitespace-nowrap">Team messaging</p>
    </div>
  );
}
...
function Container1() {
  return (
    <div className="h-[63.993px] relative shrink-0 w-[128.238px]" data-name="Container">
...
function Container() {
  return (
    <div className="h-[63.993px] opacity-30 relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex items-start justify-between pr-[831.771px] relative size-full">
        <Container1 />
      </div>
    </div>
  );
...
function Container24() {
  return (
    <div className="absolute content-stretch flex h-[24.444px] items-start left-[32px] top-[32px] w-[496.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Create Channel</p>
    </div>
  );
}
...
function Container25() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[32px] top-[60.43px] w-[496.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[14px]">Create a new channel for team communication</p>
    </div>
  );
}
    ...
    <div className="h-[16.111px] relative shrink-0 w-[496.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] min-w-px not-italic relative text-[#334155] text-[13px]">
          <span className="leading-[normal]">{`Channel Name `}</span>
...
function Text() {
  return (
    <div className="bg-[#f8fafc] h-[37.778px] relative rounded-bl-[8px] rounded-tl-[8px] shrink-0 w-[23.568px]" data-name="Text">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-b-[0.556px] border-l-[0.556px] border-solid border-t-[0.556px] inset-0 pointer-events-none rounded-bl-[8px] rounded-tl-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[14.55px] not-italic text-[#94a3b8] text-[14px] top-[10.56px] whitespace-nowrap">#</p>
      </div>
    </div>
  );
}
...
function TextInput1() {
  return (
    <div className="bg-white flex-[472.439_0_0] h-[37.778px] min-w-px relative rounded-br-[8px] rounded-tr-[8px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">e.g. project-portal-v2</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-b-[0.556px] border-r-[0.556px] border-solid border-t-[0.556px] inset-0 pointer-events-none rounded-br-[8px] rounded-tr-[8px]" />
    </div>
  );
}
...
function Container28() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-[496.007px]" data-name="Container">
...
function Container33() {
  return (
    <div className="relative rounded-[8.997px] shrink-0 size-[17.995px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#5048e5] border-[1.667px] border-solid inset-0 pointer-events-none rounded-[8.997px]" />
    </div>
  );
}
...
function Text1() {
  return (
    <div className="h-[16.667px] relative shrink-0 w-[41.198px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#334155] text-[14px] whitespace-nowrap">Public</p>
      </div>
    </div>
  );
}
...
function Container32() {
  return (
    <div className="h-[17.995px] relative shrink-0 w-[67.188px]" data-name="Container">
...
function Container35() {
  return (
    <div className="relative rounded-[8.997px] shrink-0 size-[17.995px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[1.667px] border-solid inset-0 pointer-events-none rounded-[8.997px]" />
    </div>
  );
}
...
function Text2() {
  return (
    <div className="h-[16.667px] relative shrink-0 w-[46.788px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#334155] text-[14px] whitespace-nowrap">Private</p>
      </div>
    </div>
  );
}
...
function Container34() {
  return (
    <div className="h-[17.995px] relative shrink-0 w-[72.778px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[7.995px] items-center relative size-full">
        <Container35 />
        <Text2 />
      </div>
...
function Container31() {
  return (
    <div className="h-[17.995px] relative shrink-0 w-[496.007px]" data-name="Container">
...
function Container30() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8.993px] h-[43.099px] items-start left-0 top-0 w-[496.007px]" data-name="Container">
      <Label1 />
      <Container31 />
    </div>
  );
...
function Container29() {
  return (
    <div className="absolute h-[43.099px] left-[32px] top-[175.98px] w-[496.007px]" data-name="Container">
      <Container30 />
    </div>
  );
}
    ...
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[496.007px]" data-name="Text Area">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">What is this channel about?</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container36() {
  return (
    <div className="absolute h-[91.111px] left-[32px] top-[235.08px] w-[496.007px]" data-name="Container">
      <Container37 />
    </div>
  );
}
...
function Label3() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[496.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Add Members</p>
      </div>
    </div>
  );
}
...
function Text4() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[71.02px] top-[2.99px] w-[9.427px]" data-name="Text">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#7c3aed] text-[14px] whitespace-nowrap">×</p>
    </div>
  );
}
...
function Container42() {
  return (
    <div className="absolute bg-[#ede9fe] h-[22.656px] left-[117.45px] rounded-[9999px] top-[9.67px] w-[90.451px]" data-name="Container">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[10px] not-italic text-[#5048e5] text-[12px] top-[4.11px] whitespace-nowrap">{`Lisa Chen `}</p>
      <Text4 />
    </div>
  );
}
...
function TextInput2() {
  return (
    <div className="absolute bg-white content-stretch flex h-[16.111px] items-center left-[213.9px] overflow-clip top-[12.94px] w-[269.557px]" data-name="Text Input">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[13px] whitespace-nowrap">Search members...</p>
    </div>
  );
}
...
function Container40() {
  return (
    <div className="flex-[1_0_0] min-h-px relative rounded-[8px] w-[496.007px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container41 />
        <Container42 />
...
function Container39() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[63.108px] items-start left-0 top-0 w-[496.007px]" data-name="Container">
      <Label3 />
      <Container40 />
    </div>
  );
...
function Container38() {
  return (
    <div className="absolute h-[63.108px] left-[32px] top-[342.19px] w-[496.007px]" data-name="Container">
      <Container39 />
    </div>
  );
}
...
function Label4() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[496.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Auto-invite Department</p>
      </div>
    </div>
  );
}
...
function Dropdown() {
  return (
    <div className="h-[37.222px] relative rounded-[8px] shrink-0 w-[496.007px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[8px]">
        ...
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[16.12%] left-0 max-w-none top-[41.94%] w-[2.02%]" src={imgDropdown.src} />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-568.663px] pr-[1064.67px] pt-[-607.648px] relative size-full">
        <Option />
        <Option1 />
        <Option2 />
        <Option3 />
...
function Container44() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[58.333px] items-start left-0 top-0 w-[496.007px]" data-name="Container">
      <Label4 />
      <Dropdown />
    </div>
  );
...
function Container43() {
  return (
    <div className="absolute h-[58.333px] left-[32px] top-[421.29px] w-[496.007px]" data-name="Container">
      <Container44 />
    </div>
  );
}
...
function Button2() {
  return (
    <div className="bg-[#5048e5] h-[37.778px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(80,72,229,0.2)] shrink-0 w-[144.635px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[20px] py-[10px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Create Channel</p>
      </div>
    </div>
  );
}
...
function Container45() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[58.333px] items-start justify-end left-[32px] pt-[20.556px] top-[503.62px] w-[496.007px]" data-name="Container">
...
function Container23() {
  return (
    <div className="bg-white h-[593.95px] relative rounded-[20px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] shrink-0 w-[560px]" data-name="Container">
...
export default function CreateChannel() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Create Channel">
      <Body />
      <Sidebar />
      <Header />
      <Container22 />
