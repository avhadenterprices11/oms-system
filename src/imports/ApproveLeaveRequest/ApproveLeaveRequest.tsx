"use client";
import svgPaths from "./svg-t8dp4xq5pk";
...
function Container25() {
  return (
    <div className="absolute content-stretch flex h-[24.444px] items-start left-[32px] top-[32px] w-[416.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Approve Leave Request</p>
    </div>
  );
}
...
function Text8() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[80.191px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[13px] whitespace-nowrap">Team Impact</p>
      </div>
    </div>
  );
}
...
function Text9() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[85.043px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#059669] text-[13px] whitespace-nowrap">Low — 1/8 off</p>
      </div>
    </div>
  );
}
...
function Container31() {
  return (
    <div className="h-[28.108px] relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center size-full">
...
function Container26() {
  return (
    <div className="absolute bg-[#f8fafc] content-stretch flex flex-col h-[177.083px] items-start left-[32px] pb-[0.556px] pt-[16.554px] px-[16.554px] rounded-[12px] top-[76.44px] w-[416.007px]" data-name="Container">
...
function Label() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[416.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Comment (optional)</p>
      </div>
    </div>
  );
}
...
function TextArea() {
  return (
    <div className="bg-white h-[70px] relative rounded-[8px] shrink-0 w-[416.007px]" data-name="Text Area">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start overflow-clip px-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Add a comment to the approval...</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container32() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[91.111px] items-start left-[32px] top-[273.52px] w-[416.007px]" data-name="Container">
      <Label />
      <TextArea />
    </div>
  );
...
function Button1() {
  return (
    <div className="bg-white h-[37.778px] relative rounded-[8px] shrink-0 w-[83.394px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[20.556px] py-[10.556px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#dc2626] text-[14px] text-center whitespace-nowrap">Reject</p>
      </div>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="bg-[#059669] h-[37.778px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(5,150,105,0.2)] shrink-0 w-[97.431px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[20px] py-[10px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Approve</p>
      </div>
    </div>
  );
}
...
function Container33() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[58.333px] items-start justify-end left-[32px] pt-[20.556px] top-[388.63px] w-[416.007px]" data-name="Container">
...
function Container24() {
  return (
    <div className="bg-white h-[478.958px] relative rounded-[20px] shadow-[0px_25px_50px_0px_rgba(0,0,0,0.25)] shrink-0 w-[480px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container25 />
        <Container26 />
        <Container32 />
...
export default function ApproveLeaveRequest() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Approve Leave Request">
      <Body />
      <Sidebar />
      <Header />
      <Container23 />
