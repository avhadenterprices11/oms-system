        ...
        <div className="flex justify-between items-start mb-6">
          ...
          <div className="flex gap-3">
            <button 
              ...
              className="flex items-center gap-2 bg-white border border-slate-200 text-slate-600 px-4 py-2 rounded-[10px] font-bold text-[13px] hover:bg-slate-50 transition-colors shadow-sm"
            >
              Social Accounts
            </button>
            <button className="flex items-center gap-2 bg-[#e0e7ff] text-[#4f46e5] px-4 py-2 rounded-[10px] font-bold text-[13px] hover:bg-[#d1dbff] transition-colors shadow-sm">
