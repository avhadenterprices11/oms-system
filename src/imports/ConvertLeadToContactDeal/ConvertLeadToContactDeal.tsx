"use client";
import svgPaths from "./svg-lzmjlfe5iw";
...
function Container19() {
  return (
    <div className="absolute content-stretch flex h-[24.5px] items-start left-[32px] top-[32px] w-[616px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Extra_Bold',sans-serif] font-extrabold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Convert Lead</p>
    </div>
  );
}
...
function Container20() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[32px] top-[60.5px] w-[616px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[14px]">Convert lead into a contact and optionally create a deal.</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <path d="M5 12L10 17L19 8" id="Vector" stroke="var(--stroke-0, white)" strokeWidth="4" />
        </g>
      </svg>
    </div>
  );
...
function Container23() {
  return (
    <div className="bg-[#10b981] relative rounded-[14px] shrink-0 size-[28px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#10b981] border-solid inset-0 pointer-events-none rounded-[14px]" />
  ...
  return (
    <div className="flex-[1_0_0] h-[14.5px] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#059669] text-[12px] whitespace-nowrap">Review</p>
      </div>
    </div>
  );
}
...
function Container22() {
  return (
    <div className="h-[28px] relative shrink-0 w-[77.727px]" data-name="Container">
...
function Container24() {
  return <div className="bg-[#10b981] flex-[153.227_0_0] h-[2px] min-w-px" data-name="Container" />;
}

function Container26() {
  return (
    <div className="bg-[#5048e5] relative rounded-[14px] shrink-0 size-[28px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#5048e5] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center p-[2px] relative size-full">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[12px] text-white whitespace-nowrap">2</p>
      </div>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="flex-[1_0_0] h-[14.5px] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[12px] whitespace-nowrap">Contact</p>
      </div>
    </div>
  );
}
...
function Container25() {
  return (
    <div className="h-[28px] relative shrink-0 w-[81.906px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Container26 />
        <Text1 />
      </div>
...
function Container27() {
  return <div className="bg-[#e2e8f0] flex-[153.227_0_0] h-[2px] min-w-px" data-name="Container" />;
}

function Container29() {
  return (
    <div className="bg-white flex-[1_0_0] h-[28px] min-w-px relative rounded-[14px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-2 border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center p-[2px] relative size-full">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[12px] whitespace-nowrap">3</p>
      </div>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="h-[14.5px] relative shrink-0 w-[25.914px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[12px] whitespace-nowrap">Deal</p>
      </div>
    </div>
  );
}
...
function Container28() {
  return (
    <div className="h-[28px] relative shrink-0 w-[61.914px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative size-full">
        <Container29 />
        <Text2 />
      </div>
...
function Container21() {
  return (
    <div className="absolute content-stretch flex gap-[12px] h-[28px] items-center left-[32px] px-[20px] top-[97.5px] w-[616px]" data-name="Container">
      <Container22 />
      <Container24 />
      <Container25 />
      <Container27 />
...
function Container31() {
  return (
    <div className="relative rounded-[10px] shrink-0 size-[40px]" style={{ backgroundImage: "linear-gradient(135deg, rgb(196, 181, 253) 0%, rgb(167, 139, 250) 100%)" }} data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[15px] text-white whitespace-nowrap">PS</p>
      </div>
    </div>
  );
}
...
function Container33() {
  return (
    <div className="content-stretch flex h-[17px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[14px]">Priya Sharma</p>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="absolute bg-[#ede9fe] content-stretch flex h-[18px] items-start left-[85.62px] px-[8px] py-[3px] rounded-[6px] top-[-1px] w-[83.328px]" data-name="Text">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#5048e5] text-[10px] whitespace-nowrap">Website Form</p>
    </div>
  );
}
...
function Container34() {
  return (
    <div className="h-[14.5px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-0 not-italic text-[#64748b] text-[12px] top-0 whitespace-nowrap">{`InnovateTech · `}</p>
      <Text3 />
    </div>
  );
}
...
function Container32() {
  return (
    <div className="flex-[426.594_0_0] h-[33.5px] min-w-px relative" data-name="Container">
...
function Container35() {
  return (
    <div className="bg-[#fef3c7] h-[26.5px] relative rounded-[8px] shrink-0 w-[79.406px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[12px] py-[6px] relative size-full">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#92400e] text-[12px] whitespace-nowrap">Score: 72</p>
      </div>
    </div>
  );
}
...
function Container30() {
  return (
    <div className="absolute bg-[#f8fafc] content-stretch flex gap-[16px] h-[70px] items-center left-[32px] px-[19px] py-px rounded-[12px] top-[149.5px] w-[616px]" data-name="Container">
...
function Icon20() {
  return (
    <div className="absolute left-0 size-[16px] top-[0.5px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p12a1e80} id="Vector" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.5" />
          <path d={svgPaths.p33c07a00} id="Vector_2" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Container36() {
  return (
    <div className="absolute h-[17px] left-[32px] top-[239.5px] w-[616px]" data-name="Container">
      <Icon20 />
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[normal] left-[24px] not-italic text-[#0f172a] text-[14px] top-0 whitespace-nowrap">{` Contact Details `}</p>
    </div>
  );
}
...
function TextInput1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[300px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[14px] whitespace-nowrap">Priya</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container38() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[59.5px] items-start left-0 top-0 w-[300px]" data-name="Container">
      <Label />
      <TextInput1 />
    </div>
  );
...
function TextInput2() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[300px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[14px] whitespace-nowrap">Sharma</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container39() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[59.5px] items-start left-[316px] top-0 w-[300px]" data-name="Container">
      <Label1 />
      <TextInput2 />
    </div>
  );
...
function Container37() {
  return (
    <div className="absolute h-[59.5px] left-[32px] top-[270.5px] w-[616px]" data-name="Container">
      <Container38 />
      <Container39 />
    </div>
  );
...
function EmailInput() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[300px]" data-name="Email Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[14px] whitespace-nowrap">priya@innovatetech.in</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Label3() {
  return (
    <div className="h-[15.5px] relative shrink-0 w-[300px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Phone</p>
      </div>
    </div>
  );
}
...
function PhoneInput() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[300px]" data-name="Phone Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[14px] whitespace-nowrap">+91 98765 12345</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container40() {
  return (
    <div className="absolute h-[59.5px] left-[32px] top-[346px] w-[616px]" data-name="Container">
      <Container41 />
      <Container42 />
    </div>
  );
...
function Label4() {
  return (
    <div className="absolute content-stretch flex h-[15.5px] items-start left-0 top-0 w-[616px]" data-name="Label">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Organisation</p>
    </div>
  );
}

function Option() {
  return <div className="absolute left-[-427px] size-0 top-[-418px]" data-name="Option" />;
}
...
function Dropdown() {
  return (
    <div className="absolute h-[38px] left-0 rounded-[8px] top-[20.5px] w-[616px]" data-name="Dropdown">
      ...
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[-427px] not-italic text-[#0f172a] text-[14px] top-[-418px] whitespace-nowrap">​</p>
      <Option />
      <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[-427px] not-italic text-[#0f172a] text-[14px] top-[-418px] whitespace-nowrap">
...
function Text4() {
  return (
    <div className="absolute content-stretch flex h-[14.5px] items-start left-0 top-[65.5px] w-[616px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] min-w-px not-italic relative text-[#5048e5] text-[0px]">
        <span className="leading-[normal] text-[12px]">Create New Organisation</span>
        <span className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] text-[#94a3b8] text-[11px]">{` if not found`}</span>
      </p>
    </div>
  );
}
...
function Container44() {
  return (
    <div className="absolute h-[80px] left-0 top-0 w-[616px]" data-name="Container">
      <Label4 />
      <Dropdown />
      <Text4 />
    </div>
...
function Container43() {
  return (
    <div className="absolute h-[80px] left-[32px] top-[421.5px] w-[616px]" data-name="Container">
      <Container44 />
    </div>
  );
}
...
function HorizontalRule() {
  return <div className="absolute border-[#f1f5f9] border-solid border-t h-px left-[32px] top-[521.5px] w-[616px]" data-name="Horizontal Rule" />;
}

function Text5() {
  return (
    <div className="absolute content-stretch flex h-[15.5px] items-start left-[48px] top-[2.25px] w-[107.07px]" data-name="Text">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#334155] text-[13px] whitespace-nowrap">Auto-create Deal</p>
    </div>
  );
}
...
function Container45() {
  return (
    <div className="absolute h-[20px] left-[32px] top-[542.5px] w-[616px]" data-name="Container">
      <Text5 />
      <Container46 />
    </div>
  );
...
function Label5() {
  return (
    <div className="h-[15.5px] relative shrink-0 w-[582px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Deal Name</p>
      </div>
    </div>
  );
}
...
function TextInput3() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[582px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[14px] whitespace-nowrap">InnovateTech — Inbound Enquiry</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container50() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[59.5px] items-start left-0 top-0 w-[582px]" data-name="Container">
      <Label5 />
      <TextInput3 />
    </div>
  );
...
function Label6() {
  return (
    <div className="h-[15.5px] relative shrink-0 w-[283px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Stage</p>
      </div>
    </div>
  );
}
...
function Option3() {
  return <div className="absolute left-[-444px] size-0 top-[-663.5px]" data-name="Option" />;
}
...
function Dropdown1() {
  return (
    <div className="h-[38px] relative rounded-[8px] shrink-0 w-[283px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[8px]">
        ...
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[15.79%] left-0 max-w-none top-[42.11%] w-[3.53%]" src={imgDropdown.src} />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[-444px] not-italic text-[#0f172a] text-[14px] top-[-663.5px] whitespace-nowrap">​</p>
        <Option3 />
        <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[-444px] not-italic text-[#0f172a] text-[14px] top-[-663.5px] whitespace-nowrap">
          <p className="leading-[normal] mb-0 whitespace-pre">​</p>
          <p className="leading-[normal] whitespace-pre">{`            `}</p>
        </div>
        <Option4 />
...
function Container52() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[78.5px] items-start left-0 top-0 w-[283px]" data-name="Container">
      <Label6 />
      <Dropdown1 />
    </div>
  );
...
function Label7() {
  return (
    <div className="absolute content-stretch flex h-[15.5px] items-start left-0 top-0 w-[283px]" data-name="Label">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Owner</p>
    </div>
  );
}

function Option7() {
  return <div className="absolute left-[-743px] size-0 top-[-663.5px]" data-name="Option" />;
}
...
function Dropdown2() {
  return (
    <div className="absolute h-[38px] left-0 rounded-[8px] top-[20.5px] w-[283px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[8px]">
        <div className="absolute bg-white inset-0 rounded-[8px]" />
        <div className="absolute inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[15.79%] left-0 max-w-none top-[42.11%] w-[3.53%]" src={imgDropdown.src} />
      ...
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[-743px] not-italic text-[#0f172a] text-[14px] top-[-663.5px] whitespace-nowrap">​</p>
      <Option7 />
      <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[-743px] not-italic text-[#0f172a] text-[14px] top-[-663.5px] whitespace-nowrap">
        <p className="leading-[normal] mb-0 whitespace-pre">​</p>
        <p className="leading-[normal] whitespace-pre">{`            `}</p>
      </div>
      <Option8 />
...
function Text6() {
  return (
    <div className="absolute content-stretch flex h-[13px] items-start left-0 top-[65.5px] w-[283px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[11px]">Assigned from lead owner</p>
    </div>
  );
}
...
function Container53() {
  return (
    <div className="absolute h-[78.5px] left-[299px] top-0 w-[283px]" data-name="Container">
      <Label7 />
      <Dropdown2 />
      <Text6 />
    </div>
...
function Container48() {
  return (
    <div className="absolute bg-[#fafaff] content-stretch flex flex-col gap-[16px] h-[204px] items-start left-[32px] pb-px pt-[17px] px-[17px] rounded-[12px] top-[574.5px] w-[616px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#ede9fe] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <Container49 />
      <Container51 />
    </div>
  );
...
function Button1() {
  return (
    <div className="bg-white h-[39px] relative rounded-[8px] shrink-0 w-[69.406px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[18px] py-[11px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#334155] text-[14px] text-center whitespace-nowrap">Back</p>
      </div>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="bg-[#5048e5] flex-[1_0_0] h-[39px] min-w-px relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(80,72,229,0.2),0px_4px_6px_0px_rgba(80,72,229,0.2)]" data-name="Button">
      <div className="flex flex-row items-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[17px] py-[10px] relative size-full">
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">{`Convert & Create Deal`}</p>
        </div>
      </div>
    </div>
  );
...
function Container55() {
  return (
    <div className="h-[39px] relative shrink-0 w-[183.352px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <Button2 />
      </div>
    </div>
...
function Container54() {
  return (
    <div className="absolute content-stretch flex h-[60px] items-start justify-between left-[32px] pt-[21px] top-[802.5px] w-[616px]" data-name="Container">
...
function Container18() {
  return (
    <div className="bg-white h-[880px] relative rounded-[20px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] shrink-0 w-[680px]" data-name="Container">
...
function Container17() {
  return (
    <div className="absolute bg-[rgba(15,23,42,0.45)] content-stretch flex h-[1088px] items-center justify-center left-0 px-[395px] top-0 w-[1470px]" data-name="Container">
      <Container18 />
    </div>
  );
}

export default function ConvertLeadToContactDeal() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Convert Lead to Contact + Deal">
      <MainContent />
      <Sidebar />
      <Header />
      <Container17 />
