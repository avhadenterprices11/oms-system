"use client";
import svgPaths from "./svg-063esuk0gj";
import imgDropdown from "./5094ae664e848e19d8526a5f2e3d190abd538585.png";

function Container() {
  return <div className="absolute h-0 left-0 top-[52px] w-[1280px]" data-name="Container" />;
}

function MainContent() {
  return <div className="absolute h-[51.997px] left-[256px] opacity-40 top-0 w-[1024.002px]" data-name="Main Content" />;
}
...
function Container20() {
  return (
    <div className="absolute content-stretch flex h-[24.444px] items-start left-[32px] top-[32px] w-[656.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Extra_Bold',sans-serif] font-extrabold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Create New Project</p>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[32px] top-[60.43px] w-[656.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[14px]">Set up a new project with team, timeline, and settings.</p>
    </div>
  );
}
...
function Icon19() {
  return (
    <div className="absolute left-0 size-[15.998px] top-[0.33px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9983 15.9983">
        <g id="Icon">
          <path d={svgPaths.p7305c00} id="Vector" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49984" />
          <path d={svgPaths.p3f1a9b00} id="Vector_2" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49984" />
        </g>
      </svg>
    </div>
  );
...
function Container22() {
  return (
    <div className="absolute h-[16.667px] left-[32px] top-[101.09px] w-[656.007px]" data-name="Container">
      <Icon19 />
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[normal] left-[23.99px] not-italic text-[#0f172a] text-[14px] top-0 whitespace-nowrap">{` Basic Info `}</p>
    </div>
  );
}
...
function Label() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[656.007px]" data-name="Label">
...
function TextInput1() {
  return (
    <div className="bg-white h-[37.778px] relative rounded-[8px] shrink-0 w-[656.007px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">e.g. Portal v2 Redesign</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container24() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[58.889px] items-start left-0 top-0 w-[656.007px]" data-name="Container">
      <Label />
      <TextInput1 />
    </div>
  );
...
function Container23() {
  return (
    <div className="absolute h-[58.889px] left-[32px] top-[131.75px] w-[656.007px]" data-name="Container">
      <Container24 />
    </div>
  );
}
...
function TextArea() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[656.007px]" data-name="Text Area">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Briefly describe the project scope and objectives...</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container26() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[92.222px] items-start left-0 top-0 w-[656.007px]" data-name="Container">
      <Label1 />
      <TextArea />
    </div>
  );
...
function Container25() {
  return (
    <div className="absolute h-[92.222px] left-[32px] top-[206.64px] w-[656.007px]" data-name="Container">
      <Container26 />
    </div>
  );
}
...
function Label2() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[320px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Project Owner</p>
      </div>
    </div>
  );
}
...
function Option() {
  return <div className="absolute left-[-488.66px] size-0 top-[-368.19px]" data-name="Option" />;
}
...
function Dropdown() {
  return (
    <div className="flex-[1_0_0] min-h-px relative rounded-[8px] w-[320px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[8px]">
        ...
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[15.88%] left-0 max-w-none top-[42.06%] w-[3.13%]" src={imgDropdown.src} />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[-488.66px] not-italic text-[#0f172a] text-[14px] top-[-368.19px] whitespace-nowrap">​</p>
        <Option />
        <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[-488.66px] not-italic text-[#0f172a] text-[14px] top-[-368.19px] whitespace-nowrap">
...
function Label3() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[320.009px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Priority</p>
      </div>
    </div>
  );
}
...
function Option5() {
  return <div className="absolute left-[-824.66px] size-0 top-[-368.19px]" data-name="Option" />;
}
...
function Dropdown1() {
  return (
    <div className="flex-[1_0_0] min-h-px relative rounded-[8px] w-[320.009px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[8px]">
        <div className="absolute bg-clip-padding bg-white border-0 border-[transparent] border-solid inset-0 rounded-[8px]" />
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[15.88%] left-0 max-w-none top-[42.06%] w-[3.12%]" src={imgDropdown.src} />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[-824.66px] not-italic text-[#0f172a] text-[14px] top-[-368.19px] whitespace-nowrap">​</p>
        <Option5 />
        <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[-824.66px] not-italic text-[#0f172a] text-[14px] top-[-368.19px] whitespace-nowrap">
          <p className="leading-[normal] mb-0 whitespace-pre">​</p>
          <p className="leading-[normal] whitespace-pre">{`          `}</p>
        </div>
        <Option6 />
...
function Container29() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[58.889px] items-start left-[336px] top-0 w-[320.009px]" data-name="Container">
      <Label3 />
      <Dropdown1 />
    </div>
  );
...
function Container27() {
  return (
    <div className="absolute h-[58.889px] left-[32px] top-[314.86px] w-[656.007px]" data-name="Container">
      <Container28 />
      <Container29 />
    </div>
  );
...
function Icon20() {
  return (
    <div className="absolute left-0 size-[15.998px] top-[0.33px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9983 15.9983">
        <g id="Icon">
          <path d={svgPaths.p3f5e0d80} id="Vector" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49984" />
          <path d="M1.99978 5.99935H13.9985" id="Vector_2" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49984" />
          <path d="M4.99946 1.49984V4.49984" id="Vector_3" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49984" />
          <path d="M10.9988 1.49984V4.49984" id="Vector_4" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49984" />
        </g>
      </svg>
    </div>
  );
...
function Container30() {
  return (
    <div className="absolute h-[16.667px] left-[32px] top-[414.31px] w-[656.007px]" data-name="Container">
      <Icon20 />
...
function DatePicker1() {
  return (
    <div className="bg-white h-[39.774px] relative rounded-[8px] shrink-0 w-[320.009px]" data-name="Date Picker">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
}
...
function Container33() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[60.885px] items-start left-[336px] top-0 w-[320.009px]" data-name="Container">
      <Label5 />
      <DatePicker1 />
    </div>
  );
...
function Container31() {
  return (
    <div className="absolute h-[60.885px] left-[32px] top-[444.97px] w-[656.007px]" data-name="Container">
      <Container32 />
      <Container33 />
    </div>
  );
...
function Text() {
  return (
    <div className="absolute content-stretch flex h-[16.111px] items-start left-[47.99px] top-[1.94px] w-[68.793px]" data-name="Text">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#334155] text-[13px] whitespace-nowrap">Milestones</p>
    </div>
  );
}

function Container36() {
  return <div className="bg-white h-[15.998px] rounded-[7.999px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1)] shrink-0 w-full" data-name="Container" />;
}

function Container35() {
  return (
    <div className="absolute bg-[#5048e5] content-stretch flex flex-col h-[20px] items-start left-0 pl-[17.995px] pr-[2.005px] pt-[1.997px] rounded-[10px] top-0 w-[35.998px]" data-name="Container">
      <Container36 />
    </div>
  );
}
...
function Container34() {
  return (
    <div className="absolute h-[20px] left-[32px] top-[521.85px] w-[656.007px]" data-name="Container">
      <Text />
      <Container35 />
    </div>
  );
...
function Container37() {
  return (
    <div className="absolute content-stretch flex h-[14.444px] items-start left-[79.99px] top-[549.84px] w-[608.012px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[12px]">Add milestones after creation</p>
    </div>
  );
}
...
function Icon21() {
  return (
    <div className="absolute left-0 size-[15.998px] top-[0.33px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9983 15.9983">
        <g clipPath="url(#clip0_15_23874)" id="Icon">
          <path d={svgPaths.p28c54100} id="Vector" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49984" />
          <path d={svgPaths.p225dadc0} id="Vector_2" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49984" />
          <path d={svgPaths.p38af1100} id="Vector_3" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49984" />
          <path d={svgPaths.p2c6f9060} id="Vector_4" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49984" />
        </g>
        <defs>
          <clipPath id="clip0_15_23874">
            <rect fill="white" height="15.9983" width="15.9983" />
          </clipPath>
        </defs>
      </svg>
...
function Container38() {
  return (
    <div className="absolute h-[16.667px] left-[32px] top-[604.84px] w-[656.007px]" data-name="Container">
      <Icon21 />
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[normal] left-[23.99px] not-italic text-[#0f172a] text-[14px] top-0 whitespace-nowrap">{` Team `}</p>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[81.48px] opacity-60 top-[3.99px] w-[9.427px]" data-name="Text">
...
function Container42() {
  return (
    <div className="absolute bg-[#ede9fe] h-[24.653px] left-[12.55px] rounded-[6px] top-[8.67px] w-[100.903px]" data-name="Container">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[10px] not-italic text-[#5048e5] text-[12px] top-[5.1px] whitespace-nowrap">{`Ravi Kumar `}</p>
      <Text1 />
    </div>
  );
}
...
function Text2() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[80.46px] opacity-60 top-[3.99px] w-[9.427px]" data-name="Text">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#5048e5] text-[14px] whitespace-nowrap">×</p>
    </div>
  );
}
...
function Container43() {
  return (
    <div className="absolute bg-[#ede9fe] h-[24.653px] left-[121.45px] rounded-[6px] top-[8.67px] w-[99.887px]" data-name="Container">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[10px] not-italic text-[#5048e5] text-[12px] top-[5.1px] whitespace-nowrap">{`Jordan Lee `}</p>
      <Text2 />
    </div>
  );
}
...
function TextInput2() {
  return (
    <div className="absolute bg-white content-stretch flex h-[16.111px] items-center left-[229.33px] overflow-clip top-[12.94px] w-[414.123px]" data-name="Text Input">
...
function Container41() {
  return (
    <div className="h-[41.997px] relative rounded-[8px] shrink-0 w-[656.007px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container42 />
        <Container43 />
...
function Container40() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[63.108px] items-start left-0 top-0 w-[656.007px]" data-name="Container">
      <Label6 />
      <Container41 />
    </div>
  );
...
function Container39() {
  return (
    <div className="absolute h-[63.108px] left-[32px] top-[635.5px] w-[656.007px]" data-name="Container">
      <Container40 />
    </div>
  );
}
...
function Label7() {
  return (
    <div className="absolute content-stretch flex h-[16.111px] items-start left-0 top-0 w-[656.007px]" data-name="Label">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Budget</p>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="absolute content-stretch flex h-[13.333px] items-start left-0 top-[65.89px] w-[656.007px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[11px]">Leave blank if no budget tracking required</p>
    </div>
  );
}
...
function TextInput3() {
  return (
    <div className="absolute bg-white h-[37.778px] left-0 rounded-[8px] top-0 w-[656.007px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip pl-[30px] pr-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Optional</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Text4() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[13.99px] top-[10.56px] w-[8px]" data-name="Text">
...
function Container46() {
  return (
    <div className="absolute h-[37.778px] left-0 top-[21.11px] w-[656.007px]" data-name="Container">
      <TextInput3 />
      <Text4 />
    </div>
  );
...
function Container45() {
  return (
    <div className="absolute h-[79.219px] left-0 top-0 w-[656.007px]" data-name="Container">
      <Label7 />
      <Text3 />
      <Container46 />
    </div>
...
function Container44() {
  return (
    <div className="absolute h-[79.219px] left-[32px] top-[714.61px] w-[656.007px]" data-name="Container">
      <Container45 />
    </div>
  );
}
...
function Icon22() {
  return (
    <div className="absolute left-0 size-[15.998px] top-[0.33px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9983 15.9983">
        <g id="Icon">
          <path d={svgPaths.p99a5200} id="Vector" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49984" />
          <path d={svgPaths.pd255600} id="Vector_2" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49984" />
        </g>
      </svg>
    </div>
  );
...
function Container47() {
  return (
    <div className="absolute h-[16.667px] left-[32px] top-[834.38px] w-[656.007px]" data-name="Container">
      <Icon22 />
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[normal] left-[23.99px] not-italic text-[#0f172a] text-[14px] top-0 whitespace-nowrap">{` Settings `}</p>
    </div>
  );
}
...
function Label8() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[320px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Visibility</p>
      </div>
    </div>
  );
}
...
function Option9() {
  return <div className="absolute left-[-488.66px] size-0 top-[-918.38px]" data-name="Option" />;
}
...
function Dropdown2() {
  return (
    <div className="h-[37.778px] relative rounded-[8px] shrink-0 w-[320px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[8px]">
        <div className="absolute bg-clip-padding bg-white border-0 border-[transparent] border-solid inset-0 rounded-[8px]" />
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[15.88%] left-0 max-w-none top-[42.06%] w-[3.13%]" src={imgDropdown.src} />
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[-488.66px] not-italic text-[#0f172a] text-[14px] top-[-918.38px] whitespace-nowrap">​</p>
        <Option9 />
        <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[-488.66px] not-italic text-[#0f172a] text-[14px] top-[-918.38px] whitespace-nowrap">
          <p className="leading-[normal] mb-0 whitespace-pre">​</p>
          <p className="leading-[normal] whitespace-pre">{`          `}</p>
        </div>
        <Option10 />
...
function Label9() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[320.009px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Link to Client Delivery</p>
      </div>
    </div>
  );
}
...
function Option12() {
  return <div className="absolute left-[-824.66px] size-0 top-[-918.38px]" data-name="Option" />;
}
...
function Dropdown3() {
  return (
    <div className="h-[37.778px] relative rounded-[8px] shrink-0 w-[320.009px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[8px]">
        <div className="absolute bg-clip-padding bg-white border-0 border-[transparent] border-solid inset-0 rounded-[8px]" />
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[15.88%] left-0 max-w-none top-[42.06%] w-[3.12%]" src={imgDropdown.src} />
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[-824.66px] not-italic text-[#0f172a] text-[14px] top-[-918.38px] whitespace-nowrap">​</p>
        <Option12 />
        <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[-824.66px] not-italic text-[#0f172a] text-[14px] top-[-918.38px] whitespace-nowrap">
          <p className="leading-[normal] mb-0 whitespace-pre">​</p>
          <p className="leading-[normal] whitespace-pre">{`          `}</p>
        </div>
        <Option13 />
...
function Container48() {
  return (
    <div className="absolute h-[58.889px] left-[32px] top-[865.04px] w-[656.007px]" data-name="Container">
      <Container49 />
      <Container50 />
    </div>
  );
...
function Button2() {
  return (
    <div className="bg-[#5048e5] h-[37.778px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(80,72,229,0.2),0px_4px_6px_0px_rgba(80,72,229,0.2)] shrink-0 w-[130.477px]" data-name="Button">
...
function Container51() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[58.333px] items-start justify-end left-[32px] pt-[20.556px] top-[947.93px] w-[656.007px]" data-name="Container">
...
function Container19() {
  return (
    <div className="bg-white h-[1022px] relative rounded-[20px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] shrink-0 w-[720px]" data-name="Container">
...
function Container18() {
  return (
    <div className="absolute bg-[rgba(15,23,42,0.45)] content-stretch flex h-[1165px] items-center justify-center left-0 px-[456.667px] top-0 w-[1633px]" data-name="Container">
      <Container19 />
    </div>
  );
}
...
export default function CreateNewProject() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Create New Project">
      <Body />
      <Sidebar />
      <Header />
      <Container18 />
