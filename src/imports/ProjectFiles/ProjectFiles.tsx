"use client";
import svgPaths from "./svg-nl6392uqna";
...
function FileGrid() {
  return (
    <div className="gap-x-[24px] gap-y-[24px] grid grid-cols-[repeat(4,minmax(0,1fr))] grid-rows-[__283px_283px] h-[548px] relative shrink-0 w-full" data-name="File Grid">
      <FileCard1Pdf />
      <FileCard2Docx />
      <FileCard3Figma />
      <FileCard4Zip />
...
function FilesContent() {
  return (
    <div className="absolute bg-[#f6f6f8] content-stretch flex flex-col gap-[30px] h-[714px] items-start left-0 p-[32px] right-0 top-[246px]" data-name="Files Content">
      <SearchAndActionsBar />
      <Categories />
      <FileGrid />
    </div>
...
export default function ProjectFiles() {
  return (
    <div className="bg-[#f6f6f8] content-stretch flex flex-col items-start relative size-full" data-name="Project Files">
      <Body />
    </div>
  );
}