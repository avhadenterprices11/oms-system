"use client";
import svgPaths from "./svg-exdac2vpmi";

function Container2() {
  return (
    <div className="h-[35.998px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Extra_Bold',sans-serif] font-extrabold leading-[36px] left-0 not-italic text-[#0f172a] text-[30px] top-[-0.56px] tracking-[-0.75px] whitespace-nowrap">Leave Requests</p>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="h-[24.002px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#64748b] text-[16px] top-[-0.78px] whitespace-nowrap">Pending approvals</p>
    </div>
  );
}
...
function Container1() {
  return (
    <div className="h-[63.993px] relative shrink-0 w-[223.863px]" data-name="Container">
...
function Container() {
  return (
    <div className="h-[63.993px] opacity-30 relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex items-start justify-between pr-[736.146px] relative size-full">
        <Container1 />
      </div>
    </div>
  );
...
function Container24() {
  return (
    <div className="absolute content-stretch flex h-[24.444px] items-start left-[32px] top-[32px] w-[416.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Reject Leave Request</p>
    </div>
  );
}
...
function Text() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[60.807px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[13px] whitespace-nowrap">Employee</p>
      </div>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="bg-[#dbeafe] h-[17.326px] relative rounded-[9999px] shrink-0 w-[92.726px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[normal] left-[10px] not-italic text-[#2563eb] text-[11px] top-[2px] whitespace-nowrap">Annual Leave</p>
      </div>
    </div>
  );
}
...
function Container27() {
  return (
    <div className="content-stretch flex h-[29.878px] items-center justify-between pb-[0.556px] relative shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#f1f5f9] border-b-[0.556px] border-solid inset-0 pointer-events-none" />
      <Text2 />
      <Text3 />
    </div>
...
function Text4() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[35.703px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[13px] whitespace-nowrap">Dates</p>
      </div>
    </div>
  );
}
...
function Text5() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[191.389px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[13px] whitespace-nowrap">Apr 10 — Apr 11, 2026 (2 days)</p>
      </div>
    </div>
  );
}
...
function Text6() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[46.068px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[13px] whitespace-nowrap">Reason</p>
      </div>
    </div>
  );
}
...
function Text7() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[79.479px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[13px] whitespace-nowrap">Family event</p>
      </div>
    </div>
  );
}
...
function Container29() {
  return (
    <div className="content-stretch flex h-[28.108px] items-center justify-between relative shrink-0 w-full" data-name="Container">
      <Text6 />
      <Text7 />
    </div>
  );
...
function Container25() {
  return (
    <div className="absolute bg-[#f8fafc] content-stretch flex flex-col h-[148.42px] items-start left-[32px] pb-[0.556px] pt-[16.554px] px-[16.554px] rounded-[12px] top-[76.44px] w-[416.007px]" data-name="Container">
    ...
    <div className="h-[16.111px] relative shrink-0 w-[416.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] min-w-px not-italic relative text-[#334155] text-[13px]">
          <span className="leading-[normal]">{`Reason for rejection `}</span>
...
function TextArea() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[416.007px]" data-name="Text Area">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Explain why this request is being rejected...</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container30() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[101.111px] items-start left-[32px] top-[244.86px] w-[416.007px]" data-name="Container">
      <Label />
      <TextArea />
    </div>
  );
...
function Text8() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[158.394px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#334155] text-[13px] whitespace-nowrap">Suggest alternative dates</p>
      </div>
    </div>
  );
}
...
function Container31() {
  return (
    <div className="absolute content-stretch flex gap-[7.995px] h-[17.995px] items-center left-[32px] top-[361.97px] w-[416.007px]" data-name="Container">
      <Container32 />
      <Text8 />
    </div>
  );
...
function Button2() {
  return (
    <div className="bg-[#dc2626] h-[37.778px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(220,38,38,0.2)] shrink-0 w-[141.267px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[20px] py-[10px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Reject Request</p>
      </div>
    </div>
  );
}
...
function Container33() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[58.333px] items-start justify-end left-[32px] pt-[20.556px] top-[455.73px] w-[416.007px]" data-name="Container">
...
function DatePicker() {
  return (
    <div className="bg-white flex-[189.002_0_0] h-[39.774px] min-w-px relative rounded-[8px]" data-name="Date Picker">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
}
...
function DatePicker1() {
  return (
    <div className="bg-white flex-[189.01_0_0] h-[39.774px] min-w-px relative rounded-[8px]" data-name="Date Picker">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
}
...
function Container34() {
  return (
    <div className="absolute content-stretch flex gap-[11.997px] h-[39.774px] items-start left-[32px] opacity-40 pl-[25.998px] top-[391.96px] w-[416.007px]" data-name="Container">
      <DatePicker />
      <DatePicker1 />
    </div>
  );
...
function Container23() {
  return (
    <div className="bg-white h-[546.059px] relative rounded-[20px] shadow-[0px_25px_50px_0px_rgba(0,0,0,0.25)] shrink-0 w-[480px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container24 />
        <Container25 />
        <Container30 />
...
export default function RejectLeaveRequest() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Reject Leave Request">
      <Body />
      <Sidebar />
      <Header />
      <Container22 />
