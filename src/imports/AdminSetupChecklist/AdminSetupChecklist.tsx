"use client";
import svgPaths from "./svg-4krrse233u";

function Container2() {
  return (
    <div className="h-[35.998px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Extra_Bold',sans-serif] font-extrabold leading-[36px] left-0 not-italic text-[#0f172a] text-[30px] top-[-0.56px] tracking-[-0.75px] whitespace-nowrap">Complete Your Setup</p>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="h-[24.002px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#64748b] text-[16px] top-[-0.78px] whitespace-nowrap">Get your organisation ready in a few steps</p>
    </div>
  );
}
...
function Container1() {
  return (
    <div className="h-[63.993px] relative shrink-0 w-[318.906px]" data-name="Container">
...
function Container() {
  return (
    <div className="absolute content-stretch flex h-[63.993px] items-start justify-between left-[32px] pr-[641.102px] top-[20px] w-[960.009px]" data-name="Container">
      <Container1 />
    </div>
  );
}
...
function Container5() {
  return (
    <div className="content-stretch flex h-[16.667px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[0] min-w-px not-italic relative text-[#5048e5] text-[0px]">
        <span className="leading-[normal] text-[14px]">3 of 8</span>
        <span className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] text-[#64748b] text-[14px]">{` complete`}</span>
      </p>
    </div>
  );
}
...
function Container7() {
  return <div className="bg-gradient-to-r from-[#5048e5] h-[7.995px] rounded-[99px] shrink-0 to-[#7c3aed] w-full" data-name="Container" />;
}

function Container6() {
  return (
    <div className="bg-[#f1f5f9] h-[7.995px] relative rounded-[99px] shrink-0 w-full" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start pr-[600.009px] relative size-full">
          <Container7 />
        </div>
      </div>
    </div>
...
function Container4() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.995px] h-[32.656px] items-start left-[32px] top-[103.99px] w-[960.009px]" data-name="Container">
      <Container5 />
      <Container6 />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[13.993px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.9931 13.9931">
        <g id="Icon">
          <path d={svgPaths.p16456c00} id="Vector" stroke="var(--stroke-0, white)" strokeWidth="1.99901" />
        </g>
      </svg>
    </div>
  );
...
function Container10() {
  return (
    <div className="bg-[#5048e5] relative rounded-[13.997px] shrink-0 size-[27.995px]" data-name="Container">
...
function Container12() {
  return (
    <div className="absolute content-stretch flex h-[18.333px] items-start left-0 top-0 w-[866.918px]" data-name="Container">
      <p className="[text-decoration-skip-ink:none] decoration-solid flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] line-through min-w-px not-italic relative text-[#94a3b8] text-[15px]">Create organisation</p>
    </div>
  );
}
...
function Container13() {
  return (
    <div className="absolute h-[18.003px] left-0 top-[20.33px] w-[866.918px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#64748b] text-[13px] top-[-0.44px] whitespace-nowrap">Set up your organisation name, domain, and basic info</p>
    </div>
  );
}
...
function Container14() {
  return (
    <div className="absolute content-stretch flex h-[14.444px] items-start left-0 top-[42.33px] w-[866.918px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[12px]">Completed</p>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="flex-[866.918_0_0] h-[56.771px] min-w-px relative" data-name="Container">
...
function Container9() {
  return (
    <div className="bg-white h-[97.882px] opacity-70 relative rounded-[16px] shrink-0 w-[960.009px]" data-name="Container">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[15.998px] items-start pb-[0.556px] pt-[20.556px] px-[24.549px] relative size-full">
        <Container10 />
        <Container11 />
      </div>
    </div>
...
function Container18() {
  return (
    <div className="absolute content-stretch flex h-[18.333px] items-start left-0 top-0 w-[866.918px]" data-name="Container">
      <p className="[text-decoration-skip-ink:none] decoration-solid flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] line-through min-w-px not-italic relative text-[#94a3b8] text-[15px]">Set up departments</p>
    </div>
  );
}
...
function Container19() {
  return (
    <div className="absolute h-[18.003px] left-0 top-[20.33px] w-[866.918px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#64748b] text-[13px] top-[-0.44px] whitespace-nowrap">Define your team structure with departments and sub-teams</p>
    </div>
  );
}
...
function Container24() {
  return (
    <div className="absolute content-stretch flex h-[18.333px] items-start left-0 top-0 w-[866.918px]" data-name="Container">
      <p className="[text-decoration-skip-ink:none] decoration-solid flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] line-through min-w-px not-italic relative text-[#94a3b8] text-[15px]">{`Configure roles & permissions`}</p>
    </div>
  );
}
...
function Container25() {
  return (
    <div className="absolute h-[18.003px] left-0 top-[20.33px] w-[866.918px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#64748b] text-[13px] top-[-0.44px] whitespace-nowrap">Set access levels for different roles in your organisation</p>
    </div>
  );
}
...
function Container28() {
  return <div className="bg-[#5048e5] rounded-[13.997px] shrink-0 size-[27.995px]" data-name="Container" />;
}

function Container30() {
  return (
    <div className="absolute content-stretch flex h-[18.333px] items-start left-0 top-0 w-[866.918px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[15px]">Invite team members</p>
    </div>
  );
}
...
function Container31() {
  return (
    <div className="absolute h-[18.003px] left-0 top-[20.33px] w-[866.918px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#64748b] text-[13px] top-[-0.44px] whitespace-nowrap">Send invitations to your team to join the portal</p>
    </div>
  );
}
...
function Container32() {
  return (
    <div className="absolute content-stretch flex h-[14.444px] items-start left-0 top-[42.33px] w-[866.918px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[12px]">~5 minutes</p>
    </div>
  );
}
...
function EmailInput() {
  return (
    <div className="bg-white flex-[654.922_0_0] h-[38.889px] min-w-px relative rounded-[8px]" data-name="Email Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Email address</p>
        </div>
      </div>
...
function Dropdown() {
  return (
    <div className="bg-white h-[38.889px] relative rounded-[8px] shrink-0 w-[160px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-1043.455px] pr-[1203.455px] pt-[-671.597px] relative size-full">
        <Option />
        <Option1 />
        <Option2 />
      </div>
...
function Container34() {
  return (
    <div className="content-stretch flex gap-[11.997px] h-[38.889px] items-start relative shrink-0 w-full" data-name="Container">
      <EmailInput />
      <Dropdown />
    </div>
  );
...
function Dropdown1() {
  return (
    <div className="bg-white h-[38.889px] relative rounded-[8px] shrink-0 w-[160px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-1043.455px] pr-[1203.455px] pt-[-722.483px] relative size-full">
        <Option3 />
      </div>
    </div>
  );
...
function Button() {
  return (
    <div className="bg-white h-[37.778px] relative rounded-[8px] shrink-0 w-[139.696px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[70.06px] not-italic text-[#334155] text-[14px] text-center top-[10.56px] whitespace-nowrap">+ Add Another</p>
      </div>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="bg-[#5048e5] h-[37.778px] relative rounded-[8px] shrink-0 w-[123.09px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[62px] not-italic text-[14px] text-center text-white top-[10.56px] whitespace-nowrap">Send Invites</p>
      </div>
    </div>
  );
}
...
function Container36() {
  return (
    <div className="content-stretch flex gap-[7.995px] h-[37.778px] items-start relative shrink-0 w-full" data-name="Container">
      <Button />
      <Button1 />
    </div>
  );
...
function Container33() {
  return (
    <div className="absolute bg-[#f8fafc] content-stretch flex flex-col gap-[11.997px] h-[179.549px] items-start left-0 pt-[20px] px-[20px] rounded-[12px] top-[72.77px] w-[866.918px]" data-name="Container">
      <Container34 />
      <Container35 />
      <Container36 />
    </div>
...
function Container29() {
  return (
    <div className="flex-[866.918_0_0] h-[252.318px] min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container30 />
        <Container31 />
        <Container32 />
...
function Container27() {
  return (
    <div className="bg-white h-[293.429px] relative rounded-[16px] shrink-0 w-[960.009px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#5048e5] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_0px_0px_0px_rgba(80,72,229,0.08)]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[15.998px] items-start pb-[0.556px] pt-[20.556px] px-[24.549px] relative size-full">
        <Container28 />
        <Container29 />
      </div>
...
function Container38() {
  return (
    <div className="bg-[#f1f5f9] relative rounded-[13.997px] shrink-0 size-[27.995px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[1.667px] border-solid inset-0 pointer-events-none rounded-[13.997px]" />
    </div>
  );
}
...
function Container40() {
  return (
    <div className="absolute content-stretch flex h-[18.333px] items-start left-0 top-0 w-[866.918px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[15px]">Configure leave policies</p>
    </div>
  );
}
...
function Container41() {
  return (
    <div className="absolute h-[18.003px] left-0 top-[20.33px] w-[866.918px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#64748b] text-[13px] top-[-0.44px] whitespace-nowrap">Set up leave types, accrual rules, and approval workflows</p>
    </div>
  );
}
...
function Container42() {
  return (
    <div className="absolute content-stretch flex h-[14.444px] items-start left-0 top-[42.33px] w-[866.918px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[12px]">~10 minutes</p>
    </div>
  );
}
...
function Container37() {
  return (
    <div className="bg-white h-[97.882px] relative rounded-[16px] shrink-0 w-[960.009px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[16px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[15.998px] items-start pb-[0.556px] pt-[20.556px] px-[24.549px] relative size-full">
        <Container38 />
        <Container39 />
...
function Container46() {
  return (
    <div className="absolute content-stretch flex h-[18.333px] items-start left-0 top-0 w-[866.918px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[15px]">Connect integrations</p>
    </div>
  );
}
...
function Container47() {
  return (
    <div className="absolute h-[18.003px] left-0 top-[20.33px] w-[866.918px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#64748b] text-[13px] top-[-0.44px] whitespace-nowrap">Link Google Calendar, Slack, and other tools</p>
    </div>
  );
}
...
function Container52() {
  return (
    <div className="absolute content-stretch flex h-[18.333px] items-start left-0 top-0 w-[866.918px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[15px]">Set up chat channels</p>
    </div>
  );
}
...
function Container53() {
  return (
    <div className="absolute h-[18.003px] left-0 top-[20.33px] w-[866.918px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#64748b] text-[13px] top-[-0.44px] whitespace-nowrap">Create default channels for your teams and projects</p>
    </div>
  );
}
...
function Container54() {
  return (
    <div className="absolute content-stretch flex h-[14.444px] items-start left-0 top-[42.33px] w-[866.918px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[12px]">~3 minutes</p>
    </div>
  );
}
...
function Container58() {
  return (
    <div className="absolute content-stretch flex h-[18.333px] items-start left-0 top-0 w-[866.918px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[15px]">Customize branding</p>
    </div>
  );
}
...
function Container59() {
  return (
    <div className="absolute h-[18.003px] left-0 top-[20.33px] w-[866.918px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[18px] left-0 not-italic text-[#64748b] text-[13px] top-[-0.44px] whitespace-nowrap">Upload your logo, set brand colors, and customize the portal</p>
    </div>
  );
}
...
function Container8() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[11.997px] h-[1062.578px] items-start left-[32px] top-[164.64px] w-[960.009px]" data-name="Container">
      <Container9 />
      <Container15 />
      <Container21 />
      <Container27 />
...
function Icon4() {
  return (
    <div className="absolute left-[12px] size-[17.995px] top-[9px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.9948 17.9948">
        <g clipPath="url(#clip0_1_449)" id="Icon">
          <path d={svgPaths.p129e1a00} id="Vector" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49957" />
          <path d={svgPaths.p831ad00} id="Vector_2" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49957" />
          <path d={svgPaths.p250f6780} id="Vector_3" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49957" />
          <path d={svgPaths.p368ba580} id="Vector_4" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49957" />
        </g>
        <defs>
...
function Link() {
  return (
    <div className="bg-[rgba(80,72,229,0.08)] h-[35.998px] relative rounded-[8px] shrink-0 w-[223.446px]" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon4 />
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[41.99px] not-italic text-[#5048e5] text-[14px] top-[9.66px] whitespace-nowrap">Dashboard</p>
      </div>
    </div>
  );
}
...
export default function AdminSetupChecklist() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Admin Setup Checklist">
      <Body />
      <Sidebar />
      <Header />
    </div>
