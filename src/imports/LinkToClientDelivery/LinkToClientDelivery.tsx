"use client";
import svgPaths from "./svg-rr7vcpeklh";
...
function Container20() {
  return (
    <div className="absolute content-stretch flex h-[24.444px] items-start left-[32px] top-[32px] w-[416.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Extra_Bold',sans-serif] font-extrabold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Link to Client Delivery</p>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[32px] top-[60.43px] w-[416.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[14px]">Connect this project to an existing or new client delivery.</p>
    </div>
  );
}
...
function Text() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[100.755px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[13px] whitespace-nowrap">Currently linked:</p>
      </div>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[33.429px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#334155] text-[13px] whitespace-nowrap">None</p>
      </div>
    </div>
  );
}
...
function Container22() {
  return (
    <div className="absolute bg-[#f8fafc] content-stretch flex h-[41.215px] items-center justify-between left-[32px] px-[16.554px] py-[0.556px] rounded-[10px] top-[101.09px] w-[416.007px]" data-name="Container">
...
function Label() {
  return (
    <div className="absolute content-stretch flex h-[16.111px] items-start left-0 top-0 w-[416.007px]" data-name="Label">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Select Existing Delivery</p>
    </div>
  );
}

function Option() {
  return <div className="absolute left-[-608.66px] size-0 top-[-313.91px]" data-name="Option" />;
}
...
function Dropdown() {
  return (
    <div className="absolute h-[37.222px] left-0 rounded-[8px] top-[21.11px] w-[416.007px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[8px]">
        <div className="absolute bg-white inset-0 rounded-[8px]" />
        <div className="absolute inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[16.12%] left-0 max-w-none top-[41.94%] w-[2.4%]" src={imgDropdown.src} />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[-608.66px] not-italic text-[#0f172a] text-[14px] top-[-313.91px] whitespace-nowrap">​</p>
      <Option />
      <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[-608.66px] not-italic text-[#0f172a] text-[14px] top-[-313.91px] whitespace-nowrap">
...
function Text2() {
  return (
    <div className="absolute content-stretch flex h-[13.333px] items-start left-0 top-[65.33px] w-[416.007px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[11px]">Showing all active deliveries</p>
    </div>
  );
}
...
function Container23() {
  return (
    <div className="absolute h-[78.663px] left-[32px] top-[158.31px] w-[416.007px]" data-name="Container">
      <Label />
      <Dropdown />
      <Text2 />
    </div>
...
function Container24() {
  return (
    <div className="absolute h-[16.111px] left-[32px] top-[273.52px] w-[148.672px]" data-name="Container">
      <Icon19 />
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[19.99px] not-italic text-[#5048e5] text-[13px] top-0 whitespace-nowrap">{` Create New Delivery `}</p>
    </div>
  );
}
...
function Label1() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[382.899px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Delivery Name</p>
      </div>
    </div>
  );
}
...
function TextInput1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[382.899px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">e.g. TechFlow Portal Delivery</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container26() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] h-[58.889px] items-start relative shrink-0 w-full" data-name="Container">
      <Label1 />
      <TextInput1 />
    </div>
  );
...
function Option5() {
  return <div className="absolute left-[-625.22px] size-0 top-[-555.5px]" data-name="Option" />;
}
...
function Dropdown1() {
  return (
    <div className="h-[37.222px] relative rounded-[8px] shrink-0 w-[382.899px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[8px]">
        ...
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[16.12%] left-0 max-w-none top-[41.94%] w-[2.61%]" src={imgDropdown.src} />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[-625.22px] not-italic text-[#0f172a] text-[14px] top-[-555.5px] whitespace-nowrap">​</p>
        <Option5 />
        <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[-625.22px] not-italic text-[#0f172a] text-[14px] top-[-555.5px] whitespace-nowrap">
          <p className="leading-[normal] mb-0 whitespace-pre">​</p>
          <p className="leading-[normal] whitespace-pre">{`          `}</p>
        </div>
        <Option6 />
...
function Container27() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] h-[58.333px] items-start relative shrink-0 w-full" data-name="Container">
      <Label2 />
      <Dropdown1 />
    </div>
  );
...
function Label3() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[382.899px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Template</p>
      </div>
    </div>
  );
}
...
function Option8() {
  return <div className="absolute left-[-625.22px] size-0 top-[-629.84px]" data-name="Option" />;
}
...
function Dropdown2() {
  return (
    <div className="h-[37.222px] relative rounded-[8px] shrink-0 w-[382.899px]" data-name="Dropdown">
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[-625.22px] not-italic text-[#0f172a] text-[14px] top-[-629.84px] whitespace-nowrap">​</p>
        <Option8 />
        <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[-625.22px] not-italic text-[#0f172a] text-[14px] top-[-629.84px] whitespace-nowrap">
          <p className="leading-[normal] mb-0 whitespace-pre">​</p>
          <p className="leading-[normal] whitespace-pre">{`          `}</p>
        </div>
        <Option9 />
...
function Container25() {
  return (
    <div className="absolute bg-[#fafaff] content-stretch flex flex-col gap-[15.998px] h-[240.66px] items-start left-[32px] pb-[0.556px] pt-[16.554px] px-[16.554px] rounded-[12px] top-[308.45px] w-[416.007px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#ede9fe] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <Container26 />
      <Container27 />
      <Container28 />
    </div>
...
function Button2() {
  return (
    <div className="bg-[#5048e5] h-[37.778px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(80,72,229,0.2),0px_4px_6px_0px_rgba(80,72,229,0.2)] shrink-0 w-[62.118px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[17px] py-[10px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Link</p>
      </div>
    </div>
  );
}
...
function Container29() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[54.332px] items-start justify-end left-[32px] pt-[16.554px] top-[569.11px] w-[416.007px]" data-name="Container">
...
function Container19() {
  return (
    <div className="bg-white h-[655.443px] relative rounded-[20px] shadow-[0px_25px_50px_0px_rgba(0,0,0,0.25)] shrink-0 w-[480px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container20 />
        <Container21 />
        <Container22 />
...
function Container18() {
  return (
    <div className="absolute bg-[rgba(15,23,42,0.45)] content-stretch flex h-[924.444px] items-center justify-center left-0 px-[576.667px] top-0 w-[1633.333px]" data-name="Container">
      <Container19 />
    </div>
  );
}

export default function LinkToClientDelivery() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Link to Client Delivery">
      <Body />
      <Sidebar />
      <Header />
      <Container18 />
