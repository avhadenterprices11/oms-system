"use client";
import svgPaths from "./svg-y2hhq06wof";
...
function Container2() {
  return (
    <div className="h-[35.998px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Extra_Bold',sans-serif] font-extrabold leading-[36px] left-0 not-italic text-[#0f172a] text-[30px] top-[-0.56px] tracking-[-0.75px] whitespace-nowrap">Leave</p>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="h-[24.002px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#64748b] text-[16px] top-[-0.78px] whitespace-nowrap">My leave requests</p>
    </div>
  );
}
...
function Container1() {
  return (
    <div className="h-[63.993px] relative shrink-0 w-[138.281px]" data-name="Container">
...
function Container() {
  return (
    <div className="h-[63.993px] opacity-30 relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex items-start justify-between pr-[821.727px] relative size-full">
        <Container1 />
      </div>
    </div>
  );
...
function Container24() {
  return (
    <div className="absolute content-stretch flex h-[24.444px] items-start left-[32px] top-[32px] w-[496.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Request Leave</p>
    </div>
  );
}
...
function Container25() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[32px] top-[60.43px] w-[496.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[14px]">Submit a new leave request</p>
    </div>
  );
}
    ...
    <div className="h-[16.111px] relative shrink-0 w-[496.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] min-w-px not-italic relative text-[#334155] text-[13px]">
          <span className="leading-[normal]">{`Leave Type `}</span>
...
function Dropdown() {
  return (
    <div className="flex-[1_0_0] min-h-px relative rounded-[8px] w-[496.007px]" data-name="Dropdown">
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-568.663px] pr-[1064.67px] pt-[-323.611px] relative size-full">
        <Option />
        <Option1 />
        <Option2 />
        <Option3 />
...
function Label1() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[193.446px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] min-w-px not-italic relative text-[#334155] text-[13px]">
...
function DatePicker() {
  return (
    <div className="bg-white h-[39.774px] relative rounded-[8px] shrink-0 w-[193.446px]" data-name="Date Picker">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
}
...
function Container29() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[63.108px] items-start left-0 top-0 w-[193.446px]" data-name="Container">
      <Label1 />
      <DatePicker />
    </div>
  );
...
function Label2() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[193.455px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] min-w-px not-italic relative text-[#334155] text-[13px]">
...
function DatePicker1() {
  return (
    <div className="bg-white h-[39.774px] relative rounded-[8px] shrink-0 w-[193.455px]" data-name="Date Picker">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
}
...
function Container30() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[63.108px] items-start left-[209.44px] top-0 w-[193.455px]" data-name="Container">
      <Label2 />
      <DatePicker1 />
    </div>
  );
...
function Label3() {
  return (
    <div className="absolute content-stretch flex h-[16.111px] items-start left-0 top-0 w-[77.109px]" data-name="Label">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Days</p>
    </div>
  );
}
...
function Container32() {
  return (
    <div className="absolute bg-[#ede9fe] content-stretch flex h-[41.997px] items-center justify-center left-0 px-[16px] py-[10px] rounded-[8px] top-[21.11px] w-[77.109px]" data-name="Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#5048e5] text-[14px] whitespace-nowrap">2 days</p>
    </div>
  );
}
...
function Container31() {
  return (
    <div className="absolute h-[63.108px] left-[418.9px] top-0 w-[77.109px]" data-name="Container">
      <Label3 />
      <Container32 />
    </div>
  );
...
function Container28() {
  return (
    <div className="absolute h-[63.108px] left-[32px] top-[175.98px] w-[496.007px]" data-name="Container">
      <Container29 />
      <Container30 />
      <Container31 />
    </div>
...
function Label4() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[496.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Reason</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[496.007px]" data-name="Text Area">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Why are you requesting leave?</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container33() {
  return (
    <div className="absolute h-[91.111px] left-[32px] top-[255.09px] w-[496.007px]" data-name="Container">
      <Container34 />
    </div>
  );
}
...
function Text() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[41.745px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[13px] whitespace-nowrap">Notify:</p>
      </div>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[168.802px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[13px] whitespace-nowrap">Ashwini Reddy — Manager</p>
      </div>
    </div>
  );
}
...
function Container36() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[216.545px]" data-name="Container">
...
function Container37() {
  return <div className="bg-[#e2e8f0] h-[20px] shrink-0 w-[0.998px]" data-name="Container" />;
}

function Text2() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[53.481px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[13px] whitespace-nowrap">Balance:</p>
      </div>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="bg-[#d1fae5] h-[19.323px] relative rounded-[9999px] shrink-0 w-[132.422px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[normal] left-[10px] not-italic text-[#059669] text-[11px] top-[2.99px] whitespace-nowrap">Annual: 12 remaining</p>
      </div>
    </div>
  );
}
...
function Container38() {
  return (
    <div className="h-[19.323px] relative shrink-0 w-[191.901px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[5.998px] items-center relative size-full">
        <Text2 />
        <Text3 />
      </div>
...
function Container35() {
  return (
    <div className="absolute bg-[#f8fafc] content-stretch flex gap-[11.997px] h-[45.104px] items-center left-[32px] pl-[16.554px] pr-[0.556px] py-[0.556px] rounded-[10px] top-[362.2px] w-[496.007px]" data-name="Container">
...
function Button2() {
  return (
    <div className="bg-[#5048e5] h-[37.778px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(80,72,229,0.2)] shrink-0 w-[146.615px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[20px] py-[10px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Submit Request</p>
      </div>
    </div>
  );
}
...
function Container39() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[58.333px] items-start justify-end left-[32px] pt-[20.556px] top-[431.29px] w-[496.007px]" data-name="Container">
...
function Container23() {
  return (
    <div className="bg-white h-[521.623px] relative rounded-[20px] shadow-[0px_25px_50px_0px_rgba(0,0,0,0.25)] shrink-0 w-[560px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container24 />
        <Container25 />
        <Container26 />
...
function Container22() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.5)] content-stretch flex h-[924.444px] items-center justify-center left-[-1px] px-[536.667px] top-[48px] w-[1633.333px]" data-name="Container">
      <Container23 />
    </div>
  );
}
...
export default function RequestLeave() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Request Leave">
      <Body />
      <Sidebar />
      <Header />
      <Container22 />
