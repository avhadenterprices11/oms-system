"use client";
import svgPaths from "./svg-j5kezbh9sc";
...
function Body() {
  return (
    <div className="absolute content-stretch flex flex-col h-[1023.993px] items-start left-0 overflow-clip top-0 w-[1280px]" data-name="Body">
      <Container />
    </div>
  );
}
...
function Container20() {
  return (
    <div className="absolute content-stretch flex h-[24.444px] items-start left-[32px] top-[32px] w-[536.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Add Risk / Blocker</p>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[32px] top-[60.43px] w-[536.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[14px]">Flag a risk or blocker for the project.</p>
    </div>
  );
}
...
function Label() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[536.007px]" data-name="Label">
...
function Container25() {
  return <div className="absolute border-[#5048e5] border-[1.667px] border-solid left-0 rounded-[8.997px] size-[17.995px] top-0" data-name="Container" />;
}

function Label1() {
  return (
    <div className="h-[17.995px] relative shrink-0 w-[53.464px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container25 />
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[25.99px] not-italic text-[#334155] text-[14px] top-[0.66px] whitespace-nowrap">{` Risk`}</p>
      </div>
    </div>
  );
}
...
function Container26() {
  return <div className="absolute border-[#e2e8f0] border-[1.667px] border-solid left-0 rounded-[8.997px] size-[17.995px] top-0" data-name="Container" />;
}

function Label2() {
  return (
    <div className="h-[17.995px] relative shrink-0 w-[75.738px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container26 />
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[25.99px] not-italic text-[#334155] text-[14px] top-[0.66px] whitespace-nowrap">{` Blocker`}</p>
      </div>
    </div>
  );
}
...
function Container24() {
  return (
    <div className="h-[17.995px] relative shrink-0 w-[536.007px]" data-name="Container">
...
function Container23() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[39.106px] items-start left-0 top-0 w-[536.007px]" data-name="Container">
      <Label />
      <Container24 />
    </div>
  );
...
function Container22() {
  return (
    <div className="absolute h-[39.106px] left-[32px] top-[101.09px] w-[536.007px]" data-name="Container">
      <Container23 />
    </div>
  );
}
...
function TextInput1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[536.007px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Short title for this risk</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container28() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[58.889px] items-start left-0 top-0 w-[536.007px]" data-name="Container">
      <Label3 />
      <TextInput1 />
    </div>
  );
...
function Container27() {
  return (
    <div className="absolute h-[58.889px] left-[32px] top-[156.2px] w-[536.007px]" data-name="Container">
      <Container28 />
    </div>
  );
}
...
function TextArea() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[536.007px]" data-name="Text Area">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Describe the risk or blocker in detail...</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container30() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[92.222px] items-start left-0 top-0 w-[536.007px]" data-name="Container">
      <Label4 />
      <TextArea />
    </div>
  );
...
function Container29() {
  return (
    <div className="absolute h-[92.222px] left-[32px] top-[231.09px] w-[536.007px]" data-name="Container">
      <Container30 />
    </div>
  );
}
...
function Label5() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[536.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] min-w-px not-italic relative text-[#334155] text-[13px]">
          <span className="leading-[normal]">{`Severity `}</span>
          <span className="leading-[normal] text-[#ef4444]">*</span>
        </p>
      </div>
    </div>
...
function Container34() {
  return (
    <div className="bg-[#fef2f2] h-[35.434px] relative rounded-[8px] shrink-0 w-[80.113px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#fecaca] border-[1.667px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[17.66px] not-italic text-[#dc2626] text-[13px] top-[9.66px] whitespace-nowrap">Critical</p>
      </div>
    </div>
  );
}
...
function Container35() {
  return (
    <div className="bg-[#fff7ed] h-[35.434px] relative rounded-[8px] shrink-0 w-[62.3px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#fed7aa] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[16.55px] not-italic text-[#ea580c] text-[13px] top-[8.55px] whitespace-nowrap">High</p>
      </div>
    </div>
  );
}
...
function Container36() {
  return (
    <div className="bg-white h-[35.434px] relative rounded-[8px] shrink-0 w-[83.967px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[16.55px] not-italic text-[#64748b] text-[13px] top-[8.55px] whitespace-nowrap">Medium</p>
      </div>
    </div>
  );
}
...
function Container37() {
  return (
    <div className="bg-white h-[35.434px] relative rounded-[8px] shrink-0 w-[59.097px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[16.55px] not-italic text-[#64748b] text-[13px] top-[8.55px] whitespace-nowrap">Low</p>
      </div>
    </div>
  );
}
...
function Container33() {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-[536.007px]" data-name="Container">
...
function Container32() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[56.545px] items-start left-0 top-0 w-[536.007px]" data-name="Container">
      <Label5 />
      <Container33 />
    </div>
  );
...
function Container31() {
  return (
    <div className="absolute h-[56.545px] left-[32px] top-[339.31px] w-[536.007px]" data-name="Container">
      <Container32 />
    </div>
  );
}
...
function Label6() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[536.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Impact Area</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[10.998px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.9983 10.9983">
        <g id="Icon">
          <path d={svgPaths.pafdd380} id="Vector" stroke="var(--stroke-0, white)" strokeWidth="1.99968" />
        </g>
      </svg>
    </div>
  );
...
function Label7() {
  return (
    <div className="absolute h-[17.995px] left-0 top-0 w-[69.948px]" data-name="Label">
      <Container41 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[25.99px] not-italic text-[#334155] text-[13px] top-[0.94px] whitespace-nowrap">Budget</p>
    </div>
  );
}
...
function Label8() {
  return (
    <div className="absolute h-[17.995px] left-[79.95px] top-0 w-[78.056px]" data-name="Label">
      <Container42 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[25.99px] not-italic text-[#334155] text-[13px] top-[0.94px] whitespace-nowrap">Timeline</p>
    </div>
  );
}
...
function Container43() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-0 px-[3.498px] py-[1.111px] rounded-[4px] size-[17.995px] top-0" data-name="Container">
...
function Label9() {
  return (
    <div className="absolute h-[17.995px] left-[168px] top-0 w-[69.028px]" data-name="Label">
      <Container43 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[25.99px] not-italic text-[#334155] text-[13px] top-[0.94px] whitespace-nowrap">Quality</p>
    </div>
  );
}
...
function Label10() {
  return (
    <div className="absolute h-[17.995px] left-[247.03px] top-0 w-[65.095px]" data-name="Label">
      <Container44 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[25.99px] not-italic text-[#334155] text-[13px] top-[0.94px] whitespace-nowrap">Scope</p>
    </div>
  );
}
...
function Container38() {
  return (
    <div className="absolute h-[39.106px] left-[32px] top-[411.85px] w-[536.007px]" data-name="Container">
      <Container39 />
    </div>
  );
}
...
function Label11() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[260px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Likelihood</p>
      </div>
    </div>
  );
}
...
function Dropdown() {
  return (
    <div className="h-[37.778px] relative rounded-[8px] shrink-0 w-[260px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[8px]">
        ...
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[15.88%] left-0 max-w-none top-[42.06%] w-[3.85%]" src={imgDropdown.src} />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-548.663px] pr-[808.663px] pt-[-586.372px] relative size-full">
        <Option />
        <Option1 />
        <Option2 />
        <Option3 />
...
function Container46() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[58.889px] items-start left-0 top-0 w-[260px]" data-name="Container">
      <Label11 />
      <Dropdown />
    </div>
  );
...
function Label12() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[260.009px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] min-w-px not-italic relative text-[#334155] text-[13px]">
          <span className="leading-[normal]">{`Owner `}</span>
          <span className="leading-[normal] text-[#ef4444]">*</span>
        </p>
      </div>
    </div>
...
function Dropdown1() {
  return (
    <div className="h-[37.778px] relative rounded-[8px] shrink-0 w-[260.009px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[8px]">
        <div className="absolute bg-clip-padding bg-white border-0 border-[transparent] border-solid inset-0 rounded-[8px]" />
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[15.88%] left-0 max-w-none top-[42.06%] w-[3.85%]" src={imgDropdown.src} />
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-824.661px] pr-[1084.67px] pt-[-586.372px] relative size-full">
        <Option4 />
        <Option5 />
        <Option6 />
        <Option7 />
...
function Container47() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[58.889px] items-start left-[276px] top-0 w-[260.009px]" data-name="Container">
      <Label12 />
      <Dropdown1 />
    </div>
  );
...
function Container45() {
  return (
    <div className="absolute h-[58.889px] left-[32px] top-[466.95px] w-[536.007px]" data-name="Container">
      <Container46 />
      <Container47 />
    </div>
  );
...
function Label13() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[536.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Mitigation Plan</p>
      </div>
    </div>
  );
}
...
function TextArea1() {
  return (
    <div className="bg-white h-[71.111px] relative rounded-[8px] shrink-0 w-[536.007px]" data-name="Text Area">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start overflow-clip px-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">How will this risk be mitigated?</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container48() {
  return (
    <div className="absolute h-[92.222px] left-[32px] top-[541.84px] w-[536.007px]" data-name="Container">
      <Container49 />
    </div>
  );
}
...
function Button2() {
  return (
    <div className="bg-[#5048e5] h-[37.778px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(80,72,229,0.2)] shrink-0 w-[99.444px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[20px] py-[10px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Add Risk</p>
      </div>
    </div>
  );
}
...
function Container50() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[37.778px] items-start justify-end left-[32px] top-[658.06px] w-[536.007px]" data-name="Container">
      <Button1 />
      <Button2 />
    </div>
  );
...
function Container19() {
  return (
    <div className="bg-white h-[727.83px] relative rounded-[20px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] shrink-0 w-[600px]" data-name="Container">
...
function Container18() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.5)] content-stretch flex h-[924.444px] items-center justify-center left-0 px-[516.667px] top-0 w-[1633.333px]" data-name="Container">
      <Container19 />
    </div>
  );
}

export default function AddRiskBlocker() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Add Risk / Blocker">
      <Body />
      <Sidebar />
      <Header />
      <Container18 />
