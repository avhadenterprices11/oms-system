"use client";
import svgPaths from "./svg-h2kze7fea9";
...
function SearchAndActionsBar() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Search and Actions Bar">
      <Container41 />
      <Container45 />
    </div>
  );
...
function Categories() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Categories">
      <Button13 />
      <Button14 />
      <Button15 />
      <Button16 />
...
export default function ClientDeliveryFilesTab() {
  return (
    <div className="bg-[#f6f6f8] content-stretch flex flex-col items-start relative size-full" data-name="Client Delivery - Files Tab">
      <Body />
    </div>
  );
}