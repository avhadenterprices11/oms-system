"use client";
import svgPaths from "./svg-ewqt4uvugp";
import imgDropdown from "./5094ae664e848e19d8526a5f2e3d190abd538585.png";

function Body() {
  return <div className="absolute h-[1024px] left-0 top-0 w-[1280px]" data-name="Body" />;
}
...
function Container19() {
  return (
    <div className="absolute content-stretch flex h-[24.5px] items-start left-[32px] top-[32px] w-[416px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Add Guest</p>
    </div>
  );
}
...
function Container20() {
  return (
    <div className="absolute content-stretch flex h-[17px] items-start left-[32px] top-[60.5px] w-[416px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[14px]">Add a guest to the event list.</p>
    </div>
  );
}
...
function Label() {
  return (
    <div className="h-[15.5px] relative shrink-0 w-[200px]" data-name="Label">
...
function TextInput1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[200px]" data-name="Text Input">
...
function Container22() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[59.5px] items-start left-0 top-0 w-[200px]" data-name="Container">
      <Label />
      <TextInput1 />
    </div>
  );
...
function EmailInput() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[200px]" data-name="Email Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">guest@company.com</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container23() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[59.5px] items-start left-[216px] top-0 w-[200px]" data-name="Container">
      <Label1 />
      <EmailInput />
    </div>
  );
...
function Container21() {
  return (
    <div className="absolute h-[59.5px] left-[32px] top-[101.5px] w-[416px]" data-name="Container">
      <Container22 />
      <Container23 />
    </div>
  );
...
function Label2() {
  return (
    <div className="absolute content-stretch flex h-[15.5px] items-start left-0 top-0 w-[200px]" data-name="Label">
...
function TextInput2() {
  return (
    <div className="absolute bg-white h-[39px] left-0 rounded-[8px] top-[20.5px] w-[200px]" data-name="Text Input">
...
function Text() {
  return (
    <div className="absolute content-stretch flex h-[13px] items-start left-0 top-[66.5px] w-[200px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[11px]">Optional</p>
    </div>
  );
}
...
function Container25() {
  return (
    <div className="absolute h-[79.5px] left-0 top-0 w-[200px]" data-name="Container">
      <Label2 />
      <TextInput2 />
      <Text />
    </div>
...
function Label3() {
  return (
    <div className="h-[15.5px] relative shrink-0 w-[200px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] min-w-px not-italic relative text-[#334155] text-[13px]">
          <span className="leading-[normal]">{`Guest Type `}</span>
          <span className="leading-[normal] text-[#ef4444]">*</span>
        </p>
      </div>
    </div>
...
function Dropdown() {
  return (
    <div className="h-[38px] relative rounded-[8px] shrink-0 w-[200px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[8px]">
        ...
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[15.79%] left-0 max-w-none top-[42.11%] w-[5%]" src={imgDropdown.src} />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-px pl-[-743px] pr-[943px] pt-[-354.25px] relative size-full">
        <Option />
        <Option1 />
        <Option2 />
        <Option3 />
...
function Container26() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[79.5px] items-start left-[216px] top-0 w-[200px]" data-name="Container">
      <Label3 />
      <Dropdown />
    </div>
  );
...
function Container24() {
  return (
    <div className="absolute h-[79.5px] left-[32px] top-[177px] w-[416px]" data-name="Container">
      <Container25 />
      <Container26 />
    </div>
  );
...
function Label4() {
  return (
    <div className="h-[15.5px] relative shrink-0 w-[416px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Dietary Requirements</p>
      </div>
    </div>
  );
}
...
function Dropdown1() {
  return (
    <div className="flex-[1_0_0] min-h-px relative rounded-[8px] w-[416px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[8px]">
        <div className="absolute bg-clip-padding bg-white border-0 border-[transparent] border-solid inset-0 rounded-[8px]" />
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[15.79%] left-0 max-w-none top-[42.11%] w-[2.4%]" src={imgDropdown.src} />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-px pl-[-527px] pr-[943px] pt-[-449.75px] relative size-full">
        <Option5 />
        <Option6 />
        <Option7 />
        <Option8 />
...
function Container28() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[58.5px] items-start left-0 top-0 w-[416px]" data-name="Container">
      <Label4 />
      <Dropdown1 />
    </div>
  );
...
function Container27() {
  return (
    <div className="absolute h-[58.5px] left-[32px] top-[272.5px] w-[416px]" data-name="Container">
      <Container28 />
    </div>
  );
}
...
function TextArea() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[416px]" data-name="Text Area">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Any additional notes...</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container30() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[76.5px] items-start left-0 top-0 w-[416px]" data-name="Container">
      <Label5 />
      <TextArea />
    </div>
  );
...
function Container29() {
  return (
    <div className="absolute h-[76.5px] left-[32px] top-[347px] w-[416px]" data-name="Container">
      <Container30 />
    </div>
  );
}
...
function Button1() {
  return (
    <div className="bg-white h-[39px] relative rounded-[8px] shrink-0 w-[89.023px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[21px] py-[11px] relative size-full">
...
function Button2() {
  return (
    <div className="bg-[#5048e5] h-[39px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(80,72,229,0.2)] shrink-0 w-[110.953px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[20px] py-[10px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Add Guest</p>
      </div>
    </div>
  );
}
...
function Container31() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[39px] items-start justify-end left-[32px] top-[447.5px] w-[416px]" data-name="Container">
      <Button1 />
      <Button2 />
    </div>
  );
...
function Container18() {
  return (
    <div className="bg-white h-[518.5px] relative rounded-[20px] shadow-[0px_25px_50px_0px_rgba(0,0,0,0.25)] shrink-0 w-[480px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container19 />
        <Container20 />
        <Container21 />
...
function Container17() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.5)] content-stretch flex h-[832px] items-center justify-center left-0 px-[495px] top-0 w-[1470px]" data-name="Container">
      <Container18 />
    </div>
  );
}
...
export default function AddGuest() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Add Guest">
      <Body />
      <Sidebar />
      <Header />
      <Container17 />
