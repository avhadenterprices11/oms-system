"use client";
import svgPaths from "./svg-btiyqqa1nj";
...
function ActivityContent() {
  return (
    <div className="bg-[#f6f6f8] h-[714px] relative shrink-0 w-full" data-name="Activity Content">
...
export default function ClientDeliveryActivityTab() {
  return (
    <div className="bg-[#f6f6f8] content-stretch flex flex-col items-start relative size-full" data-name="Client Delivery - Activity Tab">
      <Body />
    </div>
  );
}