"use client";
import svgPaths from "./svg-xlw0oo0cad";
...
function Container24() {
  return (
    <div className="absolute content-stretch flex h-[24.444px] items-start left-[32px] top-[32px] w-[416.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Request Additional Information</p>
    </div>
  );
}
...
function Label() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[416.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Question / message to employee</p>
      </div>
    </div>
  );
}
...
function TextArea() {
  return (
    <div className="bg-white h-[90px] relative rounded-[8px] shrink-0 w-[416.007px]" data-name="Text Area">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start overflow-clip px-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">What additional information do you need?</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container30() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[111.111px] items-start left-[32px] top-[244.86px] w-[416.007px]" data-name="Container">
      <Label />
      <TextArea />
    </div>
  );
...
function Button2() {
  return (
    <div className="bg-[#5048e5] h-[37.778px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(80,72,229,0.2)] shrink-0 w-[133.681px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[20px] py-[10px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Send Request</p>
      </div>
    </div>
  );
}
...
function Container31() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[58.333px] items-start justify-end left-[32px] pt-[20.556px] top-[379.97px] w-[416.007px]" data-name="Container">
...
function Container23() {
  return (
    <div className="bg-white h-[470.295px] relative rounded-[20px] shadow-[0px_25px_50px_0px_rgba(0,0,0,0.25)] shrink-0 w-[480px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container24 />
        <Container25 />
        <Container30 />
...
export default function RequestAdditionalInformation() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Request Additional Information">
      <Body />
      <Sidebar />
      <Header />
      <Container22 />
