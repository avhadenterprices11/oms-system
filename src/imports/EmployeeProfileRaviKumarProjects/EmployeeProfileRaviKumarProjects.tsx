"use client";
import svgPaths from "./svg-jckfrund1p";

function Link() {
  return (
    <div className="h-[15.5px] relative shrink-0 w-[42.695px]" data-name="Link">
...
function Link1() {
  return (
    <div className="h-[15.5px] relative shrink-0 w-[57.438px]" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
...
function Text2() {
  return (
    <div className="h-[15.5px] relative shrink-0 w-[70.969px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
...
function Container3() {
  return (
    <div className="relative rounded-[16px] shrink-0 size-[72px]" style={{ backgroundImage: "linear-gradient(135deg, rgb(254, 202, 202) 0%, rgb(252, 165, 165) 100%)" }} data-name="Container">
...
function Container5() {
  return (
    <div className="absolute h-[29.5px] left-0 top-0 w-[522.508px]" data-name="Container">
...
function Container6() {
  return (
    <div className="absolute content-stretch flex h-[18px] items-start left-0 top-[33.5px] w-[522.508px]" data-name="Container">
...
function Icon() {
  return (
    <div className="absolute left-0 size-[14px] top-[0.75px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="Icon">
          <path d="M2 4L7 7.5L12 4" id="Vector" stroke="var(--stroke-0, #94A3B8)" strokeWidth="1.3" />
          <path d={svgPaths.p34eb490} id="Vector_2" stroke="var(--stroke-0, #94A3B8)" strokeWidth="1.3" />
        </g>
      </svg>
    </div>
  );
...
function Text4() {
  return (
    <div className="h-[15.5px] relative shrink-0 w-[147.469px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon />
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[20px] not-italic text-[#475569] text-[13px] top-0 whitespace-nowrap">ravi.kumar@portal.io</p>
      </div>
    </div>
  );
}
...
function Icon1() {
  return (
    <div className="absolute left-0 size-[14px] top-[0.75px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="Icon">
          <path d={svgPaths.p33f4db00} id="Vector" stroke="var(--stroke-0, #94A3B8)" strokeWidth="1.3" />
          <path d={svgPaths.pe8bc7a0} id="Vector_2" stroke="var(--stroke-0, #94A3B8)" strokeWidth="1.3" />
        </g>
      </svg>
    </div>
  );
...
function BoldText() {
  return (
    <div className="absolute content-stretch flex h-[15.5px] items-start left-[92.92px] top-0 w-[93.398px]" data-name="Bold Text">
...
function Text5() {
  return (
    <div className="flex-[1_0_0] h-[15.5px] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon1 />
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[20px] not-italic text-[#475569] text-[13px] top-0 whitespace-nowrap">{`Reports to: `}</p>
        <BoldText />
      </div>
    </div>
  );
...
function Icon2() {
  return (
    <div className="absolute left-0 size-[14px] top-[0.75px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="Icon">
          <path d={svgPaths.p36b52580} id="Vector" stroke="var(--stroke-0, #94A3B8)" strokeWidth="1.3" />
          <path d="M1.5 5.5H12.5" id="Vector_2" stroke="var(--stroke-0, #94A3B8)" strokeWidth="1.3" />
          <path d="M5 2V4" id="Vector_3" stroke="var(--stroke-0, #94A3B8)" strokeWidth="1.3" />
          <path d="M9 2V4" id="Vector_4" stroke="var(--stroke-0, #94A3B8)" strokeWidth="1.3" />
        </g>
      </svg>
    </div>
  );
...
function Text6() {
  return (
    <div className="h-[15.5px] relative shrink-0 w-[148.719px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon2 />
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[20px] not-italic text-[#475569] text-[13px] top-0 whitespace-nowrap">Joined: Mar 15, 2023</p>
      </div>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="absolute content-stretch flex gap-[20px] h-[15.5px] items-start left-0 top-[63.5px] w-[522.508px]" data-name="Container">
      <Text4 />
      <Text5 />
      <Text6 />
    </div>
...
function Container2() {
  return (
    <div className="h-[79px] relative shrink-0 w-[614.508px]" data-name="Container">
...
function Icon3() {
  return (
    <div className="absolute left-[18px] size-[14px] top-[12.5px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="Icon">
          <path d="M3 4H11M3 7H8M3 10H6" id="Vector" stroke="var(--stroke-0, #334155)" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Icon4() {
  return (
    <div className="absolute left-[18px] size-[14px] top-[12.5px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="Icon">
          <path d="M10 2L12 4L5 11H3V9L10 2Z" id="Vector" stroke="var(--stroke-0, #334155)" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Icon5() {
  return (
    <div className="absolute h-[14px] left-[17px] top-[20px] w-[8.828px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.82812 14">
        <g id="Icon">
          <path d={svgPaths.p2b816600} id="Vector" stroke="var(--stroke-0, white)" strokeWidth="0.945871" />
        </g>
      </svg>
    </div>
  );
...
function Container10() {
  return (
    <div className="h-[37.5px] relative shrink-0 w-[94.992px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0)] border-b-2 border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center pb-[12px] pt-[10px] px-[18px] relative size-full">
...
function Text7() {
  return (
    <div className="absolute bg-[#ede9fe] content-stretch flex h-[14px] items-start left-[75.47px] px-[6px] py-px rounded-[9999px] top-[10.75px] w-[18.227px]" data-name="Text">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#5048e5] text-[10px] whitespace-nowrap">5</p>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="h-[37.5px] relative shrink-0 w-[111.695px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#5048e5] border-b-2 border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[18px] not-italic text-[#5048e5] text-[13px] top-[10px] whitespace-nowrap">{`Projects `}</p>
        <Text7 />
      </div>
    </div>
  );
...
function Text8() {
  return (
    <div className="absolute bg-[#f1f5f9] content-stretch flex h-[14px] items-start left-[60.2px] px-[6px] py-px rounded-[9999px] top-[10.75px] w-[24.813px]" data-name="Text">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[10px] whitespace-nowrap">28</p>
    </div>
  );
}
...
function Container12() {
  return (
    <div className="h-[37.5px] relative shrink-0 w-[103.008px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0)] border-b-2 border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[18px] not-italic text-[#64748b] text-[13px] top-[10px] whitespace-nowrap">{`Tasks `}</p>
        <Text8 />
      </div>
    </div>
  );
...
function Text9() {
  return (
    <div className="absolute bg-[#f1f5f9] content-stretch flex h-[14px] items-start left-[53.83px] px-[6px] py-px rounded-[9999px] top-[10.75px] w-[18.461px]" data-name="Text">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[10px] whitespace-nowrap">3</p>
    </div>
  );
}
...
function Container13() {
  return (
    <div className="h-[37.5px] relative shrink-0 w-[90.289px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0)] border-b-2 border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[18px] not-italic text-[#64748b] text-[13px] top-[10px] whitespace-nowrap">{`CRM `}</p>
        <Text9 />
      </div>
    </div>
  );
...
function Text10() {
  return (
    <div className="absolute bg-[#f1f5f9] content-stretch flex h-[14px] items-start left-[81.71px] px-[6px] py-px rounded-[9999px] top-[10.75px] w-[18.766px]" data-name="Text">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[10px] whitespace-nowrap">4</p>
    </div>
  );
}
...
function Container14() {
  return (
    <div className="h-[37.5px] relative shrink-0 w-[118.477px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0)] border-b-2 border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[18px] not-italic text-[#64748b] text-[13px] top-[10px] whitespace-nowrap">{`Meetings `}</p>
        <Text10 />
      </div>
    </div>
  );
...
function Text11() {
  return (
    <div className="absolute bg-[#f1f5f9] content-stretch flex h-[14px] items-start left-[94.88px] px-[6px] py-px rounded-[9999px] top-[10.75px] w-[22.609px]" data-name="Text">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[10px] whitespace-nowrap">12</p>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="h-[37.5px] relative shrink-0 w-[135.484px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0)] border-b-2 border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[18px] not-italic text-[#64748b] text-[13px] top-[10px] whitespace-nowrap">{`Documents `}</p>
        <Text11 />
      </div>
    </div>
  );
...
function Container16() {
  return (
    <div className="h-[37.5px] relative shrink-0 w-[73.148px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0)] border-b-2 border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center pb-[12px] pt-[10px] px-[18px] relative size-full">
...
function Container17() {
  return (
    <div className="h-[37.5px] relative shrink-0 w-[83.227px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0)] border-b-2 border-solid inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center pb-[12px] pt-[10px] px-[18px] relative size-full">
...
function Icon6() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_15_11893)" id="Icon">
          <path d={svgPaths.p3d1d3900} id="Vector" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.3" />
          <path d="M1.5 4L7 6.5L12.5 4" id="Vector_2" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.3" />
          <path d="M7 6.5V12.5" id="Vector_3" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.3" />
        </g>
        <defs>
          <clipPath id="clip0_15_11893">
...
function Container21() {
  return (
    <div className="bg-[#ede9fe] relative rounded-[8px] shrink-0 size-[28px]" data-name="Container">
...
function Heading() {
  return (
    <div className="flex-[1_0_0] h-[17px] min-w-px relative" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[14px] whitespace-nowrap">Assigned Projects</p>
      </div>
    </div>
  );
}
...
function Text12() {
  return (
    <div className="bg-[#ede9fe] h-[16px] relative rounded-[9999px] shrink-0 w-[22.227px]" data-name="Text">
...
function Container20() {
  return (
    <div className="h-[28px] relative shrink-0 w-[190.305px]" data-name="Container">
...
function Link2() {
  return (
    <div className="h-[14.5px] relative shrink-0 w-[125.945px]" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#5048e5] text-[12px] whitespace-nowrap">View All in Projects →</p>
      </div>
    </div>
  );
}
...
function Text13() {
  return (
    <div className="absolute bg-[#d1fae5] content-stretch flex h-[16px] items-start left-[16px] px-[8px] py-[2px] rounded-[9999px] top-[11.5px] w-[71.156px]" data-name="Text">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#059669] text-[10px] whitespace-nowrap">In Progress</p>
    </div>
  );
}
...
function Container24() {
  return <div className="bg-[#5048e5] h-[5px] rounded-[3px] shrink-0 w-full" data-name="Container" />;
}

function Container23() {
  return (
    <div className="bg-[#f1f5f9] flex-[116.688_0_0] h-[5px] min-w-px relative rounded-[3px]" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pr-[37.344px] relative size-full">
          <Container24 />
        </div>
      </div>
    </div>
...
function Text14() {
  return (
    <div className="h-[13px] relative shrink-0 w-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#5048e5] text-[11px] text-right">68%</p>
      </div>
    </div>
  );
}
...
function Container22() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[13px] items-center left-[16px] top-[12.5px] w-[156.688px]" data-name="Container">
      <Container23 />
      <Text14 />
    </div>
  );
...
function Container26() {
  return (
    <div className="bg-[#f1f5f9] flex-[116.688_0_0] h-[5px] min-w-px relative rounded-[3px]" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pr-[67.68px] relative size-full">
          <Container27 />
        </div>
      </div>
    </div>
...
function Text16() {
  return (
    <div className="h-[13px] relative shrink-0 w-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#5048e5] text-[11px] text-right">42%</p>
      </div>
    </div>
  );
}
...
function Text17() {
  return (
    <div className="absolute bg-[#dbeafe] content-stretch flex h-[16px] items-start left-[16px] px-[8px] py-[2px] rounded-[9999px] top-[11.5px] w-[58.703px]" data-name="Text">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#2563eb] text-[10px] whitespace-nowrap">Planning</p>
    </div>
  );
}
...
function Container29() {
  return (
    <div className="bg-[#f1f5f9] flex-[116.688_0_0] h-[5px] min-w-px relative rounded-[3px]" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pr-[102.688px] relative size-full">
          <Container30 />
        </div>
      </div>
    </div>
...
function Text18() {
  return (
    <div className="h-[13px] relative shrink-0 w-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#3b82f6] text-[11px] text-right">12%</p>
      </div>
    </div>
  );
}
...
function Text19() {
  return (
    <div className="absolute bg-[#fef3c7] content-stretch flex h-[16px] items-start left-[16px] px-[8px] py-[2px] rounded-[9999px] top-[11.5px] w-[54.922px]" data-name="Text">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#d97706] text-[10px] whitespace-nowrap">On Hold</p>
    </div>
  );
}
...
function Container33() {
  return <div className="bg-[#f59e0b] h-[5px] rounded-[3px] shrink-0 w-full" data-name="Container" />;
}
...
function Container32() {
  return (
    <div className="bg-[#f1f5f9] flex-[116.688_0_0] h-[5px] min-w-px relative rounded-[3px]" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pr-[17.508px] relative size-full">
          <Container33 />
        </div>
      </div>
    </div>
...
function Text20() {
  return (
    <div className="h-[13px] relative shrink-0 w-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#f59e0b] text-[11px] text-right">85%</p>
      </div>
    </div>
  );
}
...
function Text21() {
  return (
    <div className="absolute bg-[#f1f5f9] content-stretch flex h-[16px] items-start left-[16px] px-[8px] py-[2px] rounded-[9999px] top-[11.5px] w-[69.453px]" data-name="Text">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[10px] whitespace-nowrap">Completed</p>
    </div>
  );
}
...
function Text22() {
  return (
    <div className="h-[13px] relative shrink-0 w-[32px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#10b981] text-[11px] text-right">100%</p>
      </div>
    </div>
  );
}
...
function Container39() {
  return (
    <div className="absolute h-[32px] left-[20px] top-[20px] w-[267.328px]" data-name="Container">
      <p className="-translate-x-1/2 absolute font-['Inter:Extra_Bold',sans-serif] font-extrabold leading-[32px] left-[134.16px] not-italic text-[#0f172a] text-[32px] text-center top-[-0.5px] whitespace-nowrap">3</p>
    </div>
  );
}
...
function Container40() {
  return (
    <div className="absolute content-stretch flex h-[14.5px] items-start left-[20px] top-[56px] w-[267.328px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#64748b] text-[12px] text-center">Active Projects</p>
    </div>
  );
}
...
function Container41() {
  return (
    <div className="absolute content-stretch flex h-[13px] items-start left-[20px] top-[72.5px] w-[267.328px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[11px] text-center">2 as Lead Dev</p>
    </div>
  );
}
...
function Container43() {
  return (
    <div className="absolute content-stretch flex h-[14.5px] items-start left-[20px] top-[72px] w-[267.336px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#64748b] text-[12px] text-center">Avg Completion</p>
    </div>
  );
}
  ...
  return (
    <div className="relative size-[48px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
        <g id="Icon">
          <path d={svgPaths.p1f337080} id="Vector" stroke="var(--stroke-0, #F1F5F9)" strokeWidth="4" />
          <path d={svgPaths.p1f337080} id="Vector_2" stroke="var(--stroke-0, #5048E5)" strokeDasharray="125.6 125.6" strokeLinecap="round" strokeWidth="4" />
        </g>
      </svg>
    </div>
  );
...
function Container45() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-0 size-[48px] top-0" data-name="Container">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[12px] text-center whitespace-nowrap">61%</p>
    </div>
  );
}
...
function Container44() {
  return (
    <div className="absolute left-[129.66px] size-[48px] top-[20px]" data-name="Container">
      <div className="absolute flex items-center justify-center left-0 size-[48px] top-0" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "24" } as React.CSSProperties}>
...
function Container47() {
  return (
    <div className="h-[32px] relative shrink-0 w-full" data-name="Container">
      <p className="-translate-x-1/2 absolute font-['Inter:Extra_Bold',sans-serif] font-extrabold leading-[32px] left-[133.41px] not-italic text-[#059669] text-[32px] text-center top-[-0.5px] whitespace-nowrap">92%</p>
    </div>
  );
}
...
function Container48() {
  return (
    <div className="content-stretch flex h-[14.5px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#64748b] text-[12px] text-center">On-Time Delivery</p>
    </div>
  );
}
...
function Icon10() {
  return (
    <div className="absolute left-[12px] size-[18px] top-[9px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="Icon">
          <path d={svgPaths.pa10000} id="Vector" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.5" />
          <path d="M1.5 16.5C1.5 13.5 4 11 7 11" id="Vector_2" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.5" />
          <path d={svgPaths.p39a88ef0} id="Vector_3" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.5" />
          <path d={svgPaths.p229fdd80} id="Vector_4" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Link4() {
  return (
    <div className="bg-[rgba(80,72,229,0.08)] h-[36px] relative rounded-[8px] shrink-0 w-[223px]" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon10 />
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[42px] not-italic text-[#5048e5] text-[14px] top-[9.5px] whitespace-nowrap">People</p>
      </div>
    </div>
  );
}
