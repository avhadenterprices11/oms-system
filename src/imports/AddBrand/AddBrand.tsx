"use client";
import svgPaths from "./svg-xrbpdwrcks";
...
function Container20() {
  return (
    <div className="absolute content-stretch flex h-[24.444px] items-start left-[32px] top-[32px] w-[536.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Add Brand</p>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[32px] top-[60.43px] w-[536.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[14px]">Set up a new brand identity for social media management.</p>
    </div>
  );
}
    ...
    <div className="h-[16.111px] relative shrink-0 w-[536.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] min-w-px not-italic relative text-[#334155] text-[13px]">
          <span className="leading-[normal]">{`Brand Name `}</span>
    ...
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[536.007px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">e.g. Acme Corp</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Label1() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[536.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Brand Description</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-white h-[54.444px] relative rounded-[8px] shrink-0 w-[536.007px]" data-name="Text Area">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start overflow-clip px-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Brief description of this brand...</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container24() {
  return (
    <div className="absolute h-[75.556px] left-[32px] top-[175.98px] w-[536.007px]" data-name="Container">
      <Container25 />
    </div>
  );
}
...
function Label2() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[260px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] min-w-px not-italic relative text-[#334155] text-[13px]">
          <span className="leading-[normal]">{`Brand Owner `}</span>
          <span className="leading-[normal] text-[#ef4444]">*</span>
        </p>
      </div>
    </div>
...
function Dropdown() {
  return (
    <div className="h-[37.778px] relative rounded-[8px] shrink-0 w-[260px]" data-name="Dropdown">
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-548.663px] pr-[808.663px] pt-[-426.997px] relative size-full">
        <Option />
        <Option1 />
        <Option2 />
        <Option3 />
...
function Container27() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[101.111px] items-start left-0 top-0 w-[260px]" data-name="Container">
      <Label2 />
      <Dropdown />
    </div>
  );
...
function Label3() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[260.009px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Logo</p>
      </div>
    </div>
  );
}
...
function Icon19() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d="M10 14V4M10 4L6 8M10 4L14 8" id="Vector" stroke="var(--stroke-0, #94A3B8)" strokeWidth="1.5" />
          <path d="M3 14H17" id="Vector_2" stroke="var(--stroke-0, #94A3B8)" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Container29() {
  return (
    <div className="flex-[1_0_0] min-h-px relative rounded-[16px] w-[80px]" data-name="Container">
      ...
      <div className="flex flex-col items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[3.993px] items-center justify-center px-[1.667px] py-[22.448px] relative size-full">
          <Icon19 />
          <Text />
        </div>
      </div>
...
function Container28() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[101.111px] items-start left-[276px] top-0 w-[260.009px]" data-name="Container">
      <Label3 />
      <Container29 />
    </div>
  );
...
function Container26() {
  return (
    <div className="absolute h-[101.111px] left-[32px] top-[267.53px] w-[536.007px]" data-name="Container">
      <Container27 />
      <Container28 />
    </div>
  );
...
function Label4() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[536.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Brand Voice</p>
      </div>
    </div>
  );
}
...
function TextArea1() {
  return (
    <div className="bg-white h-[71.111px] relative rounded-[8px] shrink-0 w-[536.007px]" data-name="Text Area">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start overflow-clip px-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Describe the tone and voice for this brand...</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container30() {
  return (
    <div className="absolute h-[92.222px] left-[32px] top-[384.64px] w-[536.007px]" data-name="Container">
      <Container31 />
    </div>
  );
}
...
function Label5() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[536.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Primary Color</p>
      </div>
    </div>
  );
}
...
function ColorPicker() {
  return (
    <div className="bg-[#efefef] relative rounded-[8px] shrink-0 size-[40px]" data-name="Color Picker">
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
}
...
function TextInput2() {
  return (
    <div className="bg-white h-[37.778px] relative rounded-[8px] shrink-0 w-[120px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[14px] whitespace-nowrap">#5048E5</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Container34() {
  return (
    <div className="h-[40px] relative shrink-0 w-[536.007px]" data-name="Container">
...
function Container33() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[61.111px] items-start left-0 top-0 w-[536.007px]" data-name="Container">
      <Label5 />
      <Container34 />
    </div>
  );
...
function Container32() {
  return (
    <div className="absolute h-[61.111px] left-[32px] top-[492.86px] w-[536.007px]" data-name="Container">
      <Container33 />
    </div>
  );
}
...
function Button2() {
  return (
    <div className="bg-[#5048e5] h-[37.778px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(80,72,229,0.2)] shrink-0 w-[128.637px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[20px] py-[10px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Create Brand</p>
      </div>
    </div>
  );
}
...
function Container35() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[37.778px] items-start justify-end left-[32px] top-[577.97px] w-[536.007px]" data-name="Container">
      <Button1 />
      <Button2 />
    </div>
  );
...
function Container19() {
  return (
    <div className="absolute bg-white h-[647.743px] left-[516.67px] rounded-[20px] shadow-[0px_25px_50px_0px_rgba(0,0,0,0.25)] top-[138.35px] w-[600px]" data-name="Container">
      <Container20 />
      <Container21 />
      <Container22 />
      <Container24 />
...
function Container18() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.5)] h-[924.444px] left-0 top-0 w-[1633.333px]" data-name="Container">
      <Container19 />
    </div>
  );
}
...
export default function AddBrand() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Add Brand">
      <Body />
      <Sidebar />
      <Header />
      <Container18 />
