"use client";
import svgPaths from "./svg-t27psno79v";
...
function Container2() {
  return (
    <div className="h-[35.998px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Extra_Bold',sans-serif] font-extrabold leading-[36px] left-0 not-italic text-[#0f172a] text-[30px] top-[-0.55px] tracking-[-0.75px] whitespace-nowrap">Ravi Kumar</p>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="h-[24.002px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#64748b] text-[16px] top-[-0.78px] whitespace-nowrap">Employee profile</p>
    </div>
  );
}
...
function Container1() {
  return (
    <div className="h-[63.993px] relative shrink-0 w-[161.085px]" data-name="Container">
...
function Container() {
  return (
    <div className="h-[63.993px] opacity-30 relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex items-start justify-between pr-[798.924px] relative size-full">
        <Container1 />
      </div>
    </div>
  );
...
function Container24() {
  return (
    <div className="absolute content-stretch flex h-[24.444px] items-start left-[32px] top-[32px] w-[576.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Edit Employee — Ravi Kumar</p>
    </div>
  );
}
...
function Container25() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[32px] top-[60.43px] w-[576.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[14px]">Update employee information and system settings</p>
    </div>
  );
}
...
function TextInput1() {
  return (
    <div className="bg-white h-[37.778px] relative rounded-[8px] shrink-0 w-[280px]" data-name="Text Input">
...
function TextInput2() {
  return (
    <div className="bg-white h-[37.778px] relative rounded-[8px] shrink-0 w-[280.009px]" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[14px] py-[10px] relative rounded-[inherit] size-full">
...
function EmailInput() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[280px]" data-name="Email Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[14px] whitespace-nowrap">ravi.kumar@portal.io</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function PhoneInput() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[280.009px]" data-name="Phone Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
...
function Label4() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[280px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Job Title</p>
      </div>
    </div>
  );
}
...
function TextInput3() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[280px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[14px] whitespace-nowrap">Full Stack Developer</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Label5() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[280.009px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Department</p>
      </div>
    </div>
  );
}
...
function Dropdown() {
  return (
    <div className="flex-[1_0_0] min-h-px relative rounded-[8px] w-[280.009px]" data-name="Dropdown">
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-824.661px] pr-[1104.67px] pt-[-461.328px] relative size-full">
        <Option />
        <Option1 />
        <Option2 />
        <Option3 />
...
function Label6() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[280px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Reports To</p>
      </div>
    </div>
  );
}
...
function Dropdown1() {
  return (
    <div className="h-[37.778px] relative rounded-[8px] shrink-0 w-[280px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[8px]">
        <div className="absolute bg-clip-padding bg-white border-0 border-[transparent] border-solid inset-0 rounded-[8px]" />
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[15.88%] left-0 max-w-none top-[42.06%] w-[3.57%]" src={imgDropdown.src} />
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-528.663px] pr-[808.663px] pt-[-536.215px] relative size-full">
        <Option5 />
        <Option6 />
        <Option7 />
      </div>
...
function Label7() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[280.009px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Employment Type</p>
      </div>
    </div>
  );
}
...
function Dropdown2() {
  return (
    <div className="h-[37.778px] relative rounded-[8px] shrink-0 w-[280.009px]" data-name="Dropdown">
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-824.661px] pr-[1104.67px] pt-[-536.215px] relative size-full">
        <Option8 />
        <Option9 />
        <Option10 />
        <Option11 />
...
function Label8() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[280px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">System Role</p>
      </div>
    </div>
  );
}
...
function Dropdown3() {
  return (
    <div className="h-[37.778px] relative rounded-[8px] shrink-0 w-[280px]" data-name="Dropdown">
      ...
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-528.663px] pr-[808.663px] pt-[-659.766px] relative size-full">
        <Option12 />
        <Option13 />
        <Option14 />
        <Option15 />
...
function Label9() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[280.009px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Capacity Limit</p>
      </div>
    </div>
  );
}
...
function NumberInput() {
  return (
    <div className="bg-white h-[37.778px] relative rounded-[8px] shrink-0 w-[280.009px]" data-name="Number Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip px-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[14px] whitespace-nowrap">100</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
export default function EditEmployee() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Edit Employee">
      <Body />
      <Sidebar />
      <Header />
      <Container22 />
