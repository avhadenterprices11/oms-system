"use client";
import svgPaths from "./svg-uefj94hc9e";
...
function Container20() {
  return (
    <div className="absolute content-stretch flex h-[24.444px] items-start left-[32px] top-[32px] w-[416.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Send Event Invites</p>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[32px] top-[60.43px] w-[416.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[14px]">Send or re-send invitations to guests.</p>
    </div>
  );
}
...
function Icon19() {
  return (
    <div className="absolute left-0 size-[17.995px] top-[0.72px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.9948 17.9948">
        <g id="Icon">
          <path d={svgPaths.p1e56f800} id="Vector" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49957" />
          <path d="M1.99942 6.99797H15.9954" id="Vector_2" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49957" />
...
function Container22() {
  return (
    <div className="absolute h-[19.444px] left-[32px] top-[101.09px] w-[416.007px]" data-name="Container">
      <Icon19 />
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[normal] left-[25.99px] not-italic text-[#0f172a] text-[16px] top-0 whitespace-nowrap">{` Q2 Tech Conference `}</p>
    </div>
  );
}
...
function Container25() {
  return (
    <div className="content-stretch flex h-[21.667px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[18px] text-center">120</p>
    </div>
  );
}
...
function Container26() {
  return (
    <div className="content-stretch flex h-[13.333px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[11px] text-center whitespace-nowrap">Total Guests</p>
    </div>
  );
}
...
function Container24() {
  return (
    <div className="bg-[#f8fafc] flex-[95_0_0] h-[52.101px] min-w-px relative rounded-[8px]" data-name="Container">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pt-[8.55px] px-[14.549px] relative size-full">
        <Container25 />
        <Container26 />
      </div>
    </div>
...
function Container28() {
  return (
    <div className="content-stretch flex h-[21.667px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#059669] text-[18px] text-center">82</p>
    </div>
  );
}
...
function Container29() {
  return (
    <div className="content-stretch flex h-[13.333px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[normal] min-w-px not-italic relative text-[#64748b] text-[11px] text-center">Confirmed</p>
    </div>
  );
}
...
function Container27() {
  return (
    <div className="bg-[#f8fafc] flex-[95.009_0_0] h-[52.101px] min-w-px relative rounded-[8px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#f1f5f9] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pt-[8.55px] px-[14.549px] relative size-full">
        <Container28 />
        <Container29 />
...
function Container31() {
  return (
    <div className="content-stretch flex h-[21.667px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#d97706] text-[18px] text-center">23</p>
    </div>
  );
}
...
function Container32() {
  return (
    <div className="content-stretch flex h-[13.333px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[normal] min-w-px not-italic relative text-[#64748b] text-[11px] text-center">Pending</p>
    </div>
  );
}
...
function Container34() {
  return (
    <div className="content-stretch flex h-[21.667px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#dc2626] text-[18px] text-center">15</p>
    </div>
  );
}
...
function Container35() {
  return (
    <div className="content-stretch flex h-[13.333px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[normal] min-w-px not-italic relative text-[#64748b] text-[11px] text-center">Declined</p>
    </div>
  );
}
...
function Container23() {
  return (
    <div className="absolute content-stretch flex gap-[11.997px] h-[52.101px] items-start left-[32px] top-[136.54px] w-[416.007px]" data-name="Container">
      <Container24 />
      <Container27 />
      <Container30 />
      <Container33 />
...
function Text() {
  return (
    <div className="absolute content-stretch flex h-[14.444px] items-start left-[178.45px] top-[1.77px] w-[23.481px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[12px] whitespace-nowrap">(23)</p>
    </div>
  );
}
...
function Label() {
  return (
    <div className="h-[17.995px] relative shrink-0 w-[416.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container37 />
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[27.99px] not-italic text-[#334155] text-[14px] top-[0.66px] whitespace-nowrap">{` Send to pending only `}</p>
        <Text />
      </div>
    </div>
  );
...
function Text1() {
  return (
    <div className="absolute content-stretch flex h-[14.444px] items-start left-[171.03px] top-[1.77px] w-[20.747px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[12px] whitespace-nowrap">(15)</p>
    </div>
  );
}
...
function Label1() {
  return (
    <div className="h-[17.995px] relative shrink-0 w-[416.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container38 />
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[27.99px] not-italic text-[#334155] text-[14px] top-[0.66px] whitespace-nowrap">{` Re-send to declined `}</p>
        <Text1 />
      </div>
    </div>
  );
...
function Text2() {
  return (
    <div className="absolute content-stretch flex h-[14.444px] items-start left-[107.34px] top-[1.77px] w-[28.516px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#64748b] text-[12px] whitespace-nowrap">(120)</p>
    </div>
  );
}
...
function Label2() {
  return (
    <div className="h-[17.995px] relative shrink-0 w-[416.007px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container39 />
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[27.99px] not-italic text-[#334155] text-[14px] top-[0.66px] whitespace-nowrap">{` Send to all `}</p>
        <Text2 />
      </div>
    </div>
  );
...
function Container36() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[10px] h-[73.984px] items-start left-[32px] top-[208.64px] w-[416.007px]" data-name="Container">
      <Label />
      <Label1 />
      <Label2 />
    </div>
...
function Container41() {
  return (
    <div className="content-stretch flex h-[13.333px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[11px] tracking-[0.5px] uppercase">Email Preview</p>
    </div>
  );
}
...
function Container42() {
  return (
    <div className="h-[58.516px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] left-0 not-italic text-[#475569] text-[13px] top-[0.67px] w-[363px]">{`Hi {name}, you're invited to Q2 Tech Conference on Apr 15, 2026. Please confirm your attendance by clicking the link below... `}</p>
    </div>
  );
}
...
function Container40() {
  return (
    <div className="absolute bg-[#f8fafc] content-stretch flex flex-col gap-[5.998px] h-[106.944px] items-start left-[32px] pb-[0.556px] pt-[14.549px] px-[16.554px] rounded-[10px] top-[302.62px] w-[416.007px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#f1f5f9] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <Container41 />
      <Container42 />
    </div>
  );
...
function Button2() {
  return (
    <div className="bg-[#5048e5] h-[37.778px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(80,72,229,0.2)] shrink-0 w-[123.09px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[20px] py-[10px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Send Invites</p>
      </div>
    </div>
  );
}
...
function Container43() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[37.778px] items-start justify-end left-[32px] top-[433.56px] w-[416.007px]" data-name="Container">
      <Button1 />
      <Button2 />
    </div>
  );
...
function Container19() {
  return (
    <div className="bg-white h-[503.333px] relative rounded-[20px] shadow-[0px_25px_50px_0px_rgba(0,0,0,0.25)] shrink-0 w-[480px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container20 />
        <Container21 />
        <Container22 />
...
export default function SendEventInvites() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Send Event Invites">
      <Body />
      <Sidebar />
      <Header />
      <Container18 />
