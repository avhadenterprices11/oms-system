"use client";
import svgPaths from "./svg-6v2l55sl96";
...
function Container24() {
  return (
    <div className="absolute content-stretch flex h-[24.444px] items-start left-[32px] top-[32px] w-[536.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Add Contact to TechFlow Inc</p>
    </div>
  );
}
...
function Container25() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[32px] top-[60.43px] w-[536.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[14px]">Add a new contact to this organisation</p>
    </div>
  );
}
...
function TextInput1() {
  return (
    <div className="bg-[#f8fafc] h-[37.778px] relative rounded-[8px] shrink-0 w-[536.007px]" data-name="Text Input">
    ...
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[260px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Enter first name</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function TextInput3() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[260.009px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Enter last name</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function EmailInput() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[260px]" data-name="Email Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">name@techflow.io</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function PhoneInput() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[260.009px]" data-name="Phone Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">+1 (555) 000-0000</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function TextInput4() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative rounded-[8px] w-[536.007px]" data-name="Text Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[14px] py-[10px] relative size-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">e.g. VP of Engineering</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  ...
  return (
    <div className="bg-white h-[80px] relative rounded-[8px] shrink-0 w-[536.007px]" data-name="Text Area">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start overflow-clip px-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Any additional notes about this contact...</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Button2() {
  return (
    <div className="bg-[#5048e5] h-[37.778px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(80,72,229,0.2)] shrink-0 w-[124.54px]" data-name="Button">
...
export default function AddContactToOrganisation() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Add Contact to Organisation">
      <Body />
      <Sidebar />
      <Header />
      <Container22 />
