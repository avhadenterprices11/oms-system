"use client";
import svgPaths from "./svg-ceb59qstsu";
...
function Container2() {
  return (
    <div className="h-[35.998px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Extra_Bold',sans-serif] font-extrabold leading-[36px] left-0 not-italic text-[#0f172a] text-[30px] top-[-0.56px] tracking-[-0.75px] whitespace-nowrap">Document Signing</p>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="h-[24.002px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#64748b] text-[16px] top-[-0.78px] whitespace-nowrap">Add signers</p>
    </div>
  );
}
...
function Container1() {
  return (
    <div className="h-[63.993px] relative shrink-0 w-[261.363px]" data-name="Container">
...
function Container() {
  return (
    <div className="h-[63.993px] opacity-30 relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex items-start justify-between pr-[698.646px] relative size-full">
        <Container1 />
      </div>
    </div>
  );
...
function Icon11() {
  return (
    <div className="absolute left-[12px] size-[17.995px] top-[9px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.9948 17.9948">
        <g clipPath="url(#clip0_15_54217)" id="Icon">
          <path d={svgPaths.p306b1e80} id="Vector" stroke="var(--stroke-0, #5048E5)" strokeWidth="1.49957" />
        </g>
        <defs>
          <clipPath id="clip0_15_54217">
            <rect fill="white" height="17.9948" width="17.9948" />
          </clipPath>
        </defs>
      </svg>
...
function Link10() {
  return (
    <div className="bg-[rgba(80,72,229,0.08)] h-[35.998px] relative rounded-[8px] shrink-0 w-[223.446px]" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon11 />
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[41.99px] not-italic text-[#5048e5] text-[14px] top-[9.66px] whitespace-nowrap">Documents</p>
      </div>
    </div>
  );
}
...
function Container25() {
  return (
    <div className="absolute content-stretch flex h-[24.444px] items-start left-[32px] top-[32px] w-[416.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[normal] min-w-px not-italic relative text-[#0f172a] text-[20px]">Add Signer</p>
    </div>
  );
}
...
function Container26() {
  return (
    <div className="absolute content-stretch flex h-[16.667px] items-start left-[32px] top-[60.43px] w-[416.007px]" data-name="Container">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#64748b] text-[14px]">Add a person who needs to sign or review this document</p>
    </div>
  );
}
  ...
  return (
    <div className="absolute content-stretch flex h-[16.111px] items-start left-0 top-0 w-[416.007px]" data-name="Label">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] min-w-px not-italic relative text-[#334155] text-[13px]">
        <span className="leading-[normal]">{`Employee or External Email `}</span>
...
function TextInput1() {
  return (
    <div className="absolute bg-white h-[37.778px] left-0 rounded-[8px] top-[21.11px] w-[416.007px]" data-name="Text Input">
      <div className="content-stretch flex items-center overflow-clip px-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap">Search employee or enter email address</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Text() {
  return (
    <div className="absolute content-stretch flex h-[13.333px] items-start left-0 top-[65.89px] w-[416.007px]" data-name="Text">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#94a3b8] text-[11px]">Search by name or enter an external email address</p>
    </div>
  );
}
...
function Container28() {
  return (
    <div className="absolute h-[79.219px] left-0 top-0 w-[416.007px]" data-name="Container">
      <Label />
      <TextInput1 />
      <Text />
    </div>
...
function Container27() {
  return (
    <div className="absolute h-[79.219px] left-[32px] top-[101.09px] w-[416.007px]" data-name="Container">
      <Container28 />
    </div>
  );
}
...
function Label1() {
  return (
    <div className="h-[16.111px] relative shrink-0 w-[200px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Signer Role</p>
      </div>
    </div>
  );
}
...
function Dropdown() {
  return (
    <div className="h-[37.778px] relative rounded-[8px] shrink-0 w-[200px]" data-name="Dropdown">
      <div aria-hidden="true" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 pointer-events-none rounded-[8px]">
        ...
        <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden rounded-[8px]">
          <img alt="" className="absolute h-[15.88%] left-0 max-w-none top-[42.06%] w-[5%]" src={imgDropdown.src} />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[0.556px] pl-[-608.663px] pr-[808.663px] pt-[-484.714px] relative size-full">
        <Option />
        <Option1 />
        <Option2 />
      </div>
...
function Container30() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5px] h-[79.219px] items-start left-0 top-0 w-[200px]" data-name="Container">
      <Label1 />
      <Dropdown />
    </div>
  );
...
function Label2() {
  return (
    <div className="absolute content-stretch flex h-[16.111px] items-start left-0 top-0 w-[200.009px]" data-name="Label">
      <p className="flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#334155] text-[13px]">Signing Order</p>
    </div>
  );
}
...
function NumberInput() {
  return (
    <div className="absolute bg-white h-[37.778px] left-0 rounded-[8px] top-[21.11px] w-[200.009px]" data-name="Number Input">
      <div className="content-stretch flex items-center overflow-clip px-[14px] py-[10px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#0f172a] text-[14px] whitespace-nowrap">1</p>
      </div>
      <div aria-hidden="true" className="absolute border-[#e2e8f0] border-[0.556px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function Text1() {
  return (
    <div className="absolute content-stretch flex h-[13.333px] items-start left-0 top-[65.89px] w-[200.009px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#94a3b8] text-[11px] whitespace-nowrap">Order in which signers will be notified</p>
    </div>
  );
}
...
function Container31() {
  return (
    <div className="absolute h-[79.219px] left-[216px] top-0 w-[200.009px]" data-name="Container">
      <Label2 />
      <NumberInput />
      <Text1 />
    </div>
...
function Container29() {
  return (
    <div className="absolute h-[79.219px] left-[32px] top-[196.31px] w-[416.007px]" data-name="Container">
      <Container30 />
      <Container31 />
    </div>
  );
...
function Button2() {
  return (
    <div className="bg-[#5048e5] h-[37.778px] relative rounded-[8px] shadow-[0px_10px_15px_0px_rgba(80,72,229,0.2)] shrink-0 w-[114.913px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center px-[20px] py-[10px] relative size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">Add Signer</p>
      </div>
    </div>
  );
}
...
function Container32() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[58.333px] items-start justify-end left-[32px] pt-[20.556px] top-[299.52px] w-[416.007px]" data-name="Container">
...
function Container24() {
  return (
    <div className="bg-white h-[389.852px] relative rounded-[20px] shadow-[0px_25px_50px_0px_rgba(0,0,0,0.25)] shrink-0 w-[480px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Container25 />
        <Container26 />
        <Container27 />
...
export default function AddSigner() {
  return (
    <div className="bg-[#f6f6f8] relative size-full" data-name="Add Signer">
      <Body />
      <Sidebar />
      <Header />
      <Container23 />
